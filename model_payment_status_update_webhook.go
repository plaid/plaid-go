...
func NewPaymentStatusUpdateWebhook(webhookType string, webhookCode string, paymentId string, newPaymentStatus string, oldPaymentStatus string, originalReference NullableString, originalStartDate NullableString, adjustedStartDate NullableString, timestamp string) *PaymentStatusUpdateWebhook {
