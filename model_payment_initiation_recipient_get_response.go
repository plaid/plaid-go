...
func NewPaymentInitiationRecipientGetResponse(recipientId string, name string, iban NullableString, bacs NullableRecipientBACSNullable, requestId string) *PaymentInitiationRecipientGetResponse {
