...
func NewTransactionAllOf(paymentChannel string, merchantName NullableString, authorizedDate NullableString, authorizedDatetime NullableString, datetime NullableString, transactionCode NullableTransactionCode) *TransactionAllOf {
...
// If the value is explicit nil, the zero value for string will be returned
func (o *TransactionAllOf) GetAuthorizedDatetime() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransactionAllOf) GetAuthorizedDatetimeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransactionAllOf) SetAuthorizedDatetime(v string) {
	o.AuthorizedDatetime.Set(&v)
}

// GetDatetime returns the Datetime field value
// If the value is explicit nil, the zero value for string will be returned
func (o *TransactionAllOf) GetDatetime() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransactionAllOf) GetDatetimeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransactionAllOf) SetDatetime(v string) {
	o.Datetime.Set(&v)
}
