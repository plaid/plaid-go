...
func NewConnectedApplication(applicationId string, name string, logo NullableString, applicationUrl NullableString, reasonForAccess NullableString, createdAt string, productDataTypes []string) *ConnectedApplication {
