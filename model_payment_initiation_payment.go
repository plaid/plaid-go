...
func NewPaymentInitiationPayment(paymentId string, amount PaymentAmount, status string, recipientId string, reference string, lastStatusUpdate time.Time, schedule NullableExternalPaymentScheduleGet, bacs NullableSenderBACSNullable, iban NullableString) *PaymentInitiationPayment {
