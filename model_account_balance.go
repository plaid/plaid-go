...
type AccountBalance struct {
	...
	LastUpdatedDatetime NullableString `json:"last_updated_datetime,omitempty"`
...
func (o *AccountBalance) GetLastUpdatedDatetime() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AccountBalance) GetLastUpdatedDatetimeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
// SetLastUpdatedDatetime gets a reference to the given NullableString and assigns it to the LastUpdatedDatetime field.
func (o *AccountBalance) SetLastUpdatedDatetime(v string) {
