...
// SetLastSuccessfulUpdate gets a reference to the given NullableString and assigns it to the LastSuccessfulUpdate field.
...
// SetLastFailedUpdate gets a reference to the given NullableString and assigns it to the LastFailedUpdate field.
