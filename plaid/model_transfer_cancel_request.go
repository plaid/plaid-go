...
func (o *TransferCancelRequest) GetOriginatorClientId() string {
...
func (o *TransferCancelRequest) GetOriginatorClientIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferCancelRequest) HasOriginatorClientId() bool {
...
func (o *TransferCancelRequest) SetOriginatorClientId(v string) {
	o.OriginatorClientId.Set(&v)
}
// SetOriginatorClientIdNil sets the value for OriginatorClientId to be an explicit nil
func (o *TransferCancelRequest) SetOriginatorClientIdNil() {
...
func (o *TransferCancelRequest) UnsetOriginatorClientId() {
	o.OriginatorClientId.Unset()
}

// GetReasonCode returns the ReasonCode field value if set, zero value otherwise.
func (o *TransferCancelRequest) GetReasonCode() ReasonCode {
...
// and a boolean to check if the value has been set.
func (o *TransferCancelRequest) GetReasonCodeOk() (*ReasonCode, bool) {
	if o == nil || o.ReasonCode == nil {
		return nil, false
	}
...
func (o *TransferCancelRequest) HasReasonCode() bool {
	if o != nil && o.ReasonCode != nil {
		return true
	}
...
// SetReasonCode gets a reference to the given ReasonCode and assigns it to the ReasonCode field.
func (o *TransferCancelRequest) SetReasonCode(v ReasonCode) {
	o.ReasonCode = &v
}
