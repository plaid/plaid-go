...
type _IndividualScreeningHitNames IndividualScreeningHitNames
...
func (o *IndividualScreeningHitNames) UnmarshalJSON(bytes []byte) (err error) {
	varIndividualScreeningHitNames := _IndividualScreeningHitNames{}

	if err = json.Unmarshal(bytes, &varIndividualScreeningHitNames); err == nil {
		*o = IndividualScreeningHitNames(varIndividualScreeningHitNames)
	} else {
		return err
	}
