...
func (v *FDXPartyRegistry) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid FDXPartyRegistry", value)
}
...
func NewFDXPartyRegistryFromValue(v string) (*FDXPartyRegistry, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for FDXPartyRegistry: valid values are %v", v, allowedFDXPartyRegistryEnumValues)
	}
}
