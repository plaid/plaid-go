...
type CraBankIncomeItem struct {
	...
	Accounts *[]CraBankIncomeAccount `json:"accounts,omitempty"`
...
func (o *CraBankIncomeItem) GetAccounts() []CraBankIncomeAccount {
...
// and a boolean to check if the value has been set.
func (o *CraBankIncomeItem) GetAccountsOk() (*[]CraBankIncomeAccount, bool) {
	if o == nil || o.Accounts == nil {
		return nil, false
	}
...
func (o *CraBankIncomeItem) HasAccounts() bool {
	if o != nil && o.Accounts != nil {
		return true
	}
...
// SetAccounts gets a reference to the given []CraBankIncomeAccount and assigns it to the Accounts field.
func (o *CraBankIncomeItem) SetAccounts(v []CraBankIncomeAccount) {
	o.Accounts = &v
}
