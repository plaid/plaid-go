...
type TransferAuthorizationDevice struct {
	// The IP address of the device being used to initiate the authorization. Required for Guarantee or when the end-user is present at authorization create time.
	IpAddress *string `json:"ip_address,omitempty"`
	// The user agent of the device being used to initiate the authorization. Required for Guarantee or when the end-user is present at authorization create time.
