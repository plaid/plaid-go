...
func (o *ProcessorTransactionsRecurringGetResponse) GetPersonalFinanceCategoryVersion() PersonalFinanceCategoryVersion {
...
// and a boolean to check if the value has been set.
func (o *ProcessorTransactionsRecurringGetResponse) GetPersonalFinanceCategoryVersionOk() (*PersonalFinanceCategoryVersion, bool) {
	if o == nil || o.PersonalFinanceCategoryVersion == nil {
		return nil, false
	}
...
func (o *ProcessorTransactionsRecurringGetResponse) SetPersonalFinanceCategoryVersion(v PersonalFinanceCategoryVersion) {
