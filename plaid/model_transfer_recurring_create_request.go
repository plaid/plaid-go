...
func NewTransferRecurringCreateRequest(clientId string, secret string, accessToken string, idempotencyKey NullableString, accountId string, type_ TransferType, network TransferNetwork, amount string, userPresent NullableBool, schedule TransferRecurringSchedule, user TransferUserInRequest, device TransferDevice) *TransferRecurringCreateRequest {
