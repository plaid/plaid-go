...
func NewTransferRecurringCreateRequest(accessToken string, idempotencyKey string, accountId string, type_ TransferType, network TransferNetwork, amount string, description string, schedule TransferRecurringSchedule, user TransferUserInRequest) *TransferRecurringCreateRequest {
