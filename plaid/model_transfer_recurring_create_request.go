...
func NewTransferRecurringCreateRequest(accessToken string, idempotencyKey string, accountId string, type_ TransferType, network TransferACHNetwork, amount string, description string, schedule TransferRecurringSchedule, user TransferUserInRequest) *TransferRecurringCreateRequest {
...
func (o *TransferRecurringCreateRequest) GetNetwork() TransferACHNetwork {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TransferRecurringCreateRequest) GetNetworkOk() (*TransferACHNetwork, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferRecurringCreateRequest) SetNetwork(v TransferACHNetwork) {
	o.Network = v
}
