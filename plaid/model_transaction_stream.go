...
type TransactionStream struct {
	...
	LastUserModifiedDate *string `json:"last_user_modified_date,omitempty"`
...
// GetLastUserModifiedDate returns the LastUserModifiedDate field value if set, zero value otherwise.
func (o *TransactionStream) GetLastUserModifiedDate() string {
	if o == nil || o.LastUserModifiedDate == nil {
		var ret string
		return ret
	}
	return *o.LastUserModifiedDate
}

// GetLastUserModifiedDateOk returns a tuple with the LastUserModifiedDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransactionStream) GetLastUserModifiedDateOk() (*string, bool) {
	if o == nil || o.LastUserModifiedDate == nil {
		return nil, false
	}
	return o.LastUserModifiedDate, true
}

// HasLastUserModifiedDate returns a boolean if a field has been set.
func (o *TransactionStream) HasLastUserModifiedDate() bool {
	if o != nil && o.LastUserModifiedDate != nil {
		return true
	}
...
// SetLastUserModifiedDate gets a reference to the given string and assigns it to the LastUserModifiedDate field.
func (o *TransactionStream) SetLastUserModifiedDate(v string) {
	o.LastUserModifiedDate = &v
}
...
func (o TransactionStream) MarshalJSON() ([]byte, error) {
	...
	if o.LastUserModifiedDate != nil {
		toSerialize["last_user_modified_date"] = o.LastUserModifiedDate
	}
...
func (o *TransactionStream) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "last_user_modified_date")
