...
type TransactionStream struct {
	...
	PredictedNextDate NullableString `json:"predicted_next_date,omitempty"`
	...
	LastUserModifiedDatetime *time.Time `json:"last_user_modified_datetime,omitempty"`
...
func NewTransactionStream(accountId string, streamId string, category []string, categoryId NullableString, description string, merchantName NullableString, firstDate string, lastDate string, frequency RecurringTransactionFrequency, transactionIds []string, averageAmount TransactionStreamAmount, lastAmount TransactionStreamAmount, isActive bool, status TransactionStreamStatus, isUserModified bool) *TransactionStream {
...
// GetPredictedNextDate returns the PredictedNextDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TransactionStream) GetPredictedNextDate() string {
	if o == nil || o.PredictedNextDate.Get() == nil {
		var ret string
		return ret
	}
	return *o.PredictedNextDate.Get()
}

// GetPredictedNextDateOk returns a tuple with the PredictedNextDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransactionStream) GetPredictedNextDateOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return o.PredictedNextDate.Get(), o.PredictedNextDate.IsSet()
}

// HasPredictedNextDate returns a boolean if a field has been set.
func (o *TransactionStream) HasPredictedNextDate() bool {
	if o != nil && o.PredictedNextDate.IsSet() {
		return true
	}
...
// SetPredictedNextDate gets a reference to the given NullableString and assigns it to the PredictedNextDate field.
func (o *TransactionStream) SetPredictedNextDate(v string) {
	o.PredictedNextDate.Set(&v)
}
// SetPredictedNextDateNil sets the value for PredictedNextDate to be an explicit nil
func (o *TransactionStream) SetPredictedNextDateNil() {
	o.PredictedNextDate.Set(nil)
}

// UnsetPredictedNextDate ensures that no value is present for PredictedNextDate, not even an explicit nil
func (o *TransactionStream) UnsetPredictedNextDate() {
	o.PredictedNextDate.Unset()
}
...
// GetIsUserModified returns the IsUserModified field value
func (o *TransactionStream) GetIsUserModified() bool {
	if o == nil {
		var ret bool
		return ret
	}

	return o.IsUserModified
}

// GetIsUserModifiedOk returns a tuple with the IsUserModified field value
// and a boolean to check if the value has been set.
func (o *TransactionStream) GetIsUserModifiedOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.IsUserModified, true
}

// SetIsUserModified sets field value
func (o *TransactionStream) SetIsUserModified(v bool) {
	o.IsUserModified = v
}

// GetLastUserModifiedDatetime returns the LastUserModifiedDatetime field value if set, zero value otherwise.
func (o *TransactionStream) GetLastUserModifiedDatetime() time.Time {
	if o == nil || o.LastUserModifiedDatetime == nil {
		var ret time.Time
		return ret
	}
	return *o.LastUserModifiedDatetime
}

// GetLastUserModifiedDatetimeOk returns a tuple with the LastUserModifiedDatetime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransactionStream) GetLastUserModifiedDatetimeOk() (*time.Time, bool) {
	if o == nil || o.LastUserModifiedDatetime == nil {
		return nil, false
	}
	return o.LastUserModifiedDatetime, true
}

// HasLastUserModifiedDatetime returns a boolean if a field has been set.
func (o *TransactionStream) HasLastUserModifiedDatetime() bool {
	if o != nil && o.LastUserModifiedDatetime != nil {
		return true
	}
...
// SetLastUserModifiedDatetime gets a reference to the given time.Time and assigns it to the LastUserModifiedDatetime field.
func (o *TransactionStream) SetLastUserModifiedDatetime(v time.Time) {
	o.LastUserModifiedDatetime = &v
}
...
func (o TransactionStream) MarshalJSON() ([]byte, error) {
	...
	if o.PredictedNextDate.IsSet() {
		toSerialize["predicted_next_date"] = o.PredictedNextDate.Get()
	}
	if true {
	...
	if true {
		toSerialize["is_user_modified"] = o.IsUserModified
	}
	if o.LastUserModifiedDatetime != nil {
		toSerialize["last_user_modified_datetime"] = o.LastUserModifiedDatetime
	}
...
func (o *TransactionStream) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "predicted_next_date")
		...
		delete(additionalProperties, "is_user_modified")
		delete(additionalProperties, "last_user_modified_datetime")
