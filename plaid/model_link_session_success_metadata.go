...
type LinkSessionSuccessMetadata struct {
	...
	// An identifier used to group related Layer sessions.
...
// GetSessionGroupId returns the SessionGroupId field value if set, zero value otherwise.
func (o *LinkSessionSuccessMetadata) GetSessionGroupId() string {
	if o == nil || o.SessionGroupId == nil {
		var ret string
		return ret
	}
	return *o.SessionGroupId
}

// GetSessionGroupIdOk returns a tuple with the SessionGroupId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LinkSessionSuccessMetadata) GetSessionGroupIdOk() (*string, bool) {
	if o == nil || o.SessionGroupId == nil {
		return nil, false
	}
	return o.SessionGroupId, true
}

// HasSessionGroupId returns a boolean if a field has been set.
func (o *LinkSessionSuccessMetadata) HasSessionGroupId() bool {
	if o != nil && o.SessionGroupId != nil {
		return true
	}
...
// SetSessionGroupId gets a reference to the given string and assigns it to the SessionGroupId field.
func (o *LinkSessionSuccessMetadata) SetSessionGroupId(v string) {
	o.SessionGroupId = &v
}
...
func (o LinkSessionSuccessMetadata) MarshalJSON() ([]byte, error) {
	...
	if o.SessionGroupId != nil {
		toSerialize["session_group_id"] = o.SessionGroupId
	}
