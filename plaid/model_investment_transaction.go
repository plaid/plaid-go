...
type InvestmentTransaction struct {
	...
	// Timestamp in [ISO 8601](https://wikipedia.org/wiki/ISO_8601) format (`YYYY-MM-DDTHH:mm:ssZ`) representing when the order was initiated. This field is returned for select financial institutions and reflects the value provided by the institution. When the institution only provides a date without time-of-day information, this field will reflect the date that the order was initiated with a time component that defaults to `T00:00:00Z`. This does not indicate that the order was initiated at midnight UTC.
	TransactionDatetime NullableTime `json:"transaction_datetime,omitempty"`
...
func (o *InvestmentTransaction) GetTransactionDatetime() time.Time {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InvestmentTransaction) GetTransactionDatetimeOk() (*time.Time, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentTransaction) HasTransactionDatetime() bool {
...
// SetTransactionDatetime gets a reference to the given NullableTime and assigns it to the TransactionDatetime field.
func (o *InvestmentTransaction) SetTransactionDatetime(v time.Time) {
	o.TransactionDatetime.Set(&v)
}
// SetTransactionDatetimeNil sets the value for TransactionDatetime to be an explicit nil
func (o *InvestmentTransaction) SetTransactionDatetimeNil() {
...
func (o *InvestmentTransaction) UnsetTransactionDatetime() {
...
func (o InvestmentTransaction) MarshalJSON() ([]byte, error) {
	...
	if o.TransactionDatetime.IsSet() {
		toSerialize["transaction_datetime"] = o.TransactionDatetime.Get()
	}
	if true {
...
func (o *InvestmentTransaction) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "transaction_datetime")
