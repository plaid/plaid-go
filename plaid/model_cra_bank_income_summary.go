...
// CraBankIncomeSummary This is a V1 (II1) schema. For the V2 (II2) equivalent, use `CraIncomeInsightsUserSummary`. Summary for income across all income sources and items (max history of 730 days).
type CraBankIncomeSummary struct {
	...
	HistoricalAnnualGrossIncome *[]CreditAmountWithCurrency `json:"historical_annual_gross_income,omitempty"`
	...
	HistoricalAnnualIncome *[]CreditAmountWithCurrency `json:"historical_annual_income,omitempty"`
	// The predicted average annual income amount for the income source(s).
	ForecastedAnnualIncome *[]CreditAmountWithCurrency `json:"forecasted_annual_income,omitempty"`
...
// GetHistoricalAnnualGrossIncome returns the HistoricalAnnualGrossIncome field value if set, zero value otherwise.
func (o *CraBankIncomeSummary) GetHistoricalAnnualGrossIncome() []CreditAmountWithCurrency {
	if o == nil || o.HistoricalAnnualGrossIncome == nil {
		var ret []CreditAmountWithCurrency
		return ret
	}
	return *o.HistoricalAnnualGrossIncome
}

// GetHistoricalAnnualGrossIncomeOk returns a tuple with the HistoricalAnnualGrossIncome field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CraBankIncomeSummary) GetHistoricalAnnualGrossIncomeOk() (*[]CreditAmountWithCurrency, bool) {
	if o == nil || o.HistoricalAnnualGrossIncome == nil {
		return nil, false
	}
	return o.HistoricalAnnualGrossIncome, true
}

// HasHistoricalAnnualGrossIncome returns a boolean if a field has been set.
func (o *CraBankIncomeSummary) HasHistoricalAnnualGrossIncome() bool {
	if o != nil && o.HistoricalAnnualGrossIncome != nil {
		return true
	}
...
// SetHistoricalAnnualGrossIncome gets a reference to the given []CreditAmountWithCurrency and assigns it to the HistoricalAnnualGrossIncome field.
func (o *CraBankIncomeSummary) SetHistoricalAnnualGrossIncome(v []CreditAmountWithCurrency) {
	o.HistoricalAnnualGrossIncome = &v
}

// GetHistoricalAnnualIncome returns the HistoricalAnnualIncome field value if set, zero value otherwise.
func (o *CraBankIncomeSummary) GetHistoricalAnnualIncome() []CreditAmountWithCurrency {
	if o == nil || o.HistoricalAnnualIncome == nil {
		var ret []CreditAmountWithCurrency
		return ret
	}
...
// GetHistoricalAnnualIncomeOk returns a tuple with the HistoricalAnnualIncome field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CraBankIncomeSummary) GetHistoricalAnnualIncomeOk() (*[]CreditAmountWithCurrency, bool) {
	if o == nil || o.HistoricalAnnualIncome == nil {
		return nil, false
	}
...
// HasHistoricalAnnualIncome returns a boolean if a field has been set.
func (o *CraBankIncomeSummary) HasHistoricalAnnualIncome() bool {
	if o != nil && o.HistoricalAnnualIncome != nil {
		return true
	}
...
// SetHistoricalAnnualIncome gets a reference to the given []CreditAmountWithCurrency and assigns it to the HistoricalAnnualIncome field.
func (o *CraBankIncomeSummary) SetHistoricalAnnualIncome(v []CreditAmountWithCurrency) {
	o.HistoricalAnnualIncome = &v
}

// GetForecastedAnnualIncome returns the ForecastedAnnualIncome field value if set, zero value otherwise.
func (o *CraBankIncomeSummary) GetForecastedAnnualIncome() []CreditAmountWithCurrency {
	if o == nil || o.ForecastedAnnualIncome == nil {
		var ret []CreditAmountWithCurrency
		return ret
	}
	return *o.ForecastedAnnualIncome
}

// GetForecastedAnnualIncomeOk returns a tuple with the ForecastedAnnualIncome field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CraBankIncomeSummary) GetForecastedAnnualIncomeOk() (*[]CreditAmountWithCurrency, bool) {
	if o == nil || o.ForecastedAnnualIncome == nil {
		return nil, false
	}
	return o.ForecastedAnnualIncome, true
}

// HasForecastedAnnualIncome returns a boolean if a field has been set.
func (o *CraBankIncomeSummary) HasForecastedAnnualIncome() bool {
	if o != nil && o.ForecastedAnnualIncome != nil {
		return true
	}
...
// SetForecastedAnnualIncome gets a reference to the given []CreditAmountWithCurrency and assigns it to the ForecastedAnnualIncome field.
func (o *CraBankIncomeSummary) SetForecastedAnnualIncome(v []CreditAmountWithCurrency) {
	o.ForecastedAnnualIncome = &v
}
...
func (o CraBankIncomeSummary) MarshalJSON() ([]byte, error) {
	...
	if o.HistoricalAnnualGrossIncome != nil {
		toSerialize["historical_annual_gross_income"] = o.HistoricalAnnualGrossIncome
	}
	if o.HistoricalAnnualIncome != nil {
		toSerialize["historical_annual_income"] = o.HistoricalAnnualIncome
	}
	if o.ForecastedAnnualIncome != nil {
		toSerialize["forecasted_annual_income"] = o.ForecastedAnnualIncome
	}
...
func (o *CraBankIncomeSummary) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "historical_annual_gross_income")
		delete(additionalProperties, "historical_annual_income")
		delete(additionalProperties, "forecasted_annual_income")
