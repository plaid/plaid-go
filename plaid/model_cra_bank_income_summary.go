...
type CraBankIncomeSummary struct {
	...
	ForcastedAverageMonthlyIncome *[]CreditAmountWithCurrency `json:"forcasted_average_monthly_income,omitempty"`
...
func (o *CraBankIncomeSummary) GetForcastedAverageMonthlyIncome() []CreditAmountWithCurrency {
...
// and a boolean to check if the value has been set.
func (o *CraBankIncomeSummary) GetForcastedAverageMonthlyIncomeOk() (*[]CreditAmountWithCurrency, bool) {
	if o == nil || o.ForcastedAverageMonthlyIncome == nil {
		return nil, false
	}
...
func (o *CraBankIncomeSummary) HasForcastedAverageMonthlyIncome() bool {
	if o != nil && o.ForcastedAverageMonthlyIncome != nil {
		return true
	}
...
// SetForcastedAverageMonthlyIncome gets a reference to the given []CreditAmountWithCurrency and assigns it to the ForcastedAverageMonthlyIncome field.
func (o *CraBankIncomeSummary) SetForcastedAverageMonthlyIncome(v []CreditAmountWithCurrency) {
...
func (o *CraBankIncomeSummary) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "forcasted_average_monthly_income")
