...
func (o *TransactionsSyncRequestOptions) GetPersonalFinanceCategoryVersion() string {
...
// and a boolean to check if the value has been set.
func (o *TransactionsSyncRequestOptions) GetPersonalFinanceCategoryVersionOk() (*string, bool) {
	if o == nil || o.PersonalFinanceCategoryVersion == nil {
		return nil, false
	}
...
func (o *TransactionsSyncRequestOptions) SetPersonalFinanceCategoryVersion(v string) {
