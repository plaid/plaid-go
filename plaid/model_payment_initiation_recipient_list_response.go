...
func (o *PaymentInitiationRecipientListResponse) GetNextCursor() string {
...
// and a boolean to check if the value has been set.
func (o *PaymentInitiationRecipientListResponse) GetNextCursorOk() (*string, bool) {
	if o == nil || o.NextCursor == nil {
		return nil, false
	}
...
func (o *PaymentInitiationRecipientListResponse) HasNextCursor() bool {
	if o != nil && o.NextCursor != nil {
		return true
	}
...
func (o *PaymentInitiationRecipientListResponse) SetNextCursor(v string) {
	o.NextCursor = &v
}
