...
type BaseReport struct {
	...
	Attributes *BaseReportUserAttributes `json:"attributes,omitempty"`
...
func (o *BaseReport) GetAttributes() BaseReportUserAttributes {
	if o == nil || o.Attributes == nil {
		var ret BaseReportUserAttributes
		return ret
	}
	return *o.Attributes
}
...
// and a boolean to check if the value has been set.
func (o *BaseReport) GetAttributesOk() (*BaseReportUserAttributes, bool) {
	if o == nil || o.Attributes == nil {
		return nil, false
	}
...
func (o *BaseReport) HasAttributes() bool {
	if o != nil && o.Attributes != nil {
		return true
	}
...
// SetAttributes gets a reference to the given BaseReportUserAttributes and assigns it to the Attributes field.
func (o *BaseReport) SetAttributes(v BaseReportUserAttributes) {
	o.Attributes = &v
}
