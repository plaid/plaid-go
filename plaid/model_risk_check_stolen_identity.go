...
func (o *RiskCheckStolenIdentity) GetRiskLevel() RiskLevel {
...
// and a boolean to check if the value has been set.
func (o *RiskCheckStolenIdentity) GetRiskLevelOk() (*RiskLevel, bool) {
	if o == nil || o.RiskLevel == nil {
		return nil, false
	}
...
func (o *RiskCheckStolenIdentity) HasRiskLevel() bool {
	if o != nil && o.RiskLevel != nil {
		return true
	}
...
func (o *RiskCheckStolenIdentity) SetRiskLevel(v RiskLevel) {
	o.RiskLevel = &v
}
