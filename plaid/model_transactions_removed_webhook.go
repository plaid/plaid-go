...
func NewTransactionsRemovedWebhook(webhookType string, webhookCode string, removedTransactions []string, itemId string, environment WebhookEnvironmentValues) *TransactionsRemovedWebhook {
...
func (o *TransactionsRemovedWebhook) GetEnvironment() WebhookEnvironmentValues {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TransactionsRemovedWebhook) GetEnvironmentOk() (*WebhookEnvironmentValues, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransactionsRemovedWebhook) SetEnvironment(v WebhookEnvironmentValues) {
	o.Environment = v
}
