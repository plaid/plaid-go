...
type SandboxIncomeFireWebhookRequest struct {
	...
	WebhookCode SandboxIncomeWebhookFireRequestWebhookCode `json:"webhook_code"`
}
...
func NewSandboxIncomeFireWebhookRequest(itemId string, webhook string, webhookCode SandboxIncomeWebhookFireRequestWebhookCode) *SandboxIncomeFireWebhookRequest {
...
func (o *SandboxIncomeFireWebhookRequest) HasVerificationStatus() bool {
	if o != nil && o.VerificationStatus != nil {
		return true
	}
...
func (o *SandboxIncomeFireWebhookRequest) GetWebhookCode() SandboxIncomeWebhookFireRequestWebhookCode {
	if o == nil {
		var ret SandboxIncomeWebhookFireRequestWebhookCode
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SandboxIncomeFireWebhookRequest) GetWebhookCodeOk() (*SandboxIncomeWebhookFireRequestWebhookCode, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *SandboxIncomeFireWebhookRequest) SetWebhookCode(v SandboxIncomeWebhookFireRequestWebhookCode) {
	o.WebhookCode = v
}
