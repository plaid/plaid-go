...
type ItemImportRequestUserAuth struct {
	// Your persistent, unique identifier for the customer.
	UserId string `json:"user_id"`
	// Authorization token used by the legacy Plaid Exchange integration; not required for Permissions Manager callers.
...
func NewItemImportRequestUserAuth(userId string) *ItemImportRequestUserAuth {
...
func (o *ItemImportRequestUserAuth) HasAuthToken() bool {
	if o != nil && o.AuthToken != nil {
		return true
	}
