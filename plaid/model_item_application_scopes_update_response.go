...
type _ItemApplicationScopesUpdateResponse ItemApplicationScopesUpdateResponse
...
func (o *ItemApplicationScopesUpdateResponse) UnmarshalJSON(bytes []byte) (err error) {
	varItemApplicationScopesUpdateResponse := _ItemApplicationScopesUpdateResponse{}

	if err = json.Unmarshal(bytes, &varItemApplicationScopesUpdateResponse); err == nil {
		*o = ItemApplicationScopesUpdateResponse(varItemApplicationScopesUpdateResponse)
	} else {
		return err
	}
