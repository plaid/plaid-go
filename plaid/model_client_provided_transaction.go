...
func (o *ClientProvidedTransaction) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *ClientProvidedTransaction) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *ClientProvidedTransaction) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *ClientProvidedTransaction) SetUserId(v string) {
	o.UserId = &v
}
