...
func (o *CreditPayrollIncomeGetRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *CreditPayrollIncomeGetRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *CreditPayrollIncomeGetRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *CreditPayrollIncomeGetRequest) SetUserId(v string) {
	o.UserId = &v
}
