...
func (o *LinkTokenGetMetadataResponse) GetUserToken() string {
...
// and a boolean to check if the value has been set.
func (o *LinkTokenGetMetadataResponse) GetUserTokenOk() (*string, bool) {
	if o == nil || o.UserToken == nil {
		return nil, false
	}
...
func (o *LinkTokenGetMetadataResponse) HasUserToken() bool {
	if o != nil && o.UserToken != nil {
		return true
	}
...
func (o *LinkTokenGetMetadataResponse) SetUserToken(v string) {
	o.UserToken = &v
}
