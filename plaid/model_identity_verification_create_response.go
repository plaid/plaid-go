...
// IdentityVerificationCreateResponse An identity verification attempt represents a customer's attempt to verify their identity, reflecting the required steps for completing the session, the results for each step, and information collected in the process.
...
// If the value is explicit nil, the zero value for string will be returned
func (o *IdentityVerificationCreateResponse) GetUserId() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IdentityVerificationCreateResponse) GetUserIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *IdentityVerificationCreateResponse) SetUserId(v string) {
	o.UserId.Set(&v)
}
...
func (o *IdentityVerificationCreateResponse) GetLatestScoredProtectEvent() IDVProtectEvent {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IdentityVerificationCreateResponse) GetLatestScoredProtectEventOk() (*IDVProtectEvent, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *IdentityVerificationCreateResponse) HasLatestScoredProtectEvent() bool {
...
func (o *IdentityVerificationCreateResponse) SetLatestScoredProtectEvent(v IDVProtectEvent) {
...
func (o *IdentityVerificationCreateResponse) SetLatestScoredProtectEventNil() {
...
func (o *IdentityVerificationCreateResponse) UnsetLatestScoredProtectEvent() {
