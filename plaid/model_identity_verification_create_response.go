...
func (o *IdentityVerificationCreateResponse) HasUserId() bool {
...
func (o *IdentityVerificationCreateResponse) SetUserIdNil() {
	o.UserId.Set(nil)
}

// UnsetUserId ensures that no value is present for UserId, not even an explicit nil
func (o *IdentityVerificationCreateResponse) UnsetUserId() {
	o.UserId.Unset()
}
