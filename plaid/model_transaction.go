...
type Transaction struct {
	...
	// The URL of a logo associated with this transaction, if available. The logo will always be a 100×100 pixel PNG file.
	...
	// The URL of an icon associated with the primary personal finance category. The icon will always be a 100×100 pixel PNG file.
	...
	RunningBalance NullableFloat64 `json:"running_balance,omitempty"`
...
func (o *Transaction) SetCategoryIdNil() {
...
func (o *Transaction) GetBusinessFinanceCategory() BusinessFinanceCategory {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Transaction) GetBusinessFinanceCategoryOk() (*BusinessFinanceCategory, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *Transaction) HasBusinessFinanceCategory() bool {
...
func (o *Transaction) SetBusinessFinanceCategory(v BusinessFinanceCategory) {
...
func (o *Transaction) SetBusinessFinanceCategoryNil() {
...
func (o *Transaction) UnsetBusinessFinanceCategory() {
...
func (o *Transaction) GetMerchantCategoryCode() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Transaction) GetMerchantCategoryCodeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *Transaction) HasMerchantCategoryCode() bool {
...
func (o *Transaction) UnsetMerchantCategoryCode() {
...
func (o *Transaction) GetRunningBalance() float64 {
	if o == nil || o.RunningBalance.Get() == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Transaction) GetRunningBalanceOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
// SetRunningBalance gets a reference to the given NullableFloat64 and assigns it to the RunningBalance field.
func (o *Transaction) SetRunningBalance(v float64) {
	o.RunningBalance.Set(&v)
}
// SetRunningBalanceNil sets the value for RunningBalance to be an explicit nil
func (o *Transaction) SetRunningBalanceNil() {
	o.RunningBalance.Set(nil)
}

// UnsetRunningBalance ensures that no value is present for RunningBalance, not even an explicit nil
func (o *Transaction) UnsetRunningBalance() {
...
func (o *Transaction) GetClientCustomization() ClientCustomization {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Transaction) GetClientCustomizationOk() (*ClientCustomization, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *Transaction) HasClientCustomization() bool {
...
func (o *Transaction) UnsetClientCustomization() {
...
func (o Transaction) MarshalJSON() ([]byte, error) {
	...
	if o.RunningBalance.IsSet() {
		toSerialize["running_balance"] = o.RunningBalance.Get()
	}
