...
type CraBankIncomeSource struct {
	...
	ForecastedAverageMonthlyIncomePredictionInterval []CraPredictionInterval `json:"forecasted_average_monthly_income_prediction_interval"`
...
func NewCraBankIncomeSource(forecastedAverageMonthlyIncomePredictionInterval []CraPredictionInterval) *CraBankIncomeSource {
...
// GetForecastedAverageMonthlyIncomePredictionInterval returns the ForecastedAverageMonthlyIncomePredictionInterval field value
func (o *CraBankIncomeSource) GetForecastedAverageMonthlyIncomePredictionInterval() []CraPredictionInterval {
	if o == nil {
		var ret []CraPredictionInterval
		return ret
	}

	return o.ForecastedAverageMonthlyIncomePredictionInterval
}

// GetForecastedAverageMonthlyIncomePredictionIntervalOk returns a tuple with the ForecastedAverageMonthlyIncomePredictionInterval field value
// and a boolean to check if the value has been set.
func (o *CraBankIncomeSource) GetForecastedAverageMonthlyIncomePredictionIntervalOk() (*[]CraPredictionInterval, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.ForecastedAverageMonthlyIncomePredictionInterval, true
}

// SetForecastedAverageMonthlyIncomePredictionInterval sets field value
func (o *CraBankIncomeSource) SetForecastedAverageMonthlyIncomePredictionInterval(v []CraPredictionInterval) {
	o.ForecastedAverageMonthlyIncomePredictionInterval = v
}
...
func (o CraBankIncomeSource) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["forecasted_average_monthly_income_prediction_interval"] = o.ForecastedAverageMonthlyIncomePredictionInterval
	}
	if o.Employer != nil {
