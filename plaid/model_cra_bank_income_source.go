...
type CraBankIncomeSource struct {
	...
	Status *CraBankIncomeStatus `json:"status,omitempty"`
...
type _CraBankIncomeSource CraBankIncomeSource

// NewCraBankIncomeSource instantiates a new CraBankIncomeSource object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCraBankIncomeSource(forecastedAverageMonthlyIncomePredictionIntervals []CraPredictionInterval, incomeProvider NullableCraBankIncomeIncomeProvider) *CraBankIncomeSource {
...
func (o *CraBankIncomeSource) GetStatus() CraBankIncomeStatus {
...
// and a boolean to check if the value has been set.
func (o *CraBankIncomeSource) GetStatusOk() (*CraBankIncomeStatus, bool) {
	if o == nil || o.Status == nil {
		return nil, false
	}
...
func (o *CraBankIncomeSource) HasStatus() bool {
	if o != nil && o.Status != nil {
		return true
	}
...
// SetStatus gets a reference to the given CraBankIncomeStatus and assigns it to the Status field.
func (o *CraBankIncomeSource) SetStatus(v CraBankIncomeStatus) {
	o.Status = &v
}
...
func (o *CraBankIncomeSource) GetIncomeProvider() CraBankIncomeIncomeProvider {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CraBankIncomeSource) GetIncomeProviderOk() (*CraBankIncomeIncomeProvider, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CraBankIncomeSource) SetIncomeProvider(v CraBankIncomeIncomeProvider) {
...
func (o *CraBankIncomeSource) UnmarshalJSON(bytes []byte) (err error) {
	varCraBankIncomeSource := _CraBankIncomeSource{}

	if err = json.Unmarshal(bytes, &varCraBankIncomeSource); err == nil {
		*o = CraBankIncomeSource(varCraBankIncomeSource)
	} else {
		return err
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "forecasted_average_monthly_income_prediction_intervals")
