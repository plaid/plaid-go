...
func (o *IdentityVerificationCreateRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *IdentityVerificationCreateRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *IdentityVerificationCreateRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *IdentityVerificationCreateRequest) SetUserId(v string) {
	o.UserId = &v
}
