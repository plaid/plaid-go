...
func NewAssetReportTransaction(originalDescription NullableString, accountId string, amount float32, isoCurrencyCode NullableString, unofficialCurrencyCode NullableString, date string, pending bool, transactionId string, merchantName NullableString, checkNumber NullableString) *AssetReportTransaction {
