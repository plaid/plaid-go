...
func NewRecurringTransferNullable(recurringTransferId string, created time.Time, nextOriginationDate NullableString, type_ TransferType, amount string, status TransferRecurringStatus, network TransferRecurringNetwork, originationAccountId string, accountId string, fundingAccountId string, isoCurrencyCode string, description string, transferIds []string, user TransferUserInResponse, schedule TransferRecurringSchedule) *RecurringTransferNullable {
...
func (o *RecurringTransferNullable) GetNetwork() TransferRecurringNetwork {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *RecurringTransferNullable) GetNetworkOk() (*TransferRecurringNetwork, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *RecurringTransferNullable) SetNetwork(v TransferRecurringNetwork) {
	o.Network = v
}
