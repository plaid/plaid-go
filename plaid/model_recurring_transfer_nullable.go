...
func NewRecurringTransferNullable(recurringTransferId string, created time.Time, nextOriginationDate NullableString, type_ TransferType, amount string, status TransferRecurringStatus, network TransferACHNetwork, originationAccountId string, accountId string, fundingAccountId string, isoCurrencyCode string, description string, transferIds []string, user TransferUserInResponse, schedule TransferRecurringSchedule) *RecurringTransferNullable {
...
func (o *RecurringTransferNullable) GetNetwork() TransferACHNetwork {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *RecurringTransferNullable) GetNetworkOk() (*TransferACHNetwork, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *RecurringTransferNullable) SetNetwork(v TransferACHNetwork) {
	o.Network = v
}
