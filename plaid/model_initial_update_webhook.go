...
func NewInitialUpdateWebhook(webhookType string, webhookCode string, newTransactions float32, itemId string, environment WebhookEnvironmentValues) *InitialUpdateWebhook {
...
func (o *InitialUpdateWebhook) GetEnvironment() WebhookEnvironmentValues {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *InitialUpdateWebhook) GetEnvironmentOk() (*WebhookEnvironmentValues, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InitialUpdateWebhook) SetEnvironment(v WebhookEnvironmentValues) {
	o.Environment = v
}
