...
type PaymentInitiationPaymentGetResponse struct {
	...
	Schedule NullableExternalPaymentScheduleGet `json:"schedule"`
...
func NewPaymentInitiationPaymentGetResponse(paymentId string, amount PaymentAmount, status string, recipientId string, reference string, lastStatusUpdate time.Time, schedule NullableExternalPaymentScheduleGet, bacs NullableSenderBACSNullable, iban NullableString, requestId string) *PaymentInitiationPaymentGetResponse {
...
// If the value is explicit nil, the zero value for ExternalPaymentScheduleGet will be returned
