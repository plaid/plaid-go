...
const (
	...
	CREDITSESSIONBANKINCOMESTATUS_STARTED CreditSessionBankIncomeStatus = "STARTED"
	CREDITSESSIONBANKINCOMESTATUS_INTERNAL_ERROR CreditSessionBankIncomeStatus = "INTERNAL_ERROR"
)
