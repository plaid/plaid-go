...
// UserAddress Home address for the user. Supported values are: not provided, address with only country code or full address.  For more context on this field, see [Input Validation by Country](https://plaid.com/docs/identity-verification/hybrid-input-validation/#input-validation-by-country).
...
func NewUserAddress(country string) *UserAddress {
	this := UserAddress{}
...
func (o *UserAddress) HasStreet() bool {
...
func (o *UserAddress) SetStreetNil() {
	o.Street.Set(nil)
}

// UnsetStreet ensures that no value is present for Street, not even an explicit nil
func (o *UserAddress) UnsetStreet() {
	o.Street.Unset()
}
...
func (o *UserAddress) SetCityNil() {
	o.City.Set(nil)
}

// UnsetCity ensures that no value is present for City, not even an explicit nil
func (o *UserAddress) UnsetCity() {
	o.City.Unset()
}
