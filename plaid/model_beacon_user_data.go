...
type BeaconUserData struct {
	...
	IdNumber BeaconUserIDNumber `json:"id_number"`
...
func NewBeaconUserData(dateOfBirth string, name BeaconUserName, address BeaconUserAddress, emailAddress NullableString, phoneNumber NullableString, idNumber BeaconUserIDNumber, ipAddress NullableString) *BeaconUserData {
	this := BeaconUserData{}
