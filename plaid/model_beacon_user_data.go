...
func NewBeaconUserData(dateOfBirth string, name BeaconUserName, address BeaconUserAddress, emailAddress NullableString, phoneNumber NullableString, idNumber NullableBeaconUserIDNumber, ipAddress NullableString) *BeaconUserData {
	this := BeaconUserData{}
