...
type FDXNotification struct {
	...
	Publisher *FDXParty `json:"publisher,omitempty"`
...
func NewFDXNotification(notificationId string, type_ FDXNotificationType, sentOn time.Time, category FDXNotificationCategory, notificationPayload FDXNotificationPayload) *FDXNotification {
...
func (o *FDXNotification) GetSubtype() string {
...
// and a boolean to check if the value has been set.
func (o *FDXNotification) GetSubtypeOk() (*string, bool) {
	if o == nil || o.Subtype == nil {
		return nil, false
	}
...
func (o *FDXNotification) HasSubtype() bool {
	if o != nil && o.Subtype != nil {
		return true
	}
...
func (o *FDXNotification) SetSubtype(v string) {
	o.Subtype = &v
}
...
func (o *FDXNotification) HasPublisher() bool {
	if o != nil && o.Publisher != nil {
		return true
	}
...
// SetPublisher gets a reference to the given FDXParty and assigns it to the Publisher field.
