...
func NewInvestmentsAuthGetResponse(accounts []AccountBase, holdings []Holding, securities []Security, owners []InvestmentsAuthOwner, numbers InvestmentsAuthGetNumbers, dataSources InvestmentsAuthDataSources, item Item, requestId string) *InvestmentsAuthGetResponse {
