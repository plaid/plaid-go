...
func NewInvestmentsAuthGetResponse(accounts []InvestmentAccount, holdings []Holding, securities []Security, owners []InvestmentsAuthOwner, numbers InvestmentsAuthGetNumbers, dataSources InvestmentsAuthDataSources, item Item, requestId string) *InvestmentsAuthGetResponse {
...
func (o *InvestmentsAuthGetResponse) GetAccounts() []InvestmentAccount {
	if o == nil {
		var ret []InvestmentAccount
		return ret
	}
...
func (o *InvestmentsAuthGetResponse) GetAccountsOk() (*[]InvestmentAccount, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentsAuthGetResponse) SetAccounts(v []InvestmentAccount) {
	o.Accounts = v
}
...
func (o *InvestmentsAuthGetResponse) GetDataSources() InvestmentsAuthDataSources {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *InvestmentsAuthGetResponse) GetDataSourcesOk() (*InvestmentsAuthDataSources, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentsAuthGetResponse) SetDataSources(v InvestmentsAuthDataSources) {
	o.DataSources = v
}

// GetAccountDetails401k returns the AccountDetails401k field value if set, zero value otherwise.
func (o *InvestmentsAuthGetResponse) GetAccountDetails401k() []InvestmentsAuthAccountDetails401k {
...
// and a boolean to check if the value has been set.
func (o *InvestmentsAuthGetResponse) GetAccountDetails401kOk() (*[]InvestmentsAuthAccountDetails401k, bool) {
	if o == nil || o.AccountDetails401k == nil {
		return nil, false
	}
...
func (o *InvestmentsAuthGetResponse) HasAccountDetails401k() bool {
	if o != nil && o.AccountDetails401k != nil {
		return true
	}
...
func (o *InvestmentsAuthGetResponse) SetAccountDetails401k(v []InvestmentsAuthAccountDetails401k) {
