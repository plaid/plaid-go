...
// ProcessorInvestmentsTransactionsGetResponse ProcessorInvestmentsTransactionsGetResponse defines the response schema for `/processor/investments/transactions/get`
...
func NewProcessorInvestmentsTransactionsGetResponse(account InvestmentAccount, investmentTransactions []InvestmentTransaction, securities []Security, totalInvestmentTransactions int32, requestId string) *ProcessorInvestmentsTransactionsGetResponse {
...
func (o *ProcessorInvestmentsTransactionsGetResponse) GetAccount() InvestmentAccount {
	if o == nil {
...
func (o *ProcessorInvestmentsTransactionsGetResponse) GetAccountOk() (*InvestmentAccount, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *ProcessorInvestmentsTransactionsGetResponse) SetAccount(v InvestmentAccount) {
	o.Account = v
}
