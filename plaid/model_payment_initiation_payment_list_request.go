...
func (o *PaymentInitiationPaymentListRequest) GetConsentId() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PaymentInitiationPaymentListRequest) GetConsentIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *PaymentInitiationPaymentListRequest) HasConsentId() bool {
...
func (o *PaymentInitiationPaymentListRequest) SetConsentId(v string) {
	o.ConsentId.Set(&v)
}
// SetConsentIdNil sets the value for ConsentId to be an explicit nil
func (o *PaymentInitiationPaymentListRequest) SetConsentIdNil() {
	o.ConsentId.Set(nil)
}

// UnsetConsentId ensures that no value is present for ConsentId, not even an explicit nil
func (o *PaymentInitiationPaymentListRequest) UnsetConsentId() {
	o.ConsentId.Unset()
}
