...
type _IdentityVerificationUserData IdentityVerificationUserData
...
func NewIdentityVerificationUserData(dateOfBirth NullableString, ipAddress NullableString, emailAddress NullableString, name NullableIdentityVerificationResponseUserName, address NullableIdentityVerificationUserAddress, idNumber NullableUserIDNumber) *IdentityVerificationUserData {
...
func (o *IdentityVerificationUserData) GetName() IdentityVerificationResponseUserName {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IdentityVerificationUserData) GetNameOk() (*IdentityVerificationResponseUserName, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *IdentityVerificationUserData) SetName(v IdentityVerificationResponseUserName) {
	o.Name.Set(&v)
}
...
func (o *IdentityVerificationUserData) UnmarshalJSON(bytes []byte) (err error) {
	varIdentityVerificationUserData := _IdentityVerificationUserData{}

	if err = json.Unmarshal(bytes, &varIdentityVerificationUserData); err == nil {
		*o = IdentityVerificationUserData(varIdentityVerificationUserData)
	} else {
		return err
	}
