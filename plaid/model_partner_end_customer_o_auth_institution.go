...
type PartnerEndCustomerOAuthInstitution struct {
	...
	Errors *[]PlaidError `json:"errors,omitempty"`
...
func (o *PartnerEndCustomerOAuthInstitution) GetErrors() []PlaidError {
...
// and a boolean to check if the value has been set.
func (o *PartnerEndCustomerOAuthInstitution) GetErrorsOk() (*[]PlaidError, bool) {
	if o == nil || o.Errors == nil {
		return nil, false
	}
...
func (o *PartnerEndCustomerOAuthInstitution) HasErrors() bool {
	if o != nil && o.Errors != nil {
		return true
	}
...
// SetErrors gets a reference to the given []PlaidError and assigns it to the Errors field.
func (o *PartnerEndCustomerOAuthInstitution) SetErrors(v []PlaidError) {
	o.Errors = &v
}
