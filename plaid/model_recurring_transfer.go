...
func NewRecurringTransfer(recurringTransferId string, created time.Time, nextOriginationDate string, type_ TransferType, amount string, status TransferRecurringStatus, network TransferNetwork, originationAccountId string, accountId string, isoCurrencyCode string, description string, transferIds []string, user TransferUserInResponse, schedule TransferRecurringSchedule) *RecurringTransfer {
