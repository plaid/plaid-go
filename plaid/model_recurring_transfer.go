...
func NewRecurringTransfer(recurringTransferId string, created time.Time, nextOriginationDate NullableString, type_ TransferType, amount string, status TransferRecurringStatus, network TransferACHNetwork, originationAccountId string, accountId string, fundingAccountId string, isoCurrencyCode string, description string, transferIds []string, user TransferUserInResponse, schedule TransferRecurringSchedule) *RecurringTransfer {
...
func (o *RecurringTransfer) GetNetwork() TransferACHNetwork {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *RecurringTransfer) GetNetworkOk() (*TransferACHNetwork, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *RecurringTransfer) SetNetwork(v TransferACHNetwork) {
	o.Network = v
}
