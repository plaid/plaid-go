...
func NewRecurringTransfer(recurringTransferId string, created time.Time, nextOriginationDate NullableString, type_ TransferType, amount string, status TransferRecurringStatus, network TransferRecurringNetwork, originationAccountId string, accountId string, fundingAccountId string, isoCurrencyCode string, description string, transferIds []string, user TransferUserInResponse, schedule TransferRecurringSchedule) *RecurringTransfer {
...
func (o *RecurringTransfer) GetNetwork() TransferRecurringNetwork {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *RecurringTransfer) GetNetworkOk() (*TransferRecurringNetwork, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *RecurringTransfer) SetNetwork(v TransferRecurringNetwork) {
	o.Network = v
}
