...
const (
	...
	WALLETTRANSACTIONFAILUREREASON_ACCOUNT_INVALID WalletTransactionFailureReason = "ACCOUNT_INVALID"
	WALLETTRANSACTIONFAILUREREASON_AUTHENTICATION_FAILED WalletTransactionFailureReason = "AUTHENTICATION_FAILED"
