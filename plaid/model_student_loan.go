...
type StudentLoan struct {
	...
	LastStatementBalance NullableFloat64 `json:"last_statement_balance,omitempty"`
	...
	OutstandingInterestAmount NullableFloat64 `json:"outstanding_interest_amount"`
...
func NewStudentLoan(accountId NullableString, accountNumber NullableString, disbursementDates []string, expectedPayoffDate NullableString, guarantor NullableString, interestRatePercentage float64, isOverdue NullableBool, lastPaymentAmount NullableFloat64, lastPaymentDate NullableString, lastStatementIssueDate NullableString, loanName NullableString, loanStatus StudentLoanStatus, minimumPaymentAmount NullableFloat64, nextPaymentDueDate NullableString, originationDate NullableString, originationPrincipalAmount NullableFloat64, outstandingInterestAmount NullableFloat64, paymentReferenceNumber NullableString, pslfStatus PSLFStatus, repaymentPlan StudentRepaymentPlan, sequenceNumber NullableString, servicerAddress ServicerAddressData, ytdInterestPaid NullableFloat64, ytdPrincipalPaid NullableFloat64) *StudentLoan {
	this := StudentLoan{}
...
func (o *StudentLoan) GetInterestRatePercentage() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *StudentLoan) GetInterestRatePercentageOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *StudentLoan) SetInterestRatePercentage(v float64) {
...
func (o *StudentLoan) GetLastPaymentAmount() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *StudentLoan) GetLastPaymentAmountOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *StudentLoan) SetLastPaymentAmount(v float64) {
...
func (o *StudentLoan) GetLastStatementBalance() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *StudentLoan) GetLastStatementBalanceOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
// SetLastStatementBalance gets a reference to the given NullableFloat64 and assigns it to the LastStatementBalance field.
func (o *StudentLoan) SetLastStatementBalance(v float64) {
...
// If the value is explicit nil, the zero value for float64 will be returned
func (o *StudentLoan) GetMinimumPaymentAmount() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *StudentLoan) GetMinimumPaymentAmountOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *StudentLoan) SetMinimumPaymentAmount(v float64) {
...
// If the value is explicit nil, the zero value for float64 will be returned
func (o *StudentLoan) GetOriginationPrincipalAmount() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *StudentLoan) GetOriginationPrincipalAmountOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *StudentLoan) SetOriginationPrincipalAmount(v float64) {
	o.OriginationPrincipalAmount.Set(&v)
}

// GetOutstandingInterestAmount returns the OutstandingInterestAmount field value
// If the value is explicit nil, the zero value for float64 will be returned
func (o *StudentLoan) GetOutstandingInterestAmount() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *StudentLoan) GetOutstandingInterestAmountOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *StudentLoan) SetOutstandingInterestAmount(v float64) {
...
// If the value is explicit nil, the zero value for float64 will be returned
func (o *StudentLoan) GetYtdInterestPaid() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *StudentLoan) GetYtdInterestPaidOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *StudentLoan) SetYtdInterestPaid(v float64) {
	o.YtdInterestPaid.Set(&v)
}

// GetYtdPrincipalPaid returns the YtdPrincipalPaid field value
// If the value is explicit nil, the zero value for float64 will be returned
func (o *StudentLoan) GetYtdPrincipalPaid() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *StudentLoan) GetYtdPrincipalPaidOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *StudentLoan) SetYtdPrincipalPaid(v float64) {
