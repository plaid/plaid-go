...
func NewBaseReportsProductReadyWebhook(webhookType string, webhookCode string, userId string, environment WebhookEnvironmentValues) *BaseReportsProductReadyWebhook {
