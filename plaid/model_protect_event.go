...
type ProtectEvent struct {
	...
	// If present, contains the current Device Session ID from the Protect SDK.
...
// GetDeviceSessionId returns the DeviceSessionId field value if set, zero value otherwise.
func (o *ProtectEvent) GetDeviceSessionId() string {
	if o == nil || o.DeviceSessionId == nil {
		var ret string
		return ret
	}
...
// GetDeviceSessionIdOk returns a tuple with the DeviceSessionId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProtectEvent) GetDeviceSessionIdOk() (*string, bool) {
	if o == nil || o.DeviceSessionId == nil {
		return nil, false
	}
...
// HasDeviceSessionId returns a boolean if a field has been set.
func (o *ProtectEvent) HasDeviceSessionId() bool {
	if o != nil && o.DeviceSessionId != nil {
		return true
	}
...
// SetDeviceSessionId gets a reference to the given string and assigns it to the DeviceSessionId field.
func (o *ProtectEvent) SetDeviceSessionId(v string) {
	o.DeviceSessionId = &v
}
...
func (o *ProtectEvent) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "device_session_id")
