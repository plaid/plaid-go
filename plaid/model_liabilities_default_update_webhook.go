...
func NewLiabilitiesDefaultUpdateWebhook(webhookType string, webhookCode string, itemId string, error_ NullablePlaidError, accountIdsWithNewLiabilities []string, accountIdsWithUpdatedLiabilities map[string][]string, environment WebhookEnvironmentValues) *LiabilitiesDefaultUpdateWebhook {
...
func (o *LiabilitiesDefaultUpdateWebhook) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *LiabilitiesDefaultUpdateWebhook) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *LiabilitiesDefaultUpdateWebhook) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *LiabilitiesDefaultUpdateWebhook) SetUserId(v string) {
	o.UserId = &v
}
...
func (o *LiabilitiesDefaultUpdateWebhook) GetEnvironment() WebhookEnvironmentValues {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *LiabilitiesDefaultUpdateWebhook) GetEnvironmentOk() (*WebhookEnvironmentValues, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *LiabilitiesDefaultUpdateWebhook) SetEnvironment(v WebhookEnvironmentValues) {
	o.Environment = v
}
