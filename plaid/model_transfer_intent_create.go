...
func NewTransferIntentCreate(id string, created time.Time, status TransferIntentStatus, originationAccountId string, amount string, mode TransferIntentCreateMode, user TransferUserInResponse, description string, isoCurrencyCode string) *TransferIntentCreate {
