...
type LinkTokenInvestments struct {
	...
	AllowManualEntry *bool `json:"allow_manual_entry,omitempty"`
}
...
// GetAllowManualEntry returns the AllowManualEntry field value if set, zero value otherwise.
func (o *LinkTokenInvestments) GetAllowManualEntry() bool {
	if o == nil || o.AllowManualEntry == nil {
		var ret bool
		return ret
	}
	return *o.AllowManualEntry
}

// GetAllowManualEntryOk returns a tuple with the AllowManualEntry field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LinkTokenInvestments) GetAllowManualEntryOk() (*bool, bool) {
	if o == nil || o.AllowManualEntry == nil {
		return nil, false
	}
	return o.AllowManualEntry, true
}

// HasAllowManualEntry returns a boolean if a field has been set.
func (o *LinkTokenInvestments) HasAllowManualEntry() bool {
	if o != nil && o.AllowManualEntry != nil {
		return true
	}
...
// SetAllowManualEntry gets a reference to the given bool and assigns it to the AllowManualEntry field.
func (o *LinkTokenInvestments) SetAllowManualEntry(v bool) {
	o.AllowManualEntry = &v
}
...
func (o LinkTokenInvestments) MarshalJSON() ([]byte, error) {
	...
	if o.AllowManualEntry != nil {
		toSerialize["allow_manual_entry"] = o.AllowManualEntry
	}
