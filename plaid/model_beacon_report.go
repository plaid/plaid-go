...
func NewBeaconReport(id string, beaconUserId string, createdAt time.Time, type_ BeaconReportType, fraudDate NullableString, eventDate string, fraudAmount NullableFraudAmount, auditTrail BeaconAuditTrail) *BeaconReport {
	this := BeaconReport{}
	this.Id = id
...
func (o *BeaconReport) GetEventDate() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BeaconReport) GetEventDateOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *BeaconReport) SetEventDate(v string) {
	o.EventDate = v
}
