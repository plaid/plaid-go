...
func NewBeaconReportCreateResponse(id string, beaconUserId string, createdAt time.Time, type_ BeaconReportType, fraudDate string, fraudAmount NullableFraudAmount, auditTrail BeaconAuditTrail, requestId string) *BeaconReportCreateResponse {
