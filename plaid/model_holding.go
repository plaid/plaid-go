...
func (o *Holding) GetVestedQuantity() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Holding) GetVestedQuantityOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *Holding) HasVestedQuantity() bool {
...
func (o *Holding) GetVestedValue() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Holding) GetVestedValueOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *Holding) HasVestedValue() bool {
...
// and a boolean to check if the value has been set.
func (o *Holding) GetTaxLotsOk() (*[]HoldingTaxLot, bool) {
	if o == nil || o.TaxLots == nil {
		return nil, false
	}
...
func (o *Holding) HasTaxLots() bool {
	if o != nil && o.TaxLots != nil {
		return true
	}
...
func (o *Holding) SetTaxLots(v []HoldingTaxLot) {
	o.TaxLots = &v
}
