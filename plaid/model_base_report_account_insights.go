...
type BaseReportAccountInsights struct {
	...
	// Customers must transition from `longest_gap_between_transactions` by September 30th 2024. Longest gap between sequential transactions in a time period. This array can include multiple time periods.
	...
	// Customers must transition from `average_inflow_amount` by September 30th 2024. Average amount of debit transactions into the account in a time period. This array will be empty for non-depository accounts. This field only takes into account USD transactions from the account.
	...
	// Customers must transition from `average_outflow_amount` by September 30th 2024. Average amount of transactions out of the account in a time period. This array will be empty for non-depository accounts. This field only takes into account USD transactions from the account.
...
// GetAverageInflowAmount returns the AverageInflowAmount field value if set, zero value otherwise.
...
// GetAverageOutflowAmount returns the AverageOutflowAmount field value if set, zero value otherwise.
