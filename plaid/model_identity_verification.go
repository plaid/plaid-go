...
func (o *IdentityVerification) GetRequestId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *IdentityVerification) GetRequestIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *IdentityVerification) SetRequestId(v string) {
	o.RequestId = v
}
