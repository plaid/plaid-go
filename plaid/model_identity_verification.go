...
func (o *IdentityVerification) HasUserId() bool {
...
func (o *IdentityVerification) SetUserIdNil() {
	o.UserId.Set(nil)
}

// UnsetUserId ensures that no value is present for UserId, not even an explicit nil
func (o *IdentityVerification) UnsetUserId() {
	o.UserId.Unset()
}
