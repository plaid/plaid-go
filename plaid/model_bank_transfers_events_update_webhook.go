...
func NewBankTransfersEventsUpdateWebhook(webhookType string, webhookCode string, environment WebhookEnvironmentValues) *BankTransfersEventsUpdateWebhook {
...
func (o *BankTransfersEventsUpdateWebhook) GetEnvironment() WebhookEnvironmentValues {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *BankTransfersEventsUpdateWebhook) GetEnvironmentOk() (*WebhookEnvironmentValues, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *BankTransfersEventsUpdateWebhook) SetEnvironment(v WebhookEnvironmentValues) {
	o.Environment = v
}
