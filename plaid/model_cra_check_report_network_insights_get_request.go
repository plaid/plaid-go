...
// CraCheckReportNetworkInsightsGetRequest CraCheckReportNetworkInsightsGetRequest defines the request schema for `/cra/check_report/network_insights/get`.
type CraCheckReportNetworkInsightsGetRequest struct {
	...
	Options NullableCraCheckReportNetworkInsightsGetOptions `json:"options,omitempty"`
...
func (o *CraCheckReportNetworkInsightsGetRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *CraCheckReportNetworkInsightsGetRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *CraCheckReportNetworkInsightsGetRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *CraCheckReportNetworkInsightsGetRequest) SetUserId(v string) {
	o.UserId = &v
}

// GetOptions returns the Options field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CraCheckReportNetworkInsightsGetRequest) GetOptions() CraCheckReportNetworkInsightsGetOptions {
...
func (o *CraCheckReportNetworkInsightsGetRequest) GetOptionsOk() (*CraCheckReportNetworkInsightsGetOptions, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CraCheckReportNetworkInsightsGetRequest) HasOptions() bool {
...
// SetOptions gets a reference to the given NullableCraCheckReportNetworkInsightsGetOptions and assigns it to the Options field.
func (o *CraCheckReportNetworkInsightsGetRequest) SetOptions(v CraCheckReportNetworkInsightsGetOptions) {
	o.Options.Set(&v)
}
// SetOptionsNil sets the value for Options to be an explicit nil
func (o *CraCheckReportNetworkInsightsGetRequest) SetOptionsNil() {
	o.Options.Set(nil)
}

// UnsetOptions ensures that no value is present for Options, not even an explicit nil
func (o *CraCheckReportNetworkInsightsGetRequest) UnsetOptions() {
	o.Options.Unset()
}
