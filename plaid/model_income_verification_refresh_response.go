...
type _IncomeVerificationRefreshResponse IncomeVerificationRefreshResponse
...
func (o *IncomeVerificationRefreshResponse) UnmarshalJSON(bytes []byte) (err error) {
	varIncomeVerificationRefreshResponse := _IncomeVerificationRefreshResponse{}

	if err = json.Unmarshal(bytes, &varIncomeVerificationRefreshResponse); err == nil {
		*o = IncomeVerificationRefreshResponse(varIncomeVerificationRefreshResponse)
	}
