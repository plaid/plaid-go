...
type Security struct {
	...
	CfiCode NullableString `json:"cfi_code"`
	// 12-character FIGI, a unique Financial Instrument Global Identifier assigned to securities that is immutable and stays consistent across most corporate actions. This is an open data standard issued by the Object Management Group and administered by Bloomberg L.P.
	Figi NullableString `json:"figi"`
...
func NewSecurity(securityId string, isin NullableString, cusip NullableString, sedol NullableString, institutionSecurityId NullableString, institutionId NullableString, proxySecurityId NullableString, name NullableString, tickerSymbol NullableString, isCashEquivalent NullableBool, type_ NullableString, closePrice NullableFloat64, closePriceAsOf NullableString, isoCurrencyCode NullableString, unofficialCurrencyCode NullableString, marketIdentifierCode NullableString, sector NullableString, industry NullableString, cfiCode NullableString, figi NullableString, optionContract NullableOptionContract, fixedIncome NullableFixedIncome) *Security {
	this := Security{}
...
func (o *Security) GetSubtype() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Security) GetSubtypeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *Security) HasSubtype() bool {
...
func (o *Security) SetSubtype(v string) {
	o.Subtype.Set(&v)
}
// SetSubtypeNil sets the value for Subtype to be an explicit nil
func (o *Security) SetSubtypeNil() {
	o.Subtype.Set(nil)
}

// UnsetSubtype ensures that no value is present for Subtype, not even an explicit nil
func (o *Security) UnsetSubtype() {
	o.Subtype.Unset()
}
...
// If the value is explicit nil, the zero value for string will be returned
func (o *Security) GetCfiCode() string {
	if o == nil || o.CfiCode.Get() == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Security) GetCfiCodeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *Security) SetCfiCode(v string) {
	o.CfiCode.Set(&v)
}

// GetFigi returns the Figi field value
// If the value is explicit nil, the zero value for string will be returned
func (o *Security) GetFigi() string {
	if o == nil || o.Figi.Get() == nil {
		var ret string
		return ret
	}
...
// GetFigiOk returns a tuple with the Figi field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Security) GetFigiOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return o.Figi.Get(), o.Figi.IsSet()
}

// SetFigi sets field value
func (o *Security) SetFigi(v string) {
	o.Figi.Set(&v)
}
...
func (o *Security) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "figi")
