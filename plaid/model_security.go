...
func NewSecurity(securityId string, isin NullableString, cusip NullableString, sedol NullableString, institutionSecurityId NullableString, institutionId NullableString, proxySecurityId NullableString, name NullableString, tickerSymbol NullableString, isCashEquivalent NullableBool, type_ NullableString, closePrice NullableFloat64, closePriceAsOf NullableString, isoCurrencyCode NullableString, unofficialCurrencyCode NullableString, marketIdentifierCode NullableString, sector NullableString, industry NullableString, optionContract NullableOptionContract) *Security {
	this := Security{}
