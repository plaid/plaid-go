...
func NewCreditBankIncomePDFGetRequest() *CreditBankIncomePDFGetRequest {
...
func (o *CreditBankIncomePDFGetRequest) HasUserToken() bool {
	if o != nil && o.UserToken != nil {
		return true
	}
...
func (o *CreditBankIncomePDFGetRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *CreditBankIncomePDFGetRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *CreditBankIncomePDFGetRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *CreditBankIncomePDFGetRequest) SetUserId(v string) {
	o.UserId = &v
}
