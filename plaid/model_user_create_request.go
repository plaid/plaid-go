...
type UserCreateRequest struct {
	...
	WithUpgradedUser *bool `json:"with_upgraded_user,omitempty"`
}
...
func (o *UserCreateRequest) GetIdentity() ClientUserIdentity {
...
func (o *UserCreateRequest) GetIdentityOk() (*ClientUserIdentity, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *UserCreateRequest) HasIdentity() bool {
...
func (o *UserCreateRequest) SetIdentity(v ClientUserIdentity) {
	o.Identity.Set(&v)
}
// SetIdentityNil sets the value for Identity to be an explicit nil
func (o *UserCreateRequest) SetIdentityNil() {
	o.Identity.Set(nil)
}

// UnsetIdentity ensures that no value is present for Identity, not even an explicit nil
func (o *UserCreateRequest) UnsetIdentity() {
	o.Identity.Unset()
}
...
// GetWithUpgradedUser returns the WithUpgradedUser field value if set, zero value otherwise.
func (o *UserCreateRequest) GetWithUpgradedUser() bool {
	if o == nil || o.WithUpgradedUser == nil {
		var ret bool
		return ret
	}
	return *o.WithUpgradedUser
}

// GetWithUpgradedUserOk returns a tuple with the WithUpgradedUser field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserCreateRequest) GetWithUpgradedUserOk() (*bool, bool) {
	if o == nil || o.WithUpgradedUser == nil {
		return nil, false
	}
	return o.WithUpgradedUser, true
}

// HasWithUpgradedUser returns a boolean if a field has been set.
func (o *UserCreateRequest) HasWithUpgradedUser() bool {
	if o != nil && o.WithUpgradedUser != nil {
		return true
	}
...
// SetWithUpgradedUser gets a reference to the given bool and assigns it to the WithUpgradedUser field.
func (o *UserCreateRequest) SetWithUpgradedUser(v bool) {
	o.WithUpgradedUser = &v
}
...
func (o UserCreateRequest) MarshalJSON() ([]byte, error) {
	...
	if o.WithUpgradedUser != nil {
		toSerialize["with_upgraded_user"] = o.WithUpgradedUser
	}
