...
func NewItemActivityListResponse(activities []Activity, lastDataAccessTimes []LastDataAccessTimes) *ItemActivityListResponse {
...
func (o *ItemActivityListResponse) HasRequestId() bool {
	if o != nil && o.RequestId != nil {
		return true
	}
