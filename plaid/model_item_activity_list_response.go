...
type ItemActivityListResponse struct {
	...
	LastDataAccessTimes []ApplicationLastDataAccessTimes `json:"last_data_access_times"`
...
func NewItemActivityListResponse(requestId string, activities []Activity, lastDataAccessTimes []ApplicationLastDataAccessTimes) *ItemActivityListResponse {
...
func (o *ItemActivityListResponse) GetLastDataAccessTimes() []ApplicationLastDataAccessTimes {
	if o == nil {
		var ret []ApplicationLastDataAccessTimes
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ItemActivityListResponse) GetLastDataAccessTimesOk() (*[]ApplicationLastDataAccessTimes, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *ItemActivityListResponse) SetLastDataAccessTimes(v []ApplicationLastDataAccessTimes) {
