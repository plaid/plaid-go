...
type CreditFreddieMacAsset struct {
	...
	ASSET_HOLDINGS *AssetHoldings `json:"ASSET_HOLDINGS,omitempty"`
...
// GetASSET_HOLDINGS returns the ASSET_HOLDINGS field value if set, zero value otherwise.
func (o *CreditFreddieMacAsset) GetASSET_HOLDINGS() AssetHoldings {
	if o == nil || o.ASSET_HOLDINGS == nil {
		var ret AssetHoldings
		return ret
	}
	return *o.ASSET_HOLDINGS
}

// GetASSET_HOLDINGSOk returns a tuple with the ASSET_HOLDINGS field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreditFreddieMacAsset) GetASSET_HOLDINGSOk() (*AssetHoldings, bool) {
	if o == nil || o.ASSET_HOLDINGS == nil {
		return nil, false
	}
	return o.ASSET_HOLDINGS, true
}

// HasASSET_HOLDINGS returns a boolean if a field has been set.
func (o *CreditFreddieMacAsset) HasASSET_HOLDINGS() bool {
	if o != nil && o.ASSET_HOLDINGS != nil {
		return true
	}
...
// SetASSET_HOLDINGS gets a reference to the given AssetHoldings and assigns it to the ASSET_HOLDINGS field.
func (o *CreditFreddieMacAsset) SetASSET_HOLDINGS(v AssetHoldings) {
	o.ASSET_HOLDINGS = &v
}
...
func (o CreditFreddieMacAsset) MarshalJSON() ([]byte, error) {
	...
	if o.ASSET_HOLDINGS != nil {
		toSerialize["ASSET_HOLDINGS"] = o.ASSET_HOLDINGS
	}
	if true {
...
func (o *CreditFreddieMacAsset) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ASSET_HOLDINGS")
