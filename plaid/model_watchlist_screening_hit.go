...
func NewWatchlistScreeningHit(id string, reviewStatus WatchlistScreeningHitStatus, firstActive time.Time, inactiveSince NullableTime, historicalSince NullableTime, listCode IndividualWatchlistCode, plaidUid string, sourceUid NullableString, subPrograms []string) *WatchlistScreeningHit {
...
func (o *WatchlistScreeningHit) GetSubPrograms() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WatchlistScreeningHit) GetSubProgramsOk() (*[]string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *WatchlistScreeningHit) SetSubPrograms(v []string) {
	o.SubPrograms = v
}
