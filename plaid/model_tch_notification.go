...
type TCHNotification struct {
	...
	TokenTimestamp NullableTime `json:"tokenTimestamp,omitempty"`
}
...
// GetTokenTimestamp returns the TokenTimestamp field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TCHNotification) GetTokenTimestamp() time.Time {
	if o == nil || o.TokenTimestamp.Get() == nil {
		var ret time.Time
		return ret
	}
	return *o.TokenTimestamp.Get()
}

// GetTokenTimestampOk returns a tuple with the TokenTimestamp field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TCHNotification) GetTokenTimestampOk() (*time.Time, bool) {
	if o == nil  {
		return nil, false
	}
	return o.TokenTimestamp.Get(), o.TokenTimestamp.IsSet()
}

// HasTokenTimestamp returns a boolean if a field has been set.
func (o *TCHNotification) HasTokenTimestamp() bool {
	if o != nil && o.TokenTimestamp.IsSet() {
		return true
	}
...
// SetTokenTimestamp gets a reference to the given NullableTime and assigns it to the TokenTimestamp field.
func (o *TCHNotification) SetTokenTimestamp(v time.Time) {
	o.TokenTimestamp.Set(&v)
}
// SetTokenTimestampNil sets the value for TokenTimestamp to be an explicit nil
func (o *TCHNotification) SetTokenTimestampNil() {
	o.TokenTimestamp.Set(nil)
}

// UnsetTokenTimestamp ensures that no value is present for TokenTimestamp, not even an explicit nil
func (o *TCHNotification) UnsetTokenTimestamp() {
	o.TokenTimestamp.Unset()
}
...
func (o TCHNotification) MarshalJSON() ([]byte, error) {
	...
	if o.TokenTimestamp.IsSet() {
		toSerialize["tokenTimestamp"] = o.TokenTimestamp.Get()
	}
