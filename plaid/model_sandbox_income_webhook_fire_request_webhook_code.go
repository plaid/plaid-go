...
const (
	SANDBOXINCOMEWEBHOOKFIREREQUESTWEBHOOKCODE_INCOME_VERIFICATION SandboxIncomeWebhookFireRequestWebhookCode = "INCOME_VERIFICATION"
	SANDBOXINCOMEWEBHOOKFIREREQUESTWEBHOOKCODE_USER_INCOME_VERIFICATION SandboxIncomeWebhookFireRequestWebhookCode = "USER_INCOME_VERIFICATION"
	SANDBOXINCOMEWEBHOOKFIREREQUESTWEBHOOKCODE_INCOME_VERIFICATION_RISK_SIGNALS SandboxIncomeWebhookFireRequestWebhookCode = "INCOME_VERIFICATION_RISK_SIGNALS"
	SANDBOXINCOMEWEBHOOKFIREREQUESTWEBHOOKCODE_USER_INCOME_VERIFICATION_RISK_SIGNALS SandboxIncomeWebhookFireRequestWebhookCode = "USER_INCOME_VERIFICATION_RISK_SIGNALS"
)
