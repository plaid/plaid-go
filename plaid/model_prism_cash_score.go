...
func NewPrismCashScore(version int32, score NullableInt32) *PrismCashScore {
	this := PrismCashScore{}
...
func (o *PrismCashScore) GetModelVersion() string {
...
// and a boolean to check if the value has been set.
func (o *PrismCashScore) GetModelVersionOk() (*string, bool) {
	if o == nil || o.ModelVersion == nil {
		return nil, false
	}
...
func (o *PrismCashScore) HasModelVersion() bool {
	if o != nil && o.ModelVersion != nil {
		return true
	}
...
func (o *PrismCashScore) SetModelVersion(v string) {
	o.ModelVersion = &v
}
...
func (o *PrismCashScore) GetErrorReason() string {
...
// and a boolean to check if the value has been set.
func (o *PrismCashScore) GetErrorReasonOk() (*string, bool) {
	if o == nil || o.ErrorReason == nil {
		return nil, false
	}
...
func (o *PrismCashScore) HasErrorReason() bool {
	if o != nil && o.ErrorReason != nil {
		return true
	}
...
func (o *PrismCashScore) SetErrorReason(v string) {
	o.ErrorReason = &v
}
