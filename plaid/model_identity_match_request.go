...
// GetIdentityVerificationId returns the IdentityVerificationId field value if set, zero value otherwise.
func (o *IdentityMatchRequest) GetIdentityVerificationId() string {
...
// GetIdentityVerificationIdOk returns a tuple with the IdentityVerificationId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IdentityMatchRequest) GetIdentityVerificationIdOk() (*string, bool) {
	if o == nil || o.IdentityVerificationId == nil {
		return nil, false
	}
...
// HasIdentityVerificationId returns a boolean if a field has been set.
func (o *IdentityMatchRequest) HasIdentityVerificationId() bool {
	if o != nil && o.IdentityVerificationId != nil {
		return true
	}
...
// SetIdentityVerificationId gets a reference to the given string and assigns it to the IdentityVerificationId field.
func (o *IdentityMatchRequest) SetIdentityVerificationId(v string) {
