...
type ProtectEventSendRequest struct {
	...
	ProtectSdkSessionId *string `json:"protect_sdk_session_id,omitempty"`
...
// GetProtectSdkSessionId returns the ProtectSdkSessionId field value if set, zero value otherwise.
func (o *ProtectEventSendRequest) GetProtectSdkSessionId() string {
	if o == nil || o.ProtectSdkSessionId == nil {
		var ret string
		return ret
	}
	return *o.ProtectSdkSessionId
}

// GetProtectSdkSessionIdOk returns a tuple with the ProtectSdkSessionId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProtectEventSendRequest) GetProtectSdkSessionIdOk() (*string, bool) {
	if o == nil || o.ProtectSdkSessionId == nil {
		return nil, false
	}
	return o.ProtectSdkSessionId, true
}

// HasProtectSdkSessionId returns a boolean if a field has been set.
func (o *ProtectEventSendRequest) HasProtectSdkSessionId() bool {
	if o != nil && o.ProtectSdkSessionId != nil {
		return true
	}
...
// SetProtectSdkSessionId gets a reference to the given string and assigns it to the ProtectSdkSessionId field.
func (o *ProtectEventSendRequest) SetProtectSdkSessionId(v string) {
	o.ProtectSdkSessionId = &v
}
...
func (o ProtectEventSendRequest) MarshalJSON() ([]byte, error) {
	...
	if o.ProtectSdkSessionId != nil {
		toSerialize["protect_sdk_session_id"] = o.ProtectSdkSessionId
	}
