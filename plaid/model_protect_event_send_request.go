...
func (o *ProtectEventSendRequest) GetDeviceSessionId() string {
...
// and a boolean to check if the value has been set.
func (o *ProtectEventSendRequest) GetDeviceSessionIdOk() (*string, bool) {
	if o == nil || o.DeviceSessionId == nil {
		return nil, false
	}
...
func (o *ProtectEventSendRequest) HasDeviceSessionId() bool {
	if o != nil && o.DeviceSessionId != nil {
		return true
	}
...
func (o *ProtectEventSendRequest) SetDeviceSessionId(v string) {
	o.DeviceSessionId = &v
}
