...
func (o *LinkSessionFinishedWebhook) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *LinkSessionFinishedWebhook) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *LinkSessionFinishedWebhook) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *LinkSessionFinishedWebhook) SetUserId(v string) {
	o.UserId = &v
}
