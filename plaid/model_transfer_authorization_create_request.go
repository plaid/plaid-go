...
type TransferAuthorizationCreateRequest struct {
	...
	RequestGuarantee NullableBool `json:"request_guarantee,omitempty"`
...
// GetRequestGuarantee returns the RequestGuarantee field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TransferAuthorizationCreateRequest) GetRequestGuarantee() bool {
	if o == nil || o.RequestGuarantee.Get() == nil {
		var ret bool
		return ret
	}
	return *o.RequestGuarantee.Get()
}

// GetRequestGuaranteeOk returns a tuple with the RequestGuarantee field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferAuthorizationCreateRequest) GetRequestGuaranteeOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
	return o.RequestGuarantee.Get(), o.RequestGuarantee.IsSet()
}

// HasRequestGuarantee returns a boolean if a field has been set.
func (o *TransferAuthorizationCreateRequest) HasRequestGuarantee() bool {
	if o != nil && o.RequestGuarantee.IsSet() {
		return true
	}
...
// SetRequestGuarantee gets a reference to the given NullableBool and assigns it to the RequestGuarantee field.
func (o *TransferAuthorizationCreateRequest) SetRequestGuarantee(v bool) {
	o.RequestGuarantee.Set(&v)
}
// SetRequestGuaranteeNil sets the value for RequestGuarantee to be an explicit nil
func (o *TransferAuthorizationCreateRequest) SetRequestGuaranteeNil() {
	o.RequestGuarantee.Set(nil)
}

// UnsetRequestGuarantee ensures that no value is present for RequestGuarantee, not even an explicit nil
func (o *TransferAuthorizationCreateRequest) UnsetRequestGuarantee() {
	o.RequestGuarantee.Unset()
}
...
func (o *TransferAuthorizationCreateRequest) GetCustomAttributes() map[string]string {
	if o == nil  {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferAuthorizationCreateRequest) GetCustomAttributesOk() (*map[string]string, bool) {
...
func (o *TransferAuthorizationCreateRequest) HasCustomAttributes() bool {
	if o != nil && o.CustomAttributes != nil {
		return true
	}
...
func (o *TransferAuthorizationCreateRequest) SetCustomAttributes(v map[string]string) {
...
func (o TransferAuthorizationCreateRequest) MarshalJSON() ([]byte, error) {
	...
	if o.RequestGuarantee.IsSet() {
		toSerialize["request_guarantee"] = o.RequestGuarantee.Get()
	}
