...
// TransferAuthorizationCreateRequest TransferAuthorizationCreateRequest defines the request schema for `/transfer/authorization/create`
...
func NewTransferAuthorizationCreateRequest(accessToken string, accountId string, type_ TransferType, network TransferNetwork, amount string, isoCurrencyCode string, description string, achClass ACHClass, user TransferUser) *TransferAuthorizationCreateRequest {
...
func (o *TransferAuthorizationCreateRequest) GetDescription() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TransferAuthorizationCreateRequest) GetDescriptionOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferAuthorizationCreateRequest) SetDescription(v string) {
	o.Description = v
}
...
func (o *TransferAuthorizationCreateRequest) GetUser() TransferUser {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TransferAuthorizationCreateRequest) GetUserOk() (*TransferUser, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.User, true
...
func (o *TransferAuthorizationCreateRequest) SetUser(v TransferUser) {
	o.User = v
}
