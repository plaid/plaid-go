...
func NewTransferAuthorizationCreateRequest(accessToken string, accountId string, type_ TransferType, network TransferNetwork, amount string, isoCurrencyCode string, description string, achClass ACHClass, user TransferUserInRequest) *TransferAuthorizationCreateRequest {
