...
type LinkTokenCreateRequest struct {
	...
	User *LinkTokenCreateRequestUser `json:"user,omitempty"`
	...
	AppearanceMode NullableLinkTokenCreateRequestAppearanceMode `json:"appearance_mode,omitempty"`
...
func NewLinkTokenCreateRequest(clientName string, language string, countryCodes []CountryCode) *LinkTokenCreateRequest {
...
func (o *LinkTokenCreateRequest) HasUser() bool {
	if o != nil && o.User != nil {
		return true
	}
...
// SetUser gets a reference to the given LinkTokenCreateRequestUser and assigns it to the User field.
func (o *LinkTokenCreateRequest) SetUser(v LinkTokenCreateRequestUser) {
	o.User = &v
}

// GetUserId returns the UserId field value if set, zero value otherwise.
func (o *LinkTokenCreateRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *LinkTokenCreateRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *LinkTokenCreateRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *LinkTokenCreateRequest) SetUserId(v string) {
	o.UserId = &v
}
...
// GetAppearanceMode returns the AppearanceMode field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *LinkTokenCreateRequest) GetAppearanceMode() LinkTokenCreateRequestAppearanceMode {
	if o == nil || o.AppearanceMode.Get() == nil {
		var ret LinkTokenCreateRequestAppearanceMode
		return ret
	}
	return *o.AppearanceMode.Get()
}

// GetAppearanceModeOk returns a tuple with the AppearanceMode field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *LinkTokenCreateRequest) GetAppearanceModeOk() (*LinkTokenCreateRequestAppearanceMode, bool) {
	if o == nil  {
		return nil, false
	}
	return o.AppearanceMode.Get(), o.AppearanceMode.IsSet()
}

// HasAppearanceMode returns a boolean if a field has been set.
func (o *LinkTokenCreateRequest) HasAppearanceMode() bool {
	if o != nil && o.AppearanceMode.IsSet() {
		return true
	}
...
// SetAppearanceMode gets a reference to the given NullableLinkTokenCreateRequestAppearanceMode and assigns it to the AppearanceMode field.
func (o *LinkTokenCreateRequest) SetAppearanceMode(v LinkTokenCreateRequestAppearanceMode) {
	o.AppearanceMode.Set(&v)
}
// SetAppearanceModeNil sets the value for AppearanceMode to be an explicit nil
func (o *LinkTokenCreateRequest) SetAppearanceModeNil() {
	o.AppearanceMode.Set(nil)
}

// UnsetAppearanceMode ensures that no value is present for AppearanceMode, not even an explicit nil
func (o *LinkTokenCreateRequest) UnsetAppearanceMode() {
	o.AppearanceMode.Unset()
}
...
func (o LinkTokenCreateRequest) MarshalJSON() ([]byte, error) {
	...
	if o.AppearanceMode.IsSet() {
		toSerialize["appearance_mode"] = o.AppearanceMode.Get()
	}
