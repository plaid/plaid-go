...
// InvestmentAccountBalance A set of fields describing the balance for an account, including margin loan information for investment accounts.
...
// NewInvestmentAccountBalance instantiates a new InvestmentAccountBalance object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInvestmentAccountBalance(available NullableFloat64, current NullableFloat64, limit NullableFloat64, isoCurrencyCode NullableString, unofficialCurrencyCode NullableString, marginLoanAmount NullableFloat64) *InvestmentAccountBalance {
	this := InvestmentAccountBalance{}
...
// NewInvestmentAccountBalanceWithDefaults instantiates a new InvestmentAccountBalance object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInvestmentAccountBalanceWithDefaults() *InvestmentAccountBalance {
	this := InvestmentAccountBalance{}
	return &this
}
...
func (o *InvestmentAccountBalance) GetAvailable() float64 {
...
func (o *InvestmentAccountBalance) GetAvailableOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccountBalance) SetAvailable(v float64) {
	o.Available.Set(&v)
}

// GetCurrent returns the Current field value
// If the value is explicit nil, the zero value for float64 will be returned
func (o *InvestmentAccountBalance) GetCurrent() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InvestmentAccountBalance) GetCurrentOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccountBalance) SetCurrent(v float64) {
	o.Current.Set(&v)
}

// GetLimit returns the Limit field value
// If the value is explicit nil, the zero value for float64 will be returned
func (o *InvestmentAccountBalance) GetLimit() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InvestmentAccountBalance) GetLimitOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccountBalance) SetLimit(v float64) {
	o.Limit.Set(&v)
}

// GetIsoCurrencyCode returns the IsoCurrencyCode field value
// If the value is explicit nil, the zero value for string will be returned
func (o *InvestmentAccountBalance) GetIsoCurrencyCode() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InvestmentAccountBalance) GetIsoCurrencyCodeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccountBalance) SetIsoCurrencyCode(v string) {
	o.IsoCurrencyCode.Set(&v)
}

// GetUnofficialCurrencyCode returns the UnofficialCurrencyCode field value
// If the value is explicit nil, the zero value for string will be returned
func (o *InvestmentAccountBalance) GetUnofficialCurrencyCode() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InvestmentAccountBalance) GetUnofficialCurrencyCodeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccountBalance) SetUnofficialCurrencyCode(v string) {
...
func (o *InvestmentAccountBalance) GetLastUpdatedDatetime() time.Time {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InvestmentAccountBalance) GetLastUpdatedDatetimeOk() (*time.Time, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccountBalance) HasLastUpdatedDatetime() bool {
...
func (o *InvestmentAccountBalance) SetLastUpdatedDatetime(v time.Time) {
	o.LastUpdatedDatetime.Set(&v)
}
// SetLastUpdatedDatetimeNil sets the value for LastUpdatedDatetime to be an explicit nil
func (o *InvestmentAccountBalance) SetLastUpdatedDatetimeNil() {
...
func (o *InvestmentAccountBalance) UnsetLastUpdatedDatetime() {
	o.LastUpdatedDatetime.Unset()
}

// GetMarginLoanAmount returns the MarginLoanAmount field value
// If the value is explicit nil, the zero value for float64 will be returned
func (o *InvestmentAccountBalance) GetMarginLoanAmount() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InvestmentAccountBalance) GetMarginLoanAmountOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccountBalance) SetMarginLoanAmount(v float64) {
	o.MarginLoanAmount.Set(&v)
}

func (o InvestmentAccountBalance) MarshalJSON() ([]byte, error) {
...
type NullableInvestmentAccountBalance struct {
	value *InvestmentAccountBalance
	isSet bool
}

func (v NullableInvestmentAccountBalance) Get() *InvestmentAccountBalance {
	return v.value
}

func (v *NullableInvestmentAccountBalance) Set(val *InvestmentAccountBalance) {
	v.value = val
	v.isSet = true
}

func (v NullableInvestmentAccountBalance) IsSet() bool {
	return v.isSet
}

func (v *NullableInvestmentAccountBalance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvestmentAccountBalance(val *InvestmentAccountBalance) *NullableInvestmentAccountBalance {
	return &NullableInvestmentAccountBalance{value: val, isSet: true}
}

func (v NullableInvestmentAccountBalance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvestmentAccountBalance) UnmarshalJSON(src []byte) error {
	v.isSet = true
