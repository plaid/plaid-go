...
// InvestmentAccount A single account at a financial institution, with additional investment-specific balance information.
type InvestmentAccount struct {
	...
	// The annual percentage yield (APY) on an interest-bearing deposit account, expressed as a percentage (e.g. `4.25` means 4.25%). In the event that the APY is not provided by the financial institution, Plaid will return a value of `null`.
	Apy NullableFloat64 `json:"apy,omitempty"`
...
func NewInvestmentAccount(accountId string, balances InvestmentAccountBalance, mask NullableString, name string, officialName NullableString, type_ AccountType, subtype NullableAccountSubtype) *InvestmentAccount {
...
func (o *InvestmentAccount) GetAccountId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InvestmentAccount) GetAccountIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccount) SetAccountId(v string) {
	o.AccountId = v
}

// GetBalances returns the Balances field value
func (o *InvestmentAccount) GetBalances() InvestmentAccountBalance {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *InvestmentAccount) GetBalancesOk() (*InvestmentAccountBalance, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccount) SetBalances(v InvestmentAccountBalance) {
	o.Balances = v
}

// GetMask returns the Mask field value
// If the value is explicit nil, the zero value for string will be returned
func (o *InvestmentAccount) GetMask() string {
...
func (o *InvestmentAccount) GetMaskOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccount) SetMask(v string) {
	o.Mask.Set(&v)
}

// GetName returns the Name field value
func (o *InvestmentAccount) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InvestmentAccount) GetNameOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Name, true
...
func (o *InvestmentAccount) SetName(v string) {
	o.Name = v
}

// GetOfficialName returns the OfficialName field value
// If the value is explicit nil, the zero value for string will be returned
func (o *InvestmentAccount) GetOfficialName() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InvestmentAccount) GetOfficialNameOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccount) SetOfficialName(v string) {
	o.OfficialName.Set(&v)
}

// GetType returns the Type field value
func (o *InvestmentAccount) GetType() AccountType {
	if o == nil {
		var ret AccountType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InvestmentAccount) GetTypeOk() (*AccountType, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Type, true
...
func (o *InvestmentAccount) SetType(v AccountType) {
	o.Type = v
}

// GetSubtype returns the Subtype field value
// If the value is explicit nil, the zero value for AccountSubtype will be returned
func (o *InvestmentAccount) GetSubtype() AccountSubtype {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InvestmentAccount) GetSubtypeOk() (*AccountSubtype, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccount) SetSubtype(v AccountSubtype) {
	o.Subtype.Set(&v)
}

// GetVerificationStatus returns the VerificationStatus field value if set, zero value otherwise.
func (o *InvestmentAccount) GetVerificationStatus() string {
...
// and a boolean to check if the value has been set.
func (o *InvestmentAccount) GetVerificationStatusOk() (*string, bool) {
	if o == nil || o.VerificationStatus == nil {
		return nil, false
	}
...
func (o *InvestmentAccount) HasVerificationStatus() bool {
	if o != nil && o.VerificationStatus != nil {
		return true
	}
...
func (o *InvestmentAccount) SetVerificationStatus(v string) {
	o.VerificationStatus = &v
}

// GetVerificationName returns the VerificationName field value if set, zero value otherwise.
func (o *InvestmentAccount) GetVerificationName() string {
...
// and a boolean to check if the value has been set.
func (o *InvestmentAccount) GetVerificationNameOk() (*string, bool) {
	if o == nil || o.VerificationName == nil {
		return nil, false
	}
...
func (o *InvestmentAccount) HasVerificationName() bool {
	if o != nil && o.VerificationName != nil {
		return true
	}
...
func (o *InvestmentAccount) SetVerificationName(v string) {
	o.VerificationName = &v
}

// GetVerificationInsights returns the VerificationInsights field value if set, zero value otherwise.
func (o *InvestmentAccount) GetVerificationInsights() AccountVerificationInsights {
...
// and a boolean to check if the value has been set.
func (o *InvestmentAccount) GetVerificationInsightsOk() (*AccountVerificationInsights, bool) {
	if o == nil || o.VerificationInsights == nil {
		return nil, false
	}
...
func (o *InvestmentAccount) HasVerificationInsights() bool {
	if o != nil && o.VerificationInsights != nil {
		return true
	}
...
func (o *InvestmentAccount) SetVerificationInsights(v AccountVerificationInsights) {
	o.VerificationInsights = &v
}

// GetPersistentAccountId returns the PersistentAccountId field value if set, zero value otherwise.
func (o *InvestmentAccount) GetPersistentAccountId() string {
...
// and a boolean to check if the value has been set.
func (o *InvestmentAccount) GetPersistentAccountIdOk() (*string, bool) {
	if o == nil || o.PersistentAccountId == nil {
		return nil, false
	}
...
func (o *InvestmentAccount) HasPersistentAccountId() bool {
	if o != nil && o.PersistentAccountId != nil {
		return true
	}
...
func (o *InvestmentAccount) SetPersistentAccountId(v string) {
...
func (o *InvestmentAccount) GetApy() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InvestmentAccount) GetApyOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccount) HasApy() bool {
...
// SetApy gets a reference to the given NullableFloat64 and assigns it to the Apy field.
func (o *InvestmentAccount) SetApy(v float64) {
	o.Apy.Set(&v)
}
// SetApyNil sets the value for Apy to be an explicit nil
func (o *InvestmentAccount) SetApyNil() {
	o.Apy.Set(nil)
}

// UnsetApy ensures that no value is present for Apy, not even an explicit nil
func (o *InvestmentAccount) UnsetApy() {
	o.Apy.Unset()
}
...
func (o *InvestmentAccount) GetHolderCategory() AccountHolderCategory {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InvestmentAccount) GetHolderCategoryOk() (*AccountHolderCategory, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentAccount) HasHolderCategory() bool {
