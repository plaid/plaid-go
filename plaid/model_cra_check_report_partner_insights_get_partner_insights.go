...
// CraCheckReportPartnerInsightsGetPartnerInsights Deprecated. This field is no longer accepted for new clients (created on or after 2026-07-01). New clients should specify required products when creating the Consumer Report. Existing integrations may continue to pass `partner_insights`.
...
func (o *CraCheckReportPartnerInsightsGetPartnerInsights) GetFico() CraPartnerInsightsFicoInput {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CraCheckReportPartnerInsightsGetPartnerInsights) GetFicoOk() (*CraPartnerInsightsFicoInput, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CraCheckReportPartnerInsightsGetPartnerInsights) HasFico() bool {
...
func (o *CraCheckReportPartnerInsightsGetPartnerInsights) SetFico(v CraPartnerInsightsFicoInput) {
	o.Fico.Set(&v)
}
// SetFicoNil sets the value for Fico to be an explicit nil
func (o *CraCheckReportPartnerInsightsGetPartnerInsights) SetFicoNil() {
	o.Fico.Set(nil)
}

// UnsetFico ensures that no value is present for Fico, not even an explicit nil
func (o *CraCheckReportPartnerInsightsGetPartnerInsights) UnsetFico() {
	o.Fico.Unset()
}
