...
const (
	OAUTHSUBJECTTOKENTYPE_TOKENSUSER OAuthSubjectTokenType = "urn:plaid:params:tokens:user"
	OAUTHSUBJECTTOKENTYPE_OAUTHUSER_TOKEN OAuthSubjectTokenType = "urn:plaid:params:oauth:user-token"
	OAUTHSUBJECTTOKENTYPE_CREDITMULTI_USER OAuthSubjectTokenType = "urn:plaid:params:credit:multi-user"
)
