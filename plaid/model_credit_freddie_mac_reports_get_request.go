...
type _CreditFreddieMacReportsGetRequest CreditFreddieMacReportsGetRequest
...
func (o *CreditFreddieMacReportsGetRequest) UnmarshalJSON(bytes []byte) (err error) {
	varCreditFreddieMacReportsGetRequest := _CreditFreddieMacReportsGetRequest{}

	if err = json.Unmarshal(bytes, &varCreditFreddieMacReportsGetRequest); err == nil {
		*o = CreditFreddieMacReportsGetRequest(varCreditFreddieMacReportsGetRequest)
	} else {
		return err
	}
