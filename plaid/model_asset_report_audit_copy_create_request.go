...
func NewAssetReportAuditCopyCreateRequest(assetReportToken string) *AssetReportAuditCopyCreateRequest {
...
// GetAuditorId returns the AuditorId field value if set, zero value otherwise.
func (o *AssetReportAuditCopyCreateRequest) GetAuditorId() string {
	if o == nil || o.AuditorId == nil {
		var ret string
		return ret
	}
	return *o.AuditorId
...
// GetAuditorIdOk returns a tuple with the AuditorId field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasAuditorId returns a boolean if a field has been set.
func (o *AssetReportAuditCopyCreateRequest) HasAuditorId() bool {
	if o != nil && o.AuditorId != nil {
		return true
	}
...
// SetAuditorId gets a reference to the given string and assigns it to the AuditorId field.
