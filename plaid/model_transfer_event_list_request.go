...
// TransferEventListRequest TransferEventListRequest defines the request schema for `/transfer/event/list`
...
func (o *TransferEventListRequest) GetDirection() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferEventListRequest) GetDirectionOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferEventListRequest) HasDirection() bool {
...
func (o *TransferEventListRequest) SetDirection(v string) {
	o.Direction.Set(&v)
}
// SetDirectionNil sets the value for Direction to be an explicit nil
func (o *TransferEventListRequest) SetDirectionNil() {
	o.Direction.Set(nil)
}

// UnsetDirection ensures that no value is present for Direction, not even an explicit nil
func (o *TransferEventListRequest) UnsetDirection() {
	o.Direction.Unset()
}
