...
type AssetReportCreateRequestOptions struct {
	...
	RequireAllItems NullableBool `json:"require_all_items,omitempty"`
}
...
func NewAssetReportCreateRequestOptions() *AssetReportCreateRequestOptions {
	...
	var requireAllItems bool = true
	this.RequireAllItems = *NewNullableBool(&requireAllItems)
	return &this
}
...
// GetRequireAllItems returns the RequireAllItems field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *AssetReportCreateRequestOptions) GetRequireAllItems() bool {
	if o == nil || o.RequireAllItems.Get() == nil {
		var ret bool
		return ret
	}
	return *o.RequireAllItems.Get()
}

// GetRequireAllItemsOk returns a tuple with the RequireAllItems field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AssetReportCreateRequestOptions) GetRequireAllItemsOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
	return o.RequireAllItems.Get(), o.RequireAllItems.IsSet()
}

// HasRequireAllItems returns a boolean if a field has been set.
func (o *AssetReportCreateRequestOptions) HasRequireAllItems() bool {
	if o != nil && o.RequireAllItems.IsSet() {
		return true
	}
...
// SetRequireAllItems gets a reference to the given NullableBool and assigns it to the RequireAllItems field.
func (o *AssetReportCreateRequestOptions) SetRequireAllItems(v bool) {
	o.RequireAllItems.Set(&v)
}
// SetRequireAllItemsNil sets the value for RequireAllItems to be an explicit nil
func (o *AssetReportCreateRequestOptions) SetRequireAllItemsNil() {
	o.RequireAllItems.Set(nil)
}

// UnsetRequireAllItems ensures that no value is present for RequireAllItems, not even an explicit nil
func (o *AssetReportCreateRequestOptions) UnsetRequireAllItems() {
	o.RequireAllItems.Unset()
}
...
func (o AssetReportCreateRequestOptions) MarshalJSON() ([]byte, error) {
	...
	if o.RequireAllItems.IsSet() {
		toSerialize["require_all_items"] = o.RequireAllItems.Get()
	}
