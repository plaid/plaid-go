...
func NewLinkEventsWebhook(webhookType string, webhookCode string, events []LinkEvent, linkSessionId string, linkToken string, environment WebhookEnvironmentValues) *LinkEventsWebhook {
...
func (o *LinkEventsWebhook) GetEnvironment() WebhookEnvironmentValues {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *LinkEventsWebhook) GetEnvironmentOk() (*WebhookEnvironmentValues, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *LinkEventsWebhook) SetEnvironment(v WebhookEnvironmentValues) {
	o.Environment = v
}
