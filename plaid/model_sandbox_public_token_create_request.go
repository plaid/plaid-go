...
func (o *SandboxPublicTokenCreateRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *SandboxPublicTokenCreateRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *SandboxPublicTokenCreateRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *SandboxPublicTokenCreateRequest) SetUserId(v string) {
	o.UserId = &v
}
