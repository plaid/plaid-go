...
func (v *WatchlistScreeningIndividualUpdateRequestResettableField) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid WatchlistScreeningIndividualUpdateRequestResettableField", value)
}
...
func NewWatchlistScreeningIndividualUpdateRequestResettableFieldFromValue(v string) (*WatchlistScreeningIndividualUpdateRequestResettableField, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for WatchlistScreeningIndividualUpdateRequestResettableField: valid values are %v", v, allowedWatchlistScreeningIndividualUpdateRequestResettableFieldEnumValues)
	}
}
