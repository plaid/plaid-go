...
func NewBankTransferSweep(id string, transferId NullableString, createdAt time.Time, amount string, isoCurrencyCode string, sweepAccount BankTransferSweepAccount) *BankTransferSweep {
