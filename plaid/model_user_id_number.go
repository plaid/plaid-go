...
type _UserIDNumber UserIDNumber
...
func (o *UserIDNumber) UnmarshalJSON(bytes []byte) (err error) {
	varUserIDNumber := _UserIDNumber{}

	if err = json.Unmarshal(bytes, &varUserIDNumber); err == nil {
		*o = UserIDNumber(varUserIDNumber)
	} else {
		return err
	}
