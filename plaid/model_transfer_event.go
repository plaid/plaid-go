...
type TransferEvent struct {
	...
	// A signed amount associated with this event (decimal string with two digits of precision e.g. \"10.00\" or \"-10.00\").
	EventAmount NullableString `json:"event_amount,omitempty"`
...
// GetEventAmount returns the EventAmount field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TransferEvent) GetEventAmount() string {
	if o == nil || o.EventAmount.Get() == nil {
		var ret string
		return ret
	}
	return *o.EventAmount.Get()
}

// GetEventAmountOk returns a tuple with the EventAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferEvent) GetEventAmountOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return o.EventAmount.Get(), o.EventAmount.IsSet()
}

// HasEventAmount returns a boolean if a field has been set.
func (o *TransferEvent) HasEventAmount() bool {
	if o != nil && o.EventAmount.IsSet() {
		return true
	}
...
// SetEventAmount gets a reference to the given NullableString and assigns it to the EventAmount field.
func (o *TransferEvent) SetEventAmount(v string) {
	o.EventAmount.Set(&v)
}
// SetEventAmountNil sets the value for EventAmount to be an explicit nil
func (o *TransferEvent) SetEventAmountNil() {
	o.EventAmount.Set(nil)
}

// UnsetEventAmount ensures that no value is present for EventAmount, not even an explicit nil
func (o *TransferEvent) UnsetEventAmount() {
	o.EventAmount.Unset()
}
...
func (o *TransferEvent) GetWireReturnFee() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferEvent) GetWireReturnFeeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferEvent) HasWireReturnFee() bool {
...
func (o TransferEvent) MarshalJSON() ([]byte, error) {
	...
	if o.EventAmount.IsSet() {
		toSerialize["event_amount"] = o.EventAmount.Get()
	}
	if true {
...
func (o *TransferEvent) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "event_amount")
		...
		delete(additionalProperties, "wire_return_fee")
