...
func NewTransferEvent(eventId int32, timestamp time.Time, eventType TransferEventType, accountId string, fundingAccountId string, transferId string, originationAccountId NullableString, transferType TransferType, transferAmount string, failureReason NullableTransferFailure, sweepId NullableString, sweepAmount NullableString, refundId NullableString, originatorClientId NullableString) *TransferEvent {
	this := TransferEvent{}
