...
type FDXNotificationPayload struct {
	...
	Event *FDXLifecycleEvent `json:"event,omitempty"`
...
func (o *FDXNotificationPayload) GetEvent() FDXLifecycleEvent {
	if o == nil || o.Event == nil {
		var ret FDXLifecycleEvent
		return ret
	}
	return *o.Event
}
...
// and a boolean to check if the value has been set.
func (o *FDXNotificationPayload) GetEventOk() (*FDXLifecycleEvent, bool) {
	if o == nil || o.Event == nil {
		return nil, false
	}
	return o.Event, true
...
func (o *FDXNotificationPayload) HasEvent() bool {
	if o != nil && o.Event != nil {
		return true
	}
...
// SetEvent gets a reference to the given FDXLifecycleEvent and assigns it to the Event field.
func (o *FDXNotificationPayload) SetEvent(v FDXLifecycleEvent) {
	o.Event = &v
}
