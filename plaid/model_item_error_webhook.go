...
func NewItemErrorWebhook(webhookType string, webhookCode string, itemId string, error_ NullablePlaidError, environment WebhookEnvironmentValues) *ItemErrorWebhook {
...
func (o *ItemErrorWebhook) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *ItemErrorWebhook) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *ItemErrorWebhook) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *ItemErrorWebhook) SetUserId(v string) {
	o.UserId = &v
}
...
func (o *ItemErrorWebhook) GetEnvironment() WebhookEnvironmentValues {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ItemErrorWebhook) GetEnvironmentOk() (*WebhookEnvironmentValues, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *ItemErrorWebhook) SetEnvironment(v WebhookEnvironmentValues) {
	o.Environment = v
}
