...
func (o *EarningsBreakdown) GetCanonicalDescription() string {
...
func (o *EarningsBreakdown) GetCanonicalDescriptionOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *EarningsBreakdown) SetCanonicalDescription(v string) {
