...
func NewCreditPayrollIncomeRefreshRequest() *CreditPayrollIncomeRefreshRequest {
...
func (o *CreditPayrollIncomeRefreshRequest) HasUserToken() bool {
	if o != nil && o.UserToken != nil {
		return true
	}
...
func (o *CreditPayrollIncomeRefreshRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *CreditPayrollIncomeRefreshRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *CreditPayrollIncomeRefreshRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *CreditPayrollIncomeRefreshRequest) SetUserId(v string) {
	o.UserId = &v
}
