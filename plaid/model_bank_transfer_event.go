...
type BankTransferEvent struct {
	...
	ReceiverDetails NullableReceiverDetails `json:"receiver_details"`
...
// If the value is explicit nil, the zero value for ReceiverDetails will be returned
func (o *BankTransferEvent) GetReceiverDetails() ReceiverDetails {
	if o == nil || o.ReceiverDetails.Get() == nil {
		var ret ReceiverDetails
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BankTransferEvent) GetReceiverDetailsOk() (*ReceiverDetails, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *BankTransferEvent) SetReceiverDetails(v ReceiverDetails) {
