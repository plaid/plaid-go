...
type Activity struct {
	...
	Authentication *ItemCreateAuthentication `json:"authentication,omitempty"`
}
...
func (o *Activity) GetAuthentication() ItemCreateAuthentication {
	if o == nil || o.Authentication == nil {
		var ret ItemCreateAuthentication
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Activity) GetAuthenticationOk() (*ItemCreateAuthentication, bool) {
	if o == nil || o.Authentication == nil {
		return nil, false
	}
...
func (o *Activity) HasAuthentication() bool {
	if o != nil && o.Authentication != nil {
		return true
	}
...
// SetAuthentication gets a reference to the given ItemCreateAuthentication and assigns it to the Authentication field.
func (o *Activity) SetAuthentication(v ItemCreateAuthentication) {
	o.Authentication = &v
}
