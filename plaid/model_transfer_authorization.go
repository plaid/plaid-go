...
type TransferAuthorization struct {
	...
	GuaranteeDetails NullableAuthorizationGuaranteeDetails `json:"guarantee_details,omitempty"`
	PaymentRisk NullableTransferAuthorizationPaymentRisk `json:"payment_risk"`
...
func (o *TransferAuthorization) GetGuaranteeDetails() AuthorizationGuaranteeDetails {
	if o == nil || o.GuaranteeDetails.Get() == nil {
		var ret AuthorizationGuaranteeDetails
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferAuthorization) GetGuaranteeDetailsOk() (*AuthorizationGuaranteeDetails, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferAuthorization) HasGuaranteeDetails() bool {
...
// SetGuaranteeDetails gets a reference to the given NullableAuthorizationGuaranteeDetails and assigns it to the GuaranteeDetails field.
func (o *TransferAuthorization) SetGuaranteeDetails(v AuthorizationGuaranteeDetails) {
	o.GuaranteeDetails.Set(&v)
}
// SetGuaranteeDetailsNil sets the value for GuaranteeDetails to be an explicit nil
func (o *TransferAuthorization) SetGuaranteeDetailsNil() {
...
func (o *TransferAuthorization) UnsetGuaranteeDetails() {
	o.GuaranteeDetails.Unset()
}

// GetPaymentRisk returns the PaymentRisk field value
// If the value is explicit nil, the zero value for TransferAuthorizationPaymentRisk will be returned
func (o *TransferAuthorization) GetPaymentRisk() TransferAuthorizationPaymentRisk {
	if o == nil || o.PaymentRisk.Get() == nil {
		var ret TransferAuthorizationPaymentRisk
		return ret
	}

	return *o.PaymentRisk.Get()
}

// GetPaymentRiskOk returns a tuple with the PaymentRisk field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferAuthorization) GetPaymentRiskOk() (*TransferAuthorizationPaymentRisk, bool) {
	if o == nil  {
		return nil, false
	}
	return o.PaymentRisk.Get(), o.PaymentRisk.IsSet()
}

// SetPaymentRisk sets field value
func (o *TransferAuthorization) SetPaymentRisk(v TransferAuthorizationPaymentRisk) {
	o.PaymentRisk.Set(&v)
}
...
func (o TransferAuthorization) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["payment_risk"] = o.PaymentRisk.Get()
	}
	if true {
...
func (o *TransferAuthorization) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "payment_risk")
