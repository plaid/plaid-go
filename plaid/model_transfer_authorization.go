...
type TransferAuthorization struct {
	...
	SignalInsights NullableSignalInsights `json:"signal_insights,omitempty"`
...
// GetSignalInsights returns the SignalInsights field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TransferAuthorization) GetSignalInsights() SignalInsights {
	if o == nil || o.SignalInsights.Get() == nil {
		var ret SignalInsights
		return ret
	}
	return *o.SignalInsights.Get()
}

// GetSignalInsightsOk returns a tuple with the SignalInsights field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferAuthorization) GetSignalInsightsOk() (*SignalInsights, bool) {
	if o == nil  {
		return nil, false
	}
	return o.SignalInsights.Get(), o.SignalInsights.IsSet()
}

// HasSignalInsights returns a boolean if a field has been set.
func (o *TransferAuthorization) HasSignalInsights() bool {
	if o != nil && o.SignalInsights.IsSet() {
		return true
	}
...
// SetSignalInsights gets a reference to the given NullableSignalInsights and assigns it to the SignalInsights field.
func (o *TransferAuthorization) SetSignalInsights(v SignalInsights) {
	o.SignalInsights.Set(&v)
}
// SetSignalInsightsNil sets the value for SignalInsights to be an explicit nil
func (o *TransferAuthorization) SetSignalInsightsNil() {
	o.SignalInsights.Set(nil)
}

// UnsetSignalInsights ensures that no value is present for SignalInsights, not even an explicit nil
func (o *TransferAuthorization) UnsetSignalInsights() {
	o.SignalInsights.Unset()
}
...
func (o TransferAuthorization) MarshalJSON() ([]byte, error) {
	...
	if o.SignalInsights.IsSet() {
		toSerialize["signal_insights"] = o.SignalInsights.Get()
	}
	if true {
...
func (o *TransferAuthorization) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "signal_insights")
