...
func (v *LoanIdentifierType) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid LoanIdentifierType", value)
}
...
func NewLoanIdentifierTypeFromValue(v string) (*LoanIdentifierType, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for LoanIdentifierType: valid values are %v", v, allowedLoanIdentifierTypeEnumValues)
	}
}
