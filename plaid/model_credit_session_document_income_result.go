...
func NewCreditSessionDocumentIncomeResult(numPaystubsUploaded int32, numW2sUploaded int32, numBankStatementsUploaded int32, num1099sUploaded int32) *CreditSessionDocumentIncomeResult {
