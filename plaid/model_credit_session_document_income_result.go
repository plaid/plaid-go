...
type CreditSessionDocumentIncomeResult struct {
	...
	Num1099sUploaded int32 `json:"num_1099s_uploaded"`
	// The number of I-20s uploaded by the user
	NumI20sUploaded int32 `json:"num_i20s_uploaded"`
}
...
func NewCreditSessionDocumentIncomeResult(numPaystubsUploaded int32, numW2sUploaded int32, numBankStatementsUploaded int32, num1099sUploaded int32, numI20sUploaded int32) *CreditSessionDocumentIncomeResult {
	...
	this.NumI20sUploaded = numI20sUploaded
	return &this
}
...
func (o *CreditSessionDocumentIncomeResult) GetNumBankStatementsUploaded() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreditSessionDocumentIncomeResult) GetNumBankStatementsUploadedOk() (*int32, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CreditSessionDocumentIncomeResult) SetNumBankStatementsUploaded(v int32) {
	o.NumBankStatementsUploaded = v
}

// GetNum1099sUploaded returns the Num1099sUploaded field value
func (o *CreditSessionDocumentIncomeResult) GetNum1099sUploaded() int32 {
	if o == nil {
		var ret int32
		return ret
	}

	return o.Num1099sUploaded
}

// GetNum1099sUploadedOk returns a tuple with the Num1099sUploaded field value
// and a boolean to check if the value has been set.
func (o *CreditSessionDocumentIncomeResult) GetNum1099sUploadedOk() (*int32, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Num1099sUploaded, true
}

// SetNum1099sUploaded sets field value
func (o *CreditSessionDocumentIncomeResult) SetNum1099sUploaded(v int32) {
	o.Num1099sUploaded = v
}

// GetNumI20sUploaded returns the NumI20sUploaded field value
func (o *CreditSessionDocumentIncomeResult) GetNumI20sUploaded() int32 {
	if o == nil {
		var ret int32
		return ret
	}

	return o.NumI20sUploaded
}

// GetNumI20sUploadedOk returns a tuple with the NumI20sUploaded field value
// and a boolean to check if the value has been set.
func (o *CreditSessionDocumentIncomeResult) GetNumI20sUploadedOk() (*int32, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.NumI20sUploaded, true
}

// SetNumI20sUploaded sets field value
func (o *CreditSessionDocumentIncomeResult) SetNumI20sUploaded(v int32) {
	o.NumI20sUploaded = v
}
...
func (o CreditSessionDocumentIncomeResult) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["num_1099s_uploaded"] = o.Num1099sUploaded
	}
	if true {
		toSerialize["num_i20s_uploaded"] = o.NumI20sUploaded
	}
