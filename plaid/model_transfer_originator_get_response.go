...
func NewTransferOriginatorGetResponse(originator Originator, requestId string) *TransferOriginatorGetResponse {
...
func (o *TransferOriginatorGetResponse) GetOriginator() Originator {
	if o == nil {
		var ret Originator
		return ret
	}
...
func (o *TransferOriginatorGetResponse) GetOriginatorOk() (*Originator, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferOriginatorGetResponse) SetOriginator(v Originator) {
	o.Originator = v
}
