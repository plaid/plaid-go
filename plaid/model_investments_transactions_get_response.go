...
func NewInvestmentsTransactionsGetResponse(item Item, accounts []InvestmentAccount, securities []Security, investmentTransactions []InvestmentTransaction, totalInvestmentTransactions int32, requestId string) *InvestmentsTransactionsGetResponse {
...
func (o *InvestmentsTransactionsGetResponse) GetAccounts() []InvestmentAccount {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *InvestmentsTransactionsGetResponse) GetAccountsOk() (*[]InvestmentAccount, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentsTransactionsGetResponse) SetAccounts(v []InvestmentAccount) {
	o.Accounts = v
}
...
func (o *InvestmentsTransactionsGetResponse) GetIsInvestmentsFallbackItem() bool {
...
// and a boolean to check if the value has been set.
func (o *InvestmentsTransactionsGetResponse) GetIsInvestmentsFallbackItemOk() (*bool, bool) {
	if o == nil || o.IsInvestmentsFallbackItem == nil {
		return nil, false
	}
...
func (o *InvestmentsTransactionsGetResponse) HasIsInvestmentsFallbackItem() bool {
	if o != nil && o.IsInvestmentsFallbackItem != nil {
		return true
	}
...
func (o *InvestmentsTransactionsGetResponse) SetIsInvestmentsFallbackItem(v bool) {
