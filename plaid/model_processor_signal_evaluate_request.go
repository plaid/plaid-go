...
func (o *ProcessorSignalEvaluateRequest) GetRulesetKey() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ProcessorSignalEvaluateRequest) GetRulesetKeyOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *ProcessorSignalEvaluateRequest) HasRulesetKey() bool {
