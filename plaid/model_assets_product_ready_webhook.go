...
type AssetsProductReadyWebhook struct {
	...
	ReportType *AssetReportType `json:"report_type,omitempty"`
...
func (o *AssetsProductReadyWebhook) GetReportType() AssetReportType {
	if o == nil || o.ReportType == nil {
		var ret AssetReportType
		return ret
	}
	return *o.ReportType
}
...
// and a boolean to check if the value has been set.
func (o *AssetsProductReadyWebhook) GetReportTypeOk() (*AssetReportType, bool) {
	if o == nil || o.ReportType == nil {
		return nil, false
	}
...
// SetReportType gets a reference to the given AssetReportType and assigns it to the ReportType field.
func (o *AssetsProductReadyWebhook) SetReportType(v AssetReportType) {
	o.ReportType = &v
}
