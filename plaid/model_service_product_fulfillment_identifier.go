...
func (v *ServiceProductFulfillmentIdentifier) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid ServiceProductFulfillmentIdentifier", value)
}
...
func NewServiceProductFulfillmentIdentifierFromValue(v string) (*ServiceProductFulfillmentIdentifier, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for ServiceProductFulfillmentIdentifier: valid values are %v", v, allowedServiceProductFulfillmentIdentifierEnumValues)
	}
}
