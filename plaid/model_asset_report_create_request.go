...
type AssetReportCreateRequest struct {
	...
	ReportType *FreddieReportType `json:"report_type,omitempty"`
}
...
func NewAssetReportCreateRequest(daysRequested int32) *AssetReportCreateRequest {
...
func (o *AssetReportCreateRequest) HasAccessTokens() bool {
	if o != nil && o.AccessTokens != nil {
		return true
	}
...
func (o *AssetReportCreateRequest) GetUserToken() string {
...
// and a boolean to check if the value has been set.
func (o *AssetReportCreateRequest) GetUserTokenOk() (*string, bool) {
	if o == nil || o.UserToken == nil {
		return nil, false
	}
...
func (o *AssetReportCreateRequest) HasUserToken() bool {
	if o != nil && o.UserToken != nil {
		return true
	}
...
func (o *AssetReportCreateRequest) SetUserToken(v string) {
	o.UserToken = &v
}
...
func (o *AssetReportCreateRequest) GetReportType() FreddieReportType {
	if o == nil || o.ReportType == nil {
		var ret FreddieReportType
		return ret
	}
	return *o.ReportType
}
...
// and a boolean to check if the value has been set.
func (o *AssetReportCreateRequest) GetReportTypeOk() (*FreddieReportType, bool) {
	if o == nil || o.ReportType == nil {
		return nil, false
	}
...
func (o *AssetReportCreateRequest) HasReportType() bool {
	if o != nil && o.ReportType != nil {
		return true
	}
...
// SetReportType gets a reference to the given FreddieReportType and assigns it to the ReportType field.
func (o *AssetReportCreateRequest) SetReportType(v FreddieReportType) {
	o.ReportType = &v
}
