...
func NewEmployer(employerId string, name string, address NullableAddressDataNullable, confidenceScore float64) *Employer {
	this := Employer{}
...
func (o *Employer) GetConfidenceScore() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Employer) GetConfidenceScoreOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *Employer) SetConfidenceScore(v float64) {
	o.ConfidenceScore = v
}
