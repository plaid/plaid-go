...
type TransactionsRecurringGetResponse struct {
	...
	InflowStreams *[]TransactionStream `json:"inflow_streams,omitempty"`
...
func NewTransactionsRecurringGetResponse(outflowStreams []TransactionStream, requestId string) *TransactionsRecurringGetResponse {
...
// GetInflowStreams returns the InflowStreams field value if set, zero value otherwise.
func (o *TransactionsRecurringGetResponse) GetInflowStreams() []TransactionStream {
	if o == nil || o.InflowStreams == nil {
...
// GetInflowStreamsOk returns a tuple with the InflowStreams field value if set, nil otherwise
...
// HasInflowStreams returns a boolean if a field has been set.
func (o *TransactionsRecurringGetResponse) HasInflowStreams() bool {
	if o != nil && o.InflowStreams != nil {
		return true
	}
...
// SetInflowStreams gets a reference to the given []TransactionStream and assigns it to the InflowStreams field.
