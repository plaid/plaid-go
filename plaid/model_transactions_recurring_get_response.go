...
func (o *TransactionsRecurringGetResponse) GetPersonalFinanceCategoryVersion() string {
...
// and a boolean to check if the value has been set.
func (o *TransactionsRecurringGetResponse) GetPersonalFinanceCategoryVersionOk() (*string, bool) {
	if o == nil || o.PersonalFinanceCategoryVersion == nil {
		return nil, false
	}
...
func (o *TransactionsRecurringGetResponse) SetPersonalFinanceCategoryVersion(v string) {
