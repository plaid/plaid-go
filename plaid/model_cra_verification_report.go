...
type CraVerificationReport struct {
	...
	Voe NullableCraVoeReport `json:"voe,omitempty"`
...
func (o *CraVerificationReport) GetVoe() CraVoeReport {
	if o == nil || o.Voe.Get() == nil {
		var ret CraVoeReport
		return ret
	}
	return *o.Voe.Get()
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CraVerificationReport) GetVoeOk() (*CraVoeReport, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CraVerificationReport) HasVoe() bool {
...
// SetVoe gets a reference to the given NullableCraVoeReport and assigns it to the Voe field.
func (o *CraVerificationReport) SetVoe(v CraVoeReport) {
	o.Voe.Set(&v)
}
// SetVoeNil sets the value for Voe to be an explicit nil
func (o *CraVerificationReport) SetVoeNil() {
	o.Voe.Set(nil)
}

// UnsetVoe ensures that no value is present for Voe, not even an explicit nil
func (o *CraVerificationReport) UnsetVoe() {
	o.Voe.Unset()
}
