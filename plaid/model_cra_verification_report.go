...
type CraVerificationReport struct {
	...
	GseReferenceId *string `json:"gse_reference_id,omitempty"`
	...
	Income NullableCraVerificationIncomeReport `json:"income,omitempty"`
...
// GetGseReferenceId returns the GseReferenceId field value if set, zero value otherwise.
func (o *CraVerificationReport) GetGseReferenceId() string {
	if o == nil || o.GseReferenceId == nil {
		var ret string
		return ret
	}
	return *o.GseReferenceId
}

// GetGseReferenceIdOk returns a tuple with the GseReferenceId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CraVerificationReport) GetGseReferenceIdOk() (*string, bool) {
	if o == nil || o.GseReferenceId == nil {
		return nil, false
	}
	return o.GseReferenceId, true
}

// HasGseReferenceId returns a boolean if a field has been set.
func (o *CraVerificationReport) HasGseReferenceId() bool {
	if o != nil && o.GseReferenceId != nil {
		return true
	}
...
// SetGseReferenceId gets a reference to the given string and assigns it to the GseReferenceId field.
func (o *CraVerificationReport) SetGseReferenceId(v string) {
	o.GseReferenceId = &v
}
...
func (o *CraVerificationReport) GetIncome() CraVerificationIncomeReport {
	if o == nil || o.Income.Get() == nil {
		var ret CraVerificationIncomeReport
		return ret
	}
	return *o.Income.Get()
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CraVerificationReport) GetIncomeOk() (*CraVerificationIncomeReport, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CraVerificationReport) HasIncome() bool {
...
// SetIncome gets a reference to the given NullableCraVerificationIncomeReport and assigns it to the Income field.
func (o *CraVerificationReport) SetIncome(v CraVerificationIncomeReport) {
	o.Income.Set(&v)
}
// SetIncomeNil sets the value for Income to be an explicit nil
func (o *CraVerificationReport) SetIncomeNil() {
	o.Income.Set(nil)
}

// UnsetIncome ensures that no value is present for Income, not even an explicit nil
func (o *CraVerificationReport) UnsetIncome() {
	o.Income.Unset()
}
...
func (o CraVerificationReport) MarshalJSON() ([]byte, error) {
	...
	if o.GseReferenceId != nil {
		toSerialize["gse_reference_id"] = o.GseReferenceId
	}
...
func (o *CraVerificationReport) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "gse_reference_id")
