...
func NewBeaconReportSyndication(id string, beaconUserId string, report BeaconReportSyndicationOriginalReport, analysis BeaconReportSyndicationAnalysis) *BeaconReportSyndication {
...
func (o *BeaconReportSyndication) GetBeaconUserId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BeaconReportSyndication) GetBeaconUserIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *BeaconReportSyndication) SetBeaconUserId(v string) {
	o.BeaconUserId = v
}
