...
func (o *DepositSwitchStateUpdateWebhook) GetEnvironment() WebhookEnvironmentValues {
...
// and a boolean to check if the value has been set.
func (o *DepositSwitchStateUpdateWebhook) GetEnvironmentOk() (*WebhookEnvironmentValues, bool) {
	if o == nil || o.Environment == nil {
		return nil, false
	}
...
func (o *DepositSwitchStateUpdateWebhook) HasEnvironment() bool {
	if o != nil && o.Environment != nil {
		return true
	}
...
func (o *DepositSwitchStateUpdateWebhook) SetEnvironment(v WebhookEnvironmentValues) {
	o.Environment = &v
}
