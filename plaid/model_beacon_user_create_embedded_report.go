...
func (o *BeaconUserCreateEmbeddedReport) GetFraudAmount() FraudAmount {
...
func (o *BeaconUserCreateEmbeddedReport) GetFraudAmountOk() (*FraudAmount, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *BeaconUserCreateEmbeddedReport) SetFraudAmount(v FraudAmount) {
	o.FraudAmount.Set(&v)
}
