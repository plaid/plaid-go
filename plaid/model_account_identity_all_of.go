...
func (o *AccountIdentityAllOf) GetDocuments() []IdentityDocument {
...
// and a boolean to check if the value has been set.
func (o *AccountIdentityAllOf) GetDocumentsOk() (*[]IdentityDocument, bool) {
	if o == nil || o.Documents == nil {
		return nil, false
	}
...
func (o *AccountIdentityAllOf) HasDocuments() bool {
	if o != nil && o.Documents != nil {
		return true
	}
...
func (o *AccountIdentityAllOf) SetDocuments(v []IdentityDocument) {
	o.Documents = &v
}
