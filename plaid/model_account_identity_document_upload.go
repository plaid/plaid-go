...
func (o *AccountIdentityDocumentUpload) GetVerificationName() string {
...
// and a boolean to check if the value has been set.
func (o *AccountIdentityDocumentUpload) GetVerificationNameOk() (*string, bool) {
	if o == nil || o.VerificationName == nil {
		return nil, false
	}
...
func (o *AccountIdentityDocumentUpload) HasVerificationName() bool {
	if o != nil && o.VerificationName != nil {
		return true
	}
...
func (o *AccountIdentityDocumentUpload) SetVerificationName(v string) {
...
func (o *AccountIdentityDocumentUpload) GetApy() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AccountIdentityDocumentUpload) GetApyOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *AccountIdentityDocumentUpload) HasApy() bool {
...
func (o *AccountIdentityDocumentUpload) SetApy(v float64) {
	o.Apy.Set(&v)
}
// SetApyNil sets the value for Apy to be an explicit nil
func (o *AccountIdentityDocumentUpload) SetApyNil() {
	o.Apy.Set(nil)
}

// UnsetApy ensures that no value is present for Apy, not even an explicit nil
func (o *AccountIdentityDocumentUpload) UnsetApy() {
	o.Apy.Unset()
}
