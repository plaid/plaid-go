...
type PayrollIncomeObject struct {
	...
	Form1099s []Credit1099 `json:"form1099s"`
	// Array of Form I-20 US immigration student documents.
	I20s []CreditI20 `json:"i20s"`
...
func NewPayrollIncomeObject(accountId NullableString, payStubs []CreditPayStub, w2s []CreditW2, form1099s []Credit1099, i20s []CreditI20) *PayrollIncomeObject {
...
// GetForm1099s returns the Form1099s field value
func (o *PayrollIncomeObject) GetForm1099s() []Credit1099 {
	if o == nil {
		var ret []Credit1099
		return ret
	}
...
// GetForm1099sOk returns a tuple with the Form1099s field value
// and a boolean to check if the value has been set.
func (o *PayrollIncomeObject) GetForm1099sOk() (*[]Credit1099, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Form1099s, true
}

// SetForm1099s sets field value
func (o *PayrollIncomeObject) SetForm1099s(v []Credit1099) {
	o.Form1099s = v
}

// GetI20s returns the I20s field value
func (o *PayrollIncomeObject) GetI20s() []CreditI20 {
	if o == nil {
		var ret []CreditI20
		return ret
	}
...
// GetI20sOk returns a tuple with the I20s field value
// and a boolean to check if the value has been set.
func (o *PayrollIncomeObject) GetI20sOk() (*[]CreditI20, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.I20s, true
...
// SetI20s sets field value
func (o *PayrollIncomeObject) SetI20s(v []CreditI20) {
	o.I20s = v
}
...
func (o PayrollIncomeObject) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["form1099s"] = o.Form1099s
	}
	if true {
		toSerialize["i20s"] = o.I20s
	}
...
func (o *PayrollIncomeObject) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "form1099s")
		delete(additionalProperties, "i20s")
