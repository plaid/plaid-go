...
type PayrollIncomeObject struct {
	...
	PayStubs []PayStub `json:"pay_stubs"`
...
func NewPayrollIncomeObject(accountId NullableString, payStubs []PayStub, w2s []CreditW2) *PayrollIncomeObject {
...
func (o *PayrollIncomeObject) GetPayStubs() []PayStub {
	if o == nil {
		var ret []PayStub
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PayrollIncomeObject) GetPayStubsOk() (*[]PayStub, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *PayrollIncomeObject) SetPayStubs(v []PayStub) {
	o.PayStubs = v
}
