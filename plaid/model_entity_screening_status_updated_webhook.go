...
func NewEntityScreeningStatusUpdatedWebhook(webhookType string, webhookCode string, screeningId interface{}, environment WebhookEnvironmentValues) *EntityScreeningStatusUpdatedWebhook {
