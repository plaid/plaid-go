...
func NewTransferEventListResponse(transferEvents []TransferEvent, hasMore bool, requestId string) *TransferEventListResponse {
...
func (o *TransferEventListResponse) GetHasMore() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TransferEventListResponse) GetHasMoreOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferEventListResponse) SetHasMore(v bool) {
	o.HasMore = v
}
