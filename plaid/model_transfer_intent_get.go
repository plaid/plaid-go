...
func NewTransferIntentGet(id string, created time.Time, status TransferIntentStatus, transferId NullableString, failureReason NullableTransferIntentGetFailureReason, authorizationDecision NullableTransferIntentAuthorizationDecision, authorizationDecisionRationale NullableTransferAuthorizationDecisionRationale, originationAccountId string, amount string, mode TransferIntentCreateMode, user TransferUserInResponse, description string, isoCurrencyCode string, guaranteeDecision NullableTransferAuthorizationGuaranteeDecision, guaranteeDecisionRationale NullableTransferAuthorizationGuaranteeDecisionRationale) *TransferIntentGet {
