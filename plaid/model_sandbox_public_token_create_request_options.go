...
type SandboxPublicTokenCreateRequestOptions struct {
	...
	Transactions NullableSandboxPublicTokenCreateRequestOptionsTransactions `json:"transactions,omitempty"`
...
// SetTransactions gets a reference to the given NullableSandboxPublicTokenCreateRequestOptionsTransactions and assigns it to the Transactions field.
...
func (o *SandboxPublicTokenCreateRequestOptions) SetTransactionsNil() {
	o.Transactions.Set(nil)
}

// UnsetTransactions ensures that no value is present for Transactions, not even an explicit nil
func (o *SandboxPublicTokenCreateRequestOptions) UnsetTransactions() {
