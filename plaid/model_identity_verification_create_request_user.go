...
func (o *IdentityVerificationCreateRequestUser) GetIpAddress() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IdentityVerificationCreateRequestUser) GetIpAddressOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *IdentityVerificationCreateRequestUser) HasIpAddress() bool {
...
func (o *IdentityVerificationCreateRequestUser) SetIpAddress(v string) {
	o.IpAddress.Set(&v)
}
// SetIpAddressNil sets the value for IpAddress to be an explicit nil
func (o *IdentityVerificationCreateRequestUser) SetIpAddressNil() {
	o.IpAddress.Set(nil)
}

// UnsetIpAddress ensures that no value is present for IpAddress, not even an explicit nil
func (o *IdentityVerificationCreateRequestUser) UnsetIpAddress() {
	o.IpAddress.Unset()
}
