...
func (o *AssetReportTransactionAllOf) GetCreditCategory() CreditCategory {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AssetReportTransactionAllOf) GetCreditCategoryOk() (*CreditCategory, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *AssetReportTransactionAllOf) HasCreditCategory() bool {
