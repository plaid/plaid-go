...
type AccountAssets struct {
	...
	Balances AssetReportAccountBalance `json:"balances"`
	...
	Investments *AssetReportInvestments `json:"investments,omitempty"`
	...
	AccountInsights NullableAccountInsights `json:"account_insights,omitempty"`
...
func (o *AccountAssets) GetBalances() AssetReportAccountBalance {
	if o == nil {
		var ret AssetReportAccountBalance
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AccountAssets) GetBalancesOk() (*AssetReportAccountBalance, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *AccountAssets) SetBalances(v AssetReportAccountBalance) {
	o.Balances = v
}
...
func (o *AccountAssets) GetInvestments() AssetReportInvestments {
	if o == nil || o.Investments == nil {
		var ret AssetReportInvestments
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AccountAssets) GetInvestmentsOk() (*AssetReportInvestments, bool) {
	if o == nil || o.Investments == nil {
		return nil, false
	}
...
func (o *AccountAssets) HasInvestments() bool {
	if o != nil && o.Investments != nil {
		return true
	}
...
// SetInvestments gets a reference to the given AssetReportInvestments and assigns it to the Investments field.
func (o *AccountAssets) SetInvestments(v AssetReportInvestments) {
	o.Investments = &v
}
...
// GetAccountInsights returns the AccountInsights field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *AccountAssets) GetAccountInsights() AccountInsights {
	if o == nil || o.AccountInsights.Get() == nil {
		var ret AccountInsights
		return ret
	}
	return *o.AccountInsights.Get()
}

// GetAccountInsightsOk returns a tuple with the AccountInsights field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AccountAssets) GetAccountInsightsOk() (*AccountInsights, bool) {
	if o == nil  {
		return nil, false
	}
	return o.AccountInsights.Get(), o.AccountInsights.IsSet()
}

// HasAccountInsights returns a boolean if a field has been set.
func (o *AccountAssets) HasAccountInsights() bool {
	if o != nil && o.AccountInsights.IsSet() {
		return true
	}
...
// SetAccountInsights gets a reference to the given NullableAccountInsights and assigns it to the AccountInsights field.
func (o *AccountAssets) SetAccountInsights(v AccountInsights) {
	o.AccountInsights.Set(&v)
}
// SetAccountInsightsNil sets the value for AccountInsights to be an explicit nil
func (o *AccountAssets) SetAccountInsightsNil() {
	o.AccountInsights.Set(nil)
}

// UnsetAccountInsights ensures that no value is present for AccountInsights, not even an explicit nil
func (o *AccountAssets) UnsetAccountInsights() {
	o.AccountInsights.Unset()
}
...
func (o AccountAssets) MarshalJSON() ([]byte, error) {
	...
	if o.AccountInsights.IsSet() {
		toSerialize["account_insights"] = o.AccountInsights.Get()
	}
