...
func (o *AccountAssets) GetHolderCategory() AccountHolderCategory {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AccountAssets) GetHolderCategoryOk() (*AccountHolderCategory, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *AccountAssets) HasHolderCategory() bool {
