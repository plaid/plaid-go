...
func NewTransferCreateRequest(idempotencyKey string, accessToken string, accountId string, authorizationId string, type_ TransferType, network TransferNetwork, amount string, isoCurrencyCode string, description string, user TransferUserInRequest) *TransferCreateRequest {
