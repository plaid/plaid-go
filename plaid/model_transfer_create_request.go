...
type TransferCreateRequest struct {
	...
	User *TransferUserInRequestDeprecated `json:"user,omitempty"`
...
// SetUser gets a reference to the given TransferUserInRequestDeprecated and assigns it to the User field.
