...
// TransferCreateRequest TransferCreateRequest defines the request schema for `/transfer/create`
...
func NewTransferCreateRequest(idempotencyKey string, accessToken string, accountId string, authorizationId string, type_ TransferType, network TransferNetwork, amount string, isoCurrencyCode string, description string, user TransferUser) *TransferCreateRequest {
...
func (o *TransferCreateRequest) GetUser() TransferUser {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TransferCreateRequest) GetUserOk() (*TransferUser, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.User, true
...
func (o *TransferCreateRequest) GetCustomTagOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferCreateRequest) HasCustomTag() bool {
