...
type _EntityScreeningHitAnalysis EntityScreeningHitAnalysis
...
func NewEntityScreeningHitAnalysis(searchTermsVersion int32) *EntityScreeningHitAnalysis {
...
func (o *EntityScreeningHitAnalysis) GetSearchTermsVersion() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EntityScreeningHitAnalysis) GetSearchTermsVersionOk() (*int32, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *EntityScreeningHitAnalysis) SetSearchTermsVersion(v int32) {
...
func (o *EntityScreeningHitAnalysis) UnmarshalJSON(bytes []byte) (err error) {
	varEntityScreeningHitAnalysis := _EntityScreeningHitAnalysis{}

	if err = json.Unmarshal(bytes, &varEntityScreeningHitAnalysis); err == nil {
		*o = EntityScreeningHitAnalysis(varEntityScreeningHitAnalysis)
	} else {
		return err
	}
