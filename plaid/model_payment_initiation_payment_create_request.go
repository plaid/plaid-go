...
func (o *PaymentInitiationPaymentCreateRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *PaymentInitiationPaymentCreateRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *PaymentInitiationPaymentCreateRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *PaymentInitiationPaymentCreateRequest) SetUserId(v string) {
	o.UserId = &v
}
