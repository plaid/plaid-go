...
func (o *LinkCallbackMetadata) GetEventName() string {
...
func (o *LinkCallbackMetadata) GetEventNameOk() (*string, bool) {
	if o == nil || o.EventName == nil {
		return nil, false
	}
...
func (o *LinkCallbackMetadata) SetEventName(v string) {
	o.EventName = &v
}
