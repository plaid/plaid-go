...
type _CreditBankIncomeHistoricalSummary CreditBankIncomeHistoricalSummary
...
func (o *CreditBankIncomeHistoricalSummary) GetTotalAmounts() []CreditAmountWithCurrency {
...
// and a boolean to check if the value has been set.
func (o *CreditBankIncomeHistoricalSummary) GetTotalAmountsOk() (*[]CreditAmountWithCurrency, bool) {
	if o == nil || o.TotalAmounts == nil {
		return nil, false
	}
...
func (o *CreditBankIncomeHistoricalSummary) HasTotalAmounts() bool {
	if o != nil && o.TotalAmounts != nil {
		return true
	}
...
func (o *CreditBankIncomeHistoricalSummary) SetTotalAmounts(v []CreditAmountWithCurrency) {
	o.TotalAmounts = &v
}
...
func (o *CreditBankIncomeHistoricalSummary) UnmarshalJSON(bytes []byte) (err error) {
	varCreditBankIncomeHistoricalSummary := _CreditBankIncomeHistoricalSummary{}

	if err = json.Unmarshal(bytes, &varCreditBankIncomeHistoricalSummary); err == nil {
		*o = CreditBankIncomeHistoricalSummary(varCreditBankIncomeHistoricalSummary)
	} else {
		return err
	}
