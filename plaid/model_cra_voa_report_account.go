...
type CraVoaReportAccount struct {
	...
	Investments NullableBaseReportInvestments `json:"investments,omitempty"`
...
func (o *CraVoaReportAccount) GetInvestments() BaseReportInvestments {
	if o == nil || o.Investments.Get() == nil {
		var ret BaseReportInvestments
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CraVoaReportAccount) GetInvestmentsOk() (*BaseReportInvestments, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CraVoaReportAccount) HasInvestments() bool {
...
// SetInvestments gets a reference to the given NullableBaseReportInvestments and assigns it to the Investments field.
func (o *CraVoaReportAccount) SetInvestments(v BaseReportInvestments) {
	o.Investments.Set(&v)
}
// SetInvestmentsNil sets the value for Investments to be an explicit nil
func (o *CraVoaReportAccount) SetInvestmentsNil() {
	o.Investments.Set(nil)
}

// UnsetInvestments ensures that no value is present for Investments, not even an explicit nil
func (o *CraVoaReportAccount) UnsetInvestments() {
	o.Investments.Unset()
}
