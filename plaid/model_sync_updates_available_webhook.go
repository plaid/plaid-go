...
func (o *SyncUpdatesAvailableWebhook) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *SyncUpdatesAvailableWebhook) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *SyncUpdatesAvailableWebhook) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *SyncUpdatesAvailableWebhook) SetUserId(v string) {
	o.UserId = &v
}
