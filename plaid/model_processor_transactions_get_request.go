...
func (o *ProcessorTransactionsGetRequest) GetOptions() TransactionsGetRequestOptions {
...
// and a boolean to check if the value has been set.
func (o *ProcessorTransactionsGetRequest) GetOptionsOk() (*TransactionsGetRequestOptions, bool) {
	if o == nil || o.Options == nil {
		return nil, false
	}
...
func (o *ProcessorTransactionsGetRequest) SetOptions(v TransactionsGetRequestOptions) {
	o.Options = &v
}
