...
type EntityWatchlistScreeningHit struct {
	...
	SubPrograms []string `json:"sub_programs"`
...
func NewEntityWatchlistScreeningHit(id string, reviewStatus WatchlistScreeningHitStatus, firstActive time.Time, inactiveSince NullableTime, historicalSince NullableTime, listCode EntityWatchlistCode, plaidUid string, sourceUid NullableString, subPrograms []string) *EntityWatchlistScreeningHit {
...
// GetSubPrograms returns the SubPrograms field value
func (o *EntityWatchlistScreeningHit) GetSubPrograms() []string {
	if o == nil {
		var ret []string
		return ret
	}

	return o.SubPrograms
}

// GetSubProgramsOk returns a tuple with the SubPrograms field value
// and a boolean to check if the value has been set.
func (o *EntityWatchlistScreeningHit) GetSubProgramsOk() (*[]string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.SubPrograms, true
}

// SetSubPrograms sets field value
func (o *EntityWatchlistScreeningHit) SetSubPrograms(v []string) {
	o.SubPrograms = v
}
...
func (o EntityWatchlistScreeningHit) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["sub_programs"] = o.SubPrograms
	}
	if o.Analysis != nil {
...
func (o *EntityWatchlistScreeningHit) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "sub_programs")
