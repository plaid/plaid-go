...
func (o *EmploymentVerificationGetResponse) GetError() PlaidError {
...
// and a boolean to check if the value has been set.
func (o *EmploymentVerificationGetResponse) GetErrorOk() (*PlaidError, bool) {
	if o == nil || o.Error == nil {
		return nil, false
	}
	return o.Error, true
...
func (o *EmploymentVerificationGetResponse) SetError(v PlaidError) {
	o.Error = &v
}
