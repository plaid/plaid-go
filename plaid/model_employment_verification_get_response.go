...
func (o *EmploymentVerificationGetResponse) GetError() Error {
...
func (o *EmploymentVerificationGetResponse) GetErrorOk() (*Error, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *EmploymentVerificationGetResponse) HasError() bool {
...
func (o *EmploymentVerificationGetResponse) SetError(v Error) {
	o.Error.Set(&v)
}
// SetErrorNil sets the value for Error to be an explicit nil
func (o *EmploymentVerificationGetResponse) SetErrorNil() {
	o.Error.Set(nil)
}

// UnsetError ensures that no value is present for Error, not even an explicit nil
func (o *EmploymentVerificationGetResponse) UnsetError() {
	o.Error.Unset()
}
