...
func (o *CreditPayrollIncomePrecheckRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *CreditPayrollIncomePrecheckRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *CreditPayrollIncomePrecheckRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *CreditPayrollIncomePrecheckRequest) SetUserId(v string) {
	o.UserId = &v
}
...
func (o *CreditPayrollIncomePrecheckRequest) GetPayrollInstitution() IncomeVerificationPrecheckPayrollInstitution {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CreditPayrollIncomePrecheckRequest) GetPayrollInstitutionOk() (*IncomeVerificationPrecheckPayrollInstitution, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CreditPayrollIncomePrecheckRequest) HasPayrollInstitution() bool {
...
func (o *CreditPayrollIncomePrecheckRequest) SetPayrollInstitution(v IncomeVerificationPrecheckPayrollInstitution) {
	o.PayrollInstitution.Set(&v)
}
// SetPayrollInstitutionNil sets the value for PayrollInstitution to be an explicit nil
func (o *CreditPayrollIncomePrecheckRequest) SetPayrollInstitutionNil() {
...
func (o *CreditPayrollIncomePrecheckRequest) UnsetPayrollInstitution() {
