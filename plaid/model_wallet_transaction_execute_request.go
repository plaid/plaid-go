...
type WalletTransactionExecuteRequest struct {
	...
	// The `user_id` of the end user the transaction is for, as returned by [`/user/create`](https://plaid.com/docs/api/users/#usercreate). The user must have a `name` and either an email address or a phone number. Required for new integrations.
	...
	OriginatingFundSource NullableOriginatingFundSource `json:"originating_fund_source,omitempty"`
}
...
func (o *WalletTransactionExecuteRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *WalletTransactionExecuteRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *WalletTransactionExecuteRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *WalletTransactionExecuteRequest) SetUserId(v string) {
	o.UserId = &v
}
...
// GetOriginatingFundSource returns the OriginatingFundSource field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WalletTransactionExecuteRequest) GetOriginatingFundSource() OriginatingFundSource {
	if o == nil || o.OriginatingFundSource.Get() == nil {
		var ret OriginatingFundSource
		return ret
	}
	return *o.OriginatingFundSource.Get()
}

// GetOriginatingFundSourceOk returns a tuple with the OriginatingFundSource field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WalletTransactionExecuteRequest) GetOriginatingFundSourceOk() (*OriginatingFundSource, bool) {
	if o == nil  {
		return nil, false
	}
	return o.OriginatingFundSource.Get(), o.OriginatingFundSource.IsSet()
}

// HasOriginatingFundSource returns a boolean if a field has been set.
func (o *WalletTransactionExecuteRequest) HasOriginatingFundSource() bool {
	if o != nil && o.OriginatingFundSource.IsSet() {
		return true
	}
...
// SetOriginatingFundSource gets a reference to the given NullableOriginatingFundSource and assigns it to the OriginatingFundSource field.
func (o *WalletTransactionExecuteRequest) SetOriginatingFundSource(v OriginatingFundSource) {
	o.OriginatingFundSource.Set(&v)
}
// SetOriginatingFundSourceNil sets the value for OriginatingFundSource to be an explicit nil
func (o *WalletTransactionExecuteRequest) SetOriginatingFundSourceNil() {
	o.OriginatingFundSource.Set(nil)
}

// UnsetOriginatingFundSource ensures that no value is present for OriginatingFundSource, not even an explicit nil
func (o *WalletTransactionExecuteRequest) UnsetOriginatingFundSource() {
	o.OriginatingFundSource.Unset()
}
...
func (o WalletTransactionExecuteRequest) MarshalJSON() ([]byte, error) {
	...
	if o.OriginatingFundSource.IsSet() {
		toSerialize["originating_fund_source"] = o.OriginatingFundSource.Get()
	}
