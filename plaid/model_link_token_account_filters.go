...
type LinkTokenAccountFilters struct {
	...
	Other *OtherFilter `json:"other,omitempty"`
...
func (o *LinkTokenAccountFilters) GetOther() OtherFilter {
...
// and a boolean to check if the value has been set.
func (o *LinkTokenAccountFilters) GetOtherOk() (*OtherFilter, bool) {
	if o == nil || o.Other == nil {
		return nil, false
	}
	return o.Other, true
...
func (o *LinkTokenAccountFilters) HasOther() bool {
	if o != nil && o.Other != nil {
		return true
	}
...
// SetOther gets a reference to the given OtherFilter and assigns it to the Other field.
func (o *LinkTokenAccountFilters) SetOther(v OtherFilter) {
	o.Other = &v
}
