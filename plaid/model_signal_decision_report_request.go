...
func (o *SignalDecisionReportRequest) GetSubmittedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *SignalDecisionReportRequest) GetSubmittedAtOk() (*time.Time, bool) {
	if o == nil || o.SubmittedAt == nil {
		return nil, false
	}
...
func (o *SignalDecisionReportRequest) HasSubmittedAt() bool {
	if o != nil && o.SubmittedAt != nil {
		return true
	}
...
func (o *SignalDecisionReportRequest) SetSubmittedAt(v time.Time) {
	o.SubmittedAt = &v
}
