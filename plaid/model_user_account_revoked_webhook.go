...
func (o *UserAccountRevokedWebhook) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *UserAccountRevokedWebhook) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *UserAccountRevokedWebhook) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *UserAccountRevokedWebhook) SetUserId(v string) {
	o.UserId = &v
}
