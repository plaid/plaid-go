...
type LinkEvent struct {
	...
	EventMetadata LinkEventMetadata `json:"event_metadata"`
...
func NewLinkEvent(eventName string, timestamp string, eventId string, eventMetadata LinkEventMetadata) *LinkEvent {
	this := LinkEvent{}
...
func (o *LinkEvent) GetEventMetadata() LinkEventMetadata {
	if o == nil {
		var ret LinkEventMetadata
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LinkEvent) GetEventMetadataOk() (*LinkEventMetadata, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *LinkEvent) SetEventMetadata(v LinkEventMetadata) {
	o.EventMetadata = v
}
