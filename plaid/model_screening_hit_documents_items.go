...
type _ScreeningHitDocumentsItems ScreeningHitDocumentsItems
...
func (o *ScreeningHitDocumentsItems) UnmarshalJSON(bytes []byte) (err error) {
	varScreeningHitDocumentsItems := _ScreeningHitDocumentsItems{}

	if err = json.Unmarshal(bytes, &varScreeningHitDocumentsItems); err == nil {
		*o = ScreeningHitDocumentsItems(varScreeningHitDocumentsItems)
	} else {
		return err
	}
