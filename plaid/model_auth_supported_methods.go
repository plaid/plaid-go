...
// GetInstantMicroDeposits returns the InstantMicroDeposits field value
...
// GetInstantMicroDepositsOk returns a tuple with the InstantMicroDeposits field value
// and a boolean to check if the value has been set.
