...
// GetPayroll returns the Payroll field value if set, zero value otherwise.
func (o *StandaloneAccountType) GetPayroll() string {
...
// GetPayrollOk returns a tuple with the Payroll field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StandaloneAccountType) GetPayrollOk() (*string, bool) {
	if o == nil || o.Payroll == nil {
		return nil, false
	}
	return o.Payroll, true
}

// HasPayroll returns a boolean if a field has been set.
func (o *StandaloneAccountType) HasPayroll() bool {
	if o != nil && o.Payroll != nil {
		return true
	}
...
// SetPayroll gets a reference to the given string and assigns it to the Payroll field.
func (o *StandaloneAccountType) SetPayroll(v string) {
	o.Payroll = &v
}
...
func (o *StandaloneAccountType) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "payroll")
