...
func NewCreditRelayCreateRequest(reportTokens []string, secondaryClientId string) *CreditRelayCreateRequest {
...
func (o *CreditRelayCreateRequest) GetReportTokens() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreditRelayCreateRequest) GetReportTokensOk() (*[]string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CreditRelayCreateRequest) SetReportTokens(v []string) {
	o.ReportTokens = v
}
