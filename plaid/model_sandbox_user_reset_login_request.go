...
func NewSandboxUserResetLoginRequest() *SandboxUserResetLoginRequest {
...
func (o *SandboxUserResetLoginRequest) HasUserToken() bool {
	if o != nil && o.UserToken != nil {
		return true
	}
...
func (o *SandboxUserResetLoginRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *SandboxUserResetLoginRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *SandboxUserResetLoginRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *SandboxUserResetLoginRequest) SetUserId(v string) {
	o.UserId = &v
}
