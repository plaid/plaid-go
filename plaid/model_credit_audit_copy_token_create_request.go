...
// CreditAuditCopyTokenCreateRequest CreditAuditCopyTokenCreateRequest defines the request schema for `/credit/audit_copy_token/get`
...
func NewCreditAuditCopyTokenCreateRequest(tokens []string, auditorId string) *CreditAuditCopyTokenCreateRequest {
...
func (o *CreditAuditCopyTokenCreateRequest) GetTokens() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreditAuditCopyTokenCreateRequest) GetTokensOk() (*[]string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CreditAuditCopyTokenCreateRequest) SetTokens(v []string) {
	o.Tokens = v
}
