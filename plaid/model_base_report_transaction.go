...
type BaseReportTransaction struct {
	...
	TransactionType *BaseReportTransactionType `json:"transaction_type,omitempty"`
...
func (o *BaseReportTransaction) GetPaymentMeta() PaymentMeta {
...
// and a boolean to check if the value has been set.
func (o *BaseReportTransaction) GetPaymentMetaOk() (*PaymentMeta, bool) {
	if o == nil || o.PaymentMeta == nil {
		return nil, false
	}
...
func (o *BaseReportTransaction) HasPaymentMeta() bool {
	if o != nil && o.PaymentMeta != nil {
		return true
	}
...
func (o *BaseReportTransaction) SetPaymentMeta(v PaymentMeta) {
	o.PaymentMeta = &v
}
...
// SetTransactionType gets a reference to the given BaseReportTransactionType and assigns it to the TransactionType field.
