...
func (o *BaseReportTransaction) GetCategoryId() interface{} {
	if o == nil  {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BaseReportTransaction) GetCategoryIdOk() (*interface{}, bool) {
...
func (o *BaseReportTransaction) SetCategoryId(v interface{}) {
	o.CategoryId = v
}
