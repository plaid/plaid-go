...
func (o *BaseReportTransaction) GetPersonalFinanceCategory() PersonalFinanceCategory {
...
// and a boolean to check if the value has been set.
func (o *BaseReportTransaction) GetPersonalFinanceCategoryOk() (*PersonalFinanceCategory, bool) {
	if o == nil || o.PersonalFinanceCategory == nil {
		return nil, false
	}
...
func (o *BaseReportTransaction) HasPersonalFinanceCategory() bool {
	if o != nil && o.PersonalFinanceCategory != nil {
		return true
	}
...
// SetPersonalFinanceCategory gets a reference to the given PersonalFinanceCategory and assigns it to the PersonalFinanceCategory field.
func (o *BaseReportTransaction) SetPersonalFinanceCategory(v PersonalFinanceCategory) {
