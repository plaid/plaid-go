...
func (v *FDXPartyType) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid FDXPartyType", value)
}
...
func NewFDXPartyTypeFromValue(v string) (*FDXPartyType, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for FDXPartyType: valid values are %v", v, allowedFDXPartyTypeEnumValues)
	}
}
