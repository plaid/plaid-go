...
func (o *AccountBaseNullable) GetApy() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AccountBaseNullable) GetApyOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *AccountBaseNullable) HasApy() bool {
