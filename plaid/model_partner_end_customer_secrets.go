...
func (o *PartnerEndCustomerSecrets) GetProduction() string {
...
// and a boolean to check if the value has been set.
func (o *PartnerEndCustomerSecrets) GetProductionOk() (*string, bool) {
	if o == nil || o.Production == nil {
		return nil, false
	}
...
func (o *PartnerEndCustomerSecrets) HasProduction() bool {
	if o != nil && o.Production != nil {
		return true
	}
...
// SetProduction gets a reference to the given string and assigns it to the Production field.
func (o *PartnerEndCustomerSecrets) SetProduction(v string) {
	o.Production = &v
}
