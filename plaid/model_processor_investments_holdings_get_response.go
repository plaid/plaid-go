...
// ProcessorInvestmentsHoldingsGetResponse ProcessorInvestmentsHoldingsGetResponse defines the response schema for `/processor/investments/holdings/get`
...
func NewProcessorInvestmentsHoldingsGetResponse(account InvestmentAccount, holdings []Holding, securities []Security) *ProcessorInvestmentsHoldingsGetResponse {
...
func (o *ProcessorInvestmentsHoldingsGetResponse) GetAccount() InvestmentAccount {
	if o == nil {
...
func (o *ProcessorInvestmentsHoldingsGetResponse) GetAccountOk() (*InvestmentAccount, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *ProcessorInvestmentsHoldingsGetResponse) SetAccount(v InvestmentAccount) {
	o.Account = v
}
...
func (o *ProcessorInvestmentsHoldingsGetResponse) HasIsInvestmentsFallbackItem() bool {
	if o != nil && o.IsInvestmentsFallbackItem != nil {
		return true
	}
