...
func NewTransactionsRulesListRequest(clientUserId string) *TransactionsRulesListRequest {
...
func (o *TransactionsRulesListRequest) GetClientUserId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TransactionsRulesListRequest) GetClientUserIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransactionsRulesListRequest) SetClientUserId(v string) {
	o.ClientUserId = v
}
