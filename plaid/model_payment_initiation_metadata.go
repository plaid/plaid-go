...
func NewPaymentInitiationMetadata(supportsInternationalPayments bool, supportsSepaInstant bool, maximumPaymentAmount map[string]string, supportsRefundDetails bool, standingOrderMetadata NullablePaymentInitiationStandingOrderMetadata, supportsPaymentConsents bool) *PaymentInitiationMetadata {
...
// GetSupportsPaymentConsents returns the SupportsPaymentConsents field value
func (o *PaymentInitiationMetadata) GetSupportsPaymentConsents() bool {
	if o == nil {
		var ret bool
		return ret
	}

	return o.SupportsPaymentConsents
}

// GetSupportsPaymentConsentsOk returns a tuple with the SupportsPaymentConsents field value
// and a boolean to check if the value has been set.
func (o *PaymentInitiationMetadata) GetSupportsPaymentConsentsOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.SupportsPaymentConsents, true
}

// SetSupportsPaymentConsents sets field value
func (o *PaymentInitiationMetadata) SetSupportsPaymentConsents(v bool) {
	o.SupportsPaymentConsents = v
}
...
func (o PaymentInitiationMetadata) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["supports_payment_consents"] = o.SupportsPaymentConsents
	}
...
func (o *PaymentInitiationMetadata) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "supports_payment_consents")
