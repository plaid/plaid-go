...
type PaymentInitiationConsentPaymentExecuteRequest struct {
	...
	Scope *PaymentInitiationConsentScope `json:"scope,omitempty"`
	ProcessingMode *PaymentInitiationConsentProcessingMode `json:"processing_mode,omitempty"`
}
...
func (o *PaymentInitiationConsentPaymentExecuteRequest) GetReference() string {
...
func (o *PaymentInitiationConsentPaymentExecuteRequest) GetReferenceOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *PaymentInitiationConsentPaymentExecuteRequest) HasReference() bool {
...
func (o *PaymentInitiationConsentPaymentExecuteRequest) SetReference(v string) {
	o.Reference.Set(&v)
}
// SetReferenceNil sets the value for Reference to be an explicit nil
func (o *PaymentInitiationConsentPaymentExecuteRequest) SetReferenceNil() {
	o.Reference.Set(nil)
}

// UnsetReference ensures that no value is present for Reference, not even an explicit nil
func (o *PaymentInitiationConsentPaymentExecuteRequest) UnsetReference() {
	o.Reference.Unset()
}

// GetScope returns the Scope field value if set, zero value otherwise.
func (o *PaymentInitiationConsentPaymentExecuteRequest) GetScope() PaymentInitiationConsentScope {
...
// and a boolean to check if the value has been set.
func (o *PaymentInitiationConsentPaymentExecuteRequest) GetScopeOk() (*PaymentInitiationConsentScope, bool) {
	if o == nil || o.Scope == nil {
		return nil, false
	}
	return o.Scope, true
...
func (o *PaymentInitiationConsentPaymentExecuteRequest) HasScope() bool {
	if o != nil && o.Scope != nil {
		return true
	}
...
// SetScope gets a reference to the given PaymentInitiationConsentScope and assigns it to the Scope field.
func (o *PaymentInitiationConsentPaymentExecuteRequest) SetScope(v PaymentInitiationConsentScope) {
	o.Scope = &v
}

// GetProcessingMode returns the ProcessingMode field value if set, zero value otherwise.
func (o *PaymentInitiationConsentPaymentExecuteRequest) GetProcessingMode() PaymentInitiationConsentProcessingMode {
	if o == nil || o.ProcessingMode == nil {
		var ret PaymentInitiationConsentProcessingMode
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PaymentInitiationConsentPaymentExecuteRequest) GetProcessingModeOk() (*PaymentInitiationConsentProcessingMode, bool) {
	if o == nil || o.ProcessingMode == nil {
		return nil, false
	}
...
func (o *PaymentInitiationConsentPaymentExecuteRequest) HasProcessingMode() bool {
	if o != nil && o.ProcessingMode != nil {
		return true
	}
...
// SetProcessingMode gets a reference to the given PaymentInitiationConsentProcessingMode and assigns it to the ProcessingMode field.
func (o *PaymentInitiationConsentPaymentExecuteRequest) SetProcessingMode(v PaymentInitiationConsentProcessingMode) {
	o.ProcessingMode = &v
}
