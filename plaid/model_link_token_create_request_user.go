...
func (o *LinkTokenCreateRequestUser) GetDateOfBirth() time.Time {
...
// and a boolean to check if the value has been set.
func (o *LinkTokenCreateRequestUser) GetDateOfBirthOk() (*time.Time, bool) {
	if o == nil || o.DateOfBirth == nil {
		return nil, false
	}
...
func (o *LinkTokenCreateRequestUser) SetDateOfBirth(v time.Time) {
	o.DateOfBirth = &v
}
