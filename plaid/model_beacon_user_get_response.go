...
func NewBeaconUserGetResponse(itemIds []string, id string, version int32, createdAt time.Time, updatedAt time.Time, status BeaconUserStatus, programId string, clientUserId string, user BeaconUserData, auditTrail BeaconAuditTrail, requestId string) *BeaconUserGetResponse {
...
func (o *BeaconUserGetResponse) GetItemIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *BeaconUserGetResponse) GetItemIdsOk() (*[]string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *BeaconUserGetResponse) SetItemIds(v []string) {
	o.ItemIds = v
}
