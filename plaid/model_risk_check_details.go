...
type RiskCheckDetails struct {
	...
	FacialDuplicates []RiskCheckFacialDuplicate `json:"facial_duplicates"`
	// The trust index score for the `risk_check` step.
	TrustIndexScore NullableInt32 `json:"trust_index_score"`
...
func NewRiskCheckDetails(status IdentityVerificationStepStatus, behavior NullableRiskCheckBehavior, email NullableRiskCheckEmail, phone NullableRiskCheckPhone, devices []RiskCheckDevice, identityAbuseSignals NullableRiskCheckIdentityAbuseSignals, facialDuplicates []RiskCheckFacialDuplicate, trustIndexScore NullableInt32) *RiskCheckDetails {
	...
	this.FacialDuplicates = facialDuplicates
	this.TrustIndexScore = trustIndexScore
	return &this
}
...
// GetFacialDuplicates returns the FacialDuplicates field value
func (o *RiskCheckDetails) GetFacialDuplicates() []RiskCheckFacialDuplicate {
	if o == nil {
		var ret []RiskCheckFacialDuplicate
		return ret
	}

	return o.FacialDuplicates
}

// GetFacialDuplicatesOk returns a tuple with the FacialDuplicates field value
// and a boolean to check if the value has been set.
func (o *RiskCheckDetails) GetFacialDuplicatesOk() (*[]RiskCheckFacialDuplicate, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.FacialDuplicates, true
}

// SetFacialDuplicates sets field value
func (o *RiskCheckDetails) SetFacialDuplicates(v []RiskCheckFacialDuplicate) {
	o.FacialDuplicates = v
}

// GetTrustIndexScore returns the TrustIndexScore field value
// If the value is explicit nil, the zero value for int32 will be returned
func (o *RiskCheckDetails) GetTrustIndexScore() int32 {
	if o == nil || o.TrustIndexScore.Get() == nil {
		var ret int32
		return ret
	}

	return *o.TrustIndexScore.Get()
}

// GetTrustIndexScoreOk returns a tuple with the TrustIndexScore field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *RiskCheckDetails) GetTrustIndexScoreOk() (*int32, bool) {
	if o == nil  {
		return nil, false
	}
	return o.TrustIndexScore.Get(), o.TrustIndexScore.IsSet()
}

// SetTrustIndexScore sets field value
func (o *RiskCheckDetails) SetTrustIndexScore(v int32) {
	o.TrustIndexScore.Set(&v)
}
...
func (o RiskCheckDetails) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["facial_duplicates"] = o.FacialDuplicates
	}
	if true {
		toSerialize["trust_index_score"] = o.TrustIndexScore.Get()
	}
...
func (o *RiskCheckDetails) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "facial_duplicates")
		delete(additionalProperties, "trust_index_score")
