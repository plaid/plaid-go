...
func NewRiskCheckDetails(status IdentityVerificationStepStatus, behavior NullableRiskCheckBehavior, email NullableRiskCheckEmail, phone NullableRiskCheckPhone, devices []RiskCheckDevice, identityAbuseSignals NullableRiskCheckIdentityAbuseSignals, facialDuplicates []RiskCheckFacialDuplicate) *RiskCheckDetails {
