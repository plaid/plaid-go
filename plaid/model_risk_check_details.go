...
type RiskCheckDetails struct {
	...
	IdentityAbuseSignals NullableRiskCheckIdentityAbuseSignals `json:"identity_abuse_signals,omitempty"`
...
// GetIdentityAbuseSignals returns the IdentityAbuseSignals field value if set, zero value otherwise (both if not set or set to explicit null).
...
// GetIdentityAbuseSignalsOk returns a tuple with the IdentityAbuseSignals field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// HasIdentityAbuseSignals returns a boolean if a field has been set.
func (o *RiskCheckDetails) HasIdentityAbuseSignals() bool {
	if o != nil && o.IdentityAbuseSignals.IsSet() {
		return true
	}
...
// SetIdentityAbuseSignals gets a reference to the given NullableRiskCheckIdentityAbuseSignals and assigns it to the IdentityAbuseSignals field.
func (o *RiskCheckDetails) SetIdentityAbuseSignals(v RiskCheckIdentityAbuseSignals) {
	o.IdentityAbuseSignals.Set(&v)
}
// SetIdentityAbuseSignalsNil sets the value for IdentityAbuseSignals to be an explicit nil
func (o *RiskCheckDetails) SetIdentityAbuseSignalsNil() {
	o.IdentityAbuseSignals.Set(nil)
}

// UnsetIdentityAbuseSignals ensures that no value is present for IdentityAbuseSignals, not even an explicit nil
func (o *RiskCheckDetails) UnsetIdentityAbuseSignals() {
	o.IdentityAbuseSignals.Unset()
}
...
func (o RiskCheckDetails) MarshalJSON() ([]byte, error) {
	...
	if o.IdentityAbuseSignals.IsSet() {
