...
func (v *FDXContentTypes) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid FDXContentTypes", value)
}
...
func NewFDXContentTypesFromValue(v string) (*FDXContentTypes, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for FDXContentTypes: valid values are %v", v, allowedFDXContentTypesEnumValues)
	}
}
