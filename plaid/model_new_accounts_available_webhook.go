...
func (o *NewAccountsAvailableWebhook) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *NewAccountsAvailableWebhook) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *NewAccountsAvailableWebhook) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *NewAccountsAvailableWebhook) SetUserId(v string) {
	o.UserId = &v
}
