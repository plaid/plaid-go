...
type IdentityVerificationRetryRequest struct {
	...
	User NullableIdentityVerificationRequestUser `json:"user,omitempty"`
	Steps NullableIdentityVerificationRetryRequestStepsObject `json:"steps,omitempty"`
	// A flag specifying whether you would like Plaid to expose a shareable URL for the verification being retried.
	IsShareable NullableBool `json:"is_shareable,omitempty"`
...
func (o *IdentityVerificationRetryRequest) GetUser() IdentityVerificationRequestUser {
...
func (o *IdentityVerificationRetryRequest) GetUserOk() (*IdentityVerificationRequestUser, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *IdentityVerificationRetryRequest) HasUser() bool {
...
// SetUser gets a reference to the given NullableIdentityVerificationRequestUser and assigns it to the User field.
func (o *IdentityVerificationRetryRequest) SetUser(v IdentityVerificationRequestUser) {
	o.User.Set(&v)
}
// SetUserNil sets the value for User to be an explicit nil
func (o *IdentityVerificationRetryRequest) SetUserNil() {
	o.User.Set(nil)
}

// UnsetUser ensures that no value is present for User, not even an explicit nil
func (o *IdentityVerificationRetryRequest) UnsetUser() {
	o.User.Unset()
}
...
func (o *IdentityVerificationRetryRequest) GetIsShareable() bool {
	if o == nil || o.IsShareable.Get() == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IdentityVerificationRetryRequest) GetIsShareableOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *IdentityVerificationRetryRequest) HasIsShareable() bool {
...
func (o IdentityVerificationRetryRequest) MarshalJSON() ([]byte, error) {
	...
	if o.IsShareable.IsSet() {
		toSerialize["is_shareable"] = o.IsShareable.Get()
	}
	if o.ClientId != nil {
