...
type APR struct {
	...
	BalanceSubjectToApr NullableFloat64 `json:"balance_subject_to_apr"`
	// Amount of money charged due to interest from last statement.
	InterestChargeAmount NullableFloat64 `json:"interest_charge_amount"`
...
func NewAPR(aprPercentage float64, aprType string, balanceSubjectToApr NullableFloat64, interestChargeAmount NullableFloat64) *APR {
	this := APR{}
...
func (o *APR) GetAprPercentage() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
func (o *APR) GetAprPercentageOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *APR) SetAprPercentage(v float64) {
	o.AprPercentage = v
}
...
func (o *APR) GetBalanceSubjectToApr() float64 {
...
func (o *APR) GetBalanceSubjectToAprOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *APR) GetInterestChargeAmountOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *APR) SetInterestChargeAmount(v float64) {
