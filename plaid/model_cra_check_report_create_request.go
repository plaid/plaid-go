...
type CraCheckReportCreateRequest struct {
	...
	Products *[]CraCheckReportProduct `json:"products,omitempty"`
...
func NewCraCheckReportCreateRequest(userToken string, webhook string, consumerReportPermissiblePurpose ConsumerReportPermissiblePurpose) *CraCheckReportCreateRequest {
...
func (o *CraCheckReportCreateRequest) HasDaysRequested() bool {
	if o != nil && o.DaysRequested != nil {
		return true
	}
...
func (o *CraCheckReportCreateRequest) GetProducts() []CraCheckReportProduct {
	if o == nil || o.Products == nil {
		var ret []CraCheckReportProduct
		return ret
	}
	return *o.Products
}
...
// and a boolean to check if the value has been set.
func (o *CraCheckReportCreateRequest) GetProductsOk() (*[]CraCheckReportProduct, bool) {
	if o == nil || o.Products == nil {
		return nil, false
	}
...
// SetProducts gets a reference to the given []CraCheckReportProduct and assigns it to the Products field.
func (o *CraCheckReportCreateRequest) SetProducts(v []CraCheckReportProduct) {
	o.Products = &v
}
