...
type CraCheckReportCreateRequest struct {
	...
	CashflowInsights NullableCraCheckReportCreateCashflowInsightsOptions `json:"cashflow_insights,omitempty"`
	PartnerInsights NullableCraCheckReportCreatePartnerInsightsOptions `json:"partner_insights,omitempty"`
	LendScore NullableCraCheckReportCreateLendScoreOptions `json:"lend_score,omitempty"`
	NetworkInsights NullableCraCheckReportCreateNetworkInsightsOptions `json:"network_insights,omitempty"`
	...
	IncomeInsights NullableCraCheckReportCreateIncomeInsightsOptions `json:"income_insights,omitempty"`
...
func NewCraCheckReportCreateRequest(webhook string, daysRequested int32, consumerReportPermissiblePurpose ConsumerReportPermissiblePurpose) *CraCheckReportCreateRequest {
...
func (o *CraCheckReportCreateRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *CraCheckReportCreateRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *CraCheckReportCreateRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *CraCheckReportCreateRequest) SetUserId(v string) {
	o.UserId = &v
}
...
func (o *CraCheckReportCreateRequest) HasUserToken() bool {
	if o != nil && o.UserToken != nil {
		return true
	}
...
func (o *CraCheckReportCreateRequest) GetCashflowInsights() CraCheckReportCreateCashflowInsightsOptions {
	if o == nil || o.CashflowInsights.Get() == nil {
		var ret CraCheckReportCreateCashflowInsightsOptions
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CraCheckReportCreateRequest) GetCashflowInsightsOk() (*CraCheckReportCreateCashflowInsightsOptions, bool) {
	if o == nil  {
		return nil, false
	}
...
// SetCashflowInsights gets a reference to the given NullableCraCheckReportCreateCashflowInsightsOptions and assigns it to the CashflowInsights field.
func (o *CraCheckReportCreateRequest) SetCashflowInsights(v CraCheckReportCreateCashflowInsightsOptions) {
...
func (o *CraCheckReportCreateRequest) GetPartnerInsights() CraCheckReportCreatePartnerInsightsOptions {
	if o == nil || o.PartnerInsights.Get() == nil {
		var ret CraCheckReportCreatePartnerInsightsOptions
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CraCheckReportCreateRequest) GetPartnerInsightsOk() (*CraCheckReportCreatePartnerInsightsOptions, bool) {
	if o == nil  {
		return nil, false
	}
...
// SetPartnerInsights gets a reference to the given NullableCraCheckReportCreatePartnerInsightsOptions and assigns it to the PartnerInsights field.
func (o *CraCheckReportCreateRequest) SetPartnerInsights(v CraCheckReportCreatePartnerInsightsOptions) {
...
func (o *CraCheckReportCreateRequest) GetLendScore() CraCheckReportCreateLendScoreOptions {
	if o == nil || o.LendScore.Get() == nil {
		var ret CraCheckReportCreateLendScoreOptions
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CraCheckReportCreateRequest) GetLendScoreOk() (*CraCheckReportCreateLendScoreOptions, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CraCheckReportCreateRequest) HasLendScore() bool {
...
// SetLendScore gets a reference to the given NullableCraCheckReportCreateLendScoreOptions and assigns it to the LendScore field.
func (o *CraCheckReportCreateRequest) SetLendScore(v CraCheckReportCreateLendScoreOptions) {
	o.LendScore.Set(&v)
}
// SetLendScoreNil sets the value for LendScore to be an explicit nil
func (o *CraCheckReportCreateRequest) SetLendScoreNil() {
	o.LendScore.Set(nil)
}

// UnsetLendScore ensures that no value is present for LendScore, not even an explicit nil
func (o *CraCheckReportCreateRequest) UnsetLendScore() {
	o.LendScore.Unset()
}

// GetNetworkInsights returns the NetworkInsights field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CraCheckReportCreateRequest) GetNetworkInsights() CraCheckReportCreateNetworkInsightsOptions {
	if o == nil || o.NetworkInsights.Get() == nil {
		var ret CraCheckReportCreateNetworkInsightsOptions
		return ret
	}
	return *o.NetworkInsights.Get()
}

// GetNetworkInsightsOk returns a tuple with the NetworkInsights field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CraCheckReportCreateRequest) GetNetworkInsightsOk() (*CraCheckReportCreateNetworkInsightsOptions, bool) {
	if o == nil  {
		return nil, false
	}
	return o.NetworkInsights.Get(), o.NetworkInsights.IsSet()
}

// HasNetworkInsights returns a boolean if a field has been set.
func (o *CraCheckReportCreateRequest) HasNetworkInsights() bool {
	if o != nil && o.NetworkInsights.IsSet() {
		return true
	}
...
// SetNetworkInsights gets a reference to the given NullableCraCheckReportCreateNetworkInsightsOptions and assigns it to the NetworkInsights field.
func (o *CraCheckReportCreateRequest) SetNetworkInsights(v CraCheckReportCreateNetworkInsightsOptions) {
	o.NetworkInsights.Set(&v)
}
// SetNetworkInsightsNil sets the value for NetworkInsights to be an explicit nil
func (o *CraCheckReportCreateRequest) SetNetworkInsightsNil() {
	o.NetworkInsights.Set(nil)
}

// UnsetNetworkInsights ensures that no value is present for NetworkInsights, not even an explicit nil
func (o *CraCheckReportCreateRequest) UnsetNetworkInsights() {
	o.NetworkInsights.Unset()
}
...
func (o *CraCheckReportCreateRequest) GetIncludeInvestments() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CraCheckReportCreateRequest) GetIncludeInvestmentsOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CraCheckReportCreateRequest) HasIncludeInvestments() bool {
...
func (o *CraCheckReportCreateRequest) SetIncludeInvestments(v bool) {
	o.IncludeInvestments.Set(&v)
}
// SetIncludeInvestmentsNil sets the value for IncludeInvestments to be an explicit nil
func (o *CraCheckReportCreateRequest) SetIncludeInvestmentsNil() {
...
func (o *CraCheckReportCreateRequest) UnsetIncludeInvestments() {
	o.IncludeInvestments.Unset()
}

// GetIncomeInsights returns the IncomeInsights field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CraCheckReportCreateRequest) GetIncomeInsights() CraCheckReportCreateIncomeInsightsOptions {
	if o == nil || o.IncomeInsights.Get() == nil {
		var ret CraCheckReportCreateIncomeInsightsOptions
		return ret
	}
	return *o.IncomeInsights.Get()
}

// GetIncomeInsightsOk returns a tuple with the IncomeInsights field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CraCheckReportCreateRequest) GetIncomeInsightsOk() (*CraCheckReportCreateIncomeInsightsOptions, bool) {
	if o == nil  {
		return nil, false
	}
	return o.IncomeInsights.Get(), o.IncomeInsights.IsSet()
}

// HasIncomeInsights returns a boolean if a field has been set.
func (o *CraCheckReportCreateRequest) HasIncomeInsights() bool {
	if o != nil && o.IncomeInsights.IsSet() {
		return true
	}
...
// SetIncomeInsights gets a reference to the given NullableCraCheckReportCreateIncomeInsightsOptions and assigns it to the IncomeInsights field.
func (o *CraCheckReportCreateRequest) SetIncomeInsights(v CraCheckReportCreateIncomeInsightsOptions) {
	o.IncomeInsights.Set(&v)
}
// SetIncomeInsightsNil sets the value for IncomeInsights to be an explicit nil
func (o *CraCheckReportCreateRequest) SetIncomeInsightsNil() {
	o.IncomeInsights.Set(nil)
}

// UnsetIncomeInsights ensures that no value is present for IncomeInsights, not even an explicit nil
func (o *CraCheckReportCreateRequest) UnsetIncomeInsights() {
	o.IncomeInsights.Unset()
}
...
func (o CraCheckReportCreateRequest) MarshalJSON() ([]byte, error) {
	...
	if o.NetworkInsights.IsSet() {
		toSerialize["network_insights"] = o.NetworkInsights.Get()
	}
	if o.IncludeInvestments.IsSet() {
		toSerialize["include_investments"] = o.IncludeInvestments.Get()
	}
	if o.IncomeInsights.IsSet() {
		toSerialize["income_insights"] = o.IncomeInsights.Get()
	}
	if true {
