...
type CraCheckReportCreateRequest struct {
	...
	PlaidCreditScore NullableCraCheckReportPlaidCreditScoreGetOptions `json:"plaid_credit_score,omitempty"`
...
func (o *CraCheckReportCreateRequest) GetPlaidCreditScore() CraCheckReportPlaidCreditScoreGetOptions {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CraCheckReportCreateRequest) GetPlaidCreditScoreOk() (*CraCheckReportPlaidCreditScoreGetOptions, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CraCheckReportCreateRequest) HasPlaidCreditScore() bool {
...
// SetPlaidCreditScore gets a reference to the given NullableCraCheckReportPlaidCreditScoreGetOptions and assigns it to the PlaidCreditScore field.
func (o *CraCheckReportCreateRequest) SetPlaidCreditScore(v CraCheckReportPlaidCreditScoreGetOptions) {
	o.PlaidCreditScore.Set(&v)
}
// SetPlaidCreditScoreNil sets the value for PlaidCreditScore to be an explicit nil
func (o *CraCheckReportCreateRequest) SetPlaidCreditScoreNil() {
...
func (o *CraCheckReportCreateRequest) UnsetPlaidCreditScore() {
