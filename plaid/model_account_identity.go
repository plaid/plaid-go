...
func (o *AccountIdentity) GetVerificationName() string {
...
// and a boolean to check if the value has been set.
func (o *AccountIdentity) GetVerificationNameOk() (*string, bool) {
	if o == nil || o.VerificationName == nil {
		return nil, false
	}
...
func (o *AccountIdentity) HasVerificationName() bool {
	if o != nil && o.VerificationName != nil {
		return true
	}
...
func (o *AccountIdentity) SetVerificationName(v string) {
...
func (o *AccountIdentity) GetApy() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AccountIdentity) GetApyOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *AccountIdentity) HasApy() bool {
...
func (o *AccountIdentity) GetHolderCategory() AccountHolderCategory {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AccountIdentity) GetHolderCategoryOk() (*AccountHolderCategory, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *AccountIdentity) HasHolderCategory() bool {
