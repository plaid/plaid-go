...
type _SignalReturnReportRequest SignalReturnReportRequest
...
func (o *SignalReturnReportRequest) UnmarshalJSON(bytes []byte) (err error) {
	varSignalReturnReportRequest := _SignalReturnReportRequest{}

	if err = json.Unmarshal(bytes, &varSignalReturnReportRequest); err == nil {
		*o = SignalReturnReportRequest(varSignalReturnReportRequest)
	}
