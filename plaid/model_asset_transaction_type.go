...
func (v *AssetTransactionType) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid AssetTransactionType", value)
}
...
func NewAssetTransactionTypeFromValue(v string) (*AssetTransactionType, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for AssetTransactionType: valid values are %v", v, allowedAssetTransactionTypeEnumValues)
	}
}
