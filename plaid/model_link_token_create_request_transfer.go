...
func (o *LinkTokenCreateRequestTransfer) GetAuthorizationId() string {
...
// and a boolean to check if the value has been set.
func (o *LinkTokenCreateRequestTransfer) GetAuthorizationIdOk() (*string, bool) {
	if o == nil || o.AuthorizationId == nil {
		return nil, false
	}
...
func (o *LinkTokenCreateRequestTransfer) HasAuthorizationId() bool {
	if o != nil && o.AuthorizationId != nil {
		return true
	}
...
func (o *LinkTokenCreateRequestTransfer) SetAuthorizationId(v string) {
	o.AuthorizationId = &v
}
