...
func (o *LinkTokenCreateRequestTransfer) GetPaymentProfileId() string {
...
// and a boolean to check if the value has been set.
func (o *LinkTokenCreateRequestTransfer) GetPaymentProfileIdOk() (*string, bool) {
	if o == nil || o.PaymentProfileId == nil {
		return nil, false
	}
...
func (o *LinkTokenCreateRequestTransfer) HasPaymentProfileId() bool {
	if o != nil && o.PaymentProfileId != nil {
		return true
	}
...
func (o *LinkTokenCreateRequestTransfer) SetPaymentProfileId(v string) {
