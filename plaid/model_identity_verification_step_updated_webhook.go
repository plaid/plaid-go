...
func NewIdentityVerificationStepUpdatedWebhook(webhookType string, webhookCode string, identityVerificationId interface{}, environment WebhookEnvironmentValues) *IdentityVerificationStepUpdatedWebhook {
