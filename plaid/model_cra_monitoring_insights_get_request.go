...
func NewCraMonitoringInsightsGetRequest(consumerReportPermissiblePurpose MonitoringConsumerReportPermissiblePurpose) *CraMonitoringInsightsGetRequest {
...
func (o *CraMonitoringInsightsGetRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *CraMonitoringInsightsGetRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *CraMonitoringInsightsGetRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *CraMonitoringInsightsGetRequest) SetUserId(v string) {
	o.UserId = &v
}
...
func (o *CraMonitoringInsightsGetRequest) HasUserToken() bool {
	if o != nil && o.UserToken != nil {
		return true
	}
