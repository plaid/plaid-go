...
func (o *CreditBankIncomeWebhookUpdateRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *CreditBankIncomeWebhookUpdateRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *CreditBankIncomeWebhookUpdateRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *CreditBankIncomeWebhookUpdateRequest) SetUserId(v string) {
	o.UserId = &v
}
