...
func NewStatementsAccount(accountId string, accountMask string, accountName string, accountOfficialName string, accountSubtype string, accountType string, statements []StatementsStatement) *StatementsAccount {
...
func (o *StatementsAccount) GetAccountMask() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *StatementsAccount) GetAccountMaskOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *StatementsAccount) SetAccountMask(v string) {
	o.AccountMask = v
}
...
// GetAccountOfficialName returns the AccountOfficialName field value
func (o *StatementsAccount) GetAccountOfficialName() string {
	if o == nil {
		var ret string
		return ret
	}

	return o.AccountOfficialName
}

// GetAccountOfficialNameOk returns a tuple with the AccountOfficialName field value
// and a boolean to check if the value has been set.
func (o *StatementsAccount) GetAccountOfficialNameOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.AccountOfficialName, true
}

// SetAccountOfficialName sets field value
func (o *StatementsAccount) SetAccountOfficialName(v string) {
	o.AccountOfficialName = v
}

// GetAccountSubtype returns the AccountSubtype field value
func (o *StatementsAccount) GetAccountSubtype() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *StatementsAccount) GetAccountSubtypeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *StatementsAccount) SetAccountSubtype(v string) {
	o.AccountSubtype = v
}
...
func (o StatementsAccount) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["account_official_name"] = o.AccountOfficialName
	}
	if true {
...
func (o *StatementsAccount) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "account_official_name")
