...
type _EntityScreeningHitPhoneNumbers EntityScreeningHitPhoneNumbers
...
func (o *EntityScreeningHitPhoneNumbers) UnmarshalJSON(bytes []byte) (err error) {
	varEntityScreeningHitPhoneNumbers := _EntityScreeningHitPhoneNumbers{}

	if err = json.Unmarshal(bytes, &varEntityScreeningHitPhoneNumbers); err == nil {
		*o = EntityScreeningHitPhoneNumbers(varEntityScreeningHitPhoneNumbers)
	} else {
		return err
	}
