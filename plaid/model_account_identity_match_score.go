...
func NewAccountIdentityMatchScore(accountId string, balances AccountBalance, mask NullableString, name string, officialName NullableString, type_ AccountType, subtype NullableAccountSubtype, legalName NameMatchScore, phoneNumber PhoneNumberMatchScore, emailAddress EmailAddressMatchScore, address AddressMatchScore) *AccountIdentityMatchScore {
...
func (o *AccountIdentityMatchScore) GetApy() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AccountIdentityMatchScore) GetApyOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *AccountIdentityMatchScore) HasApy() bool {
...
func (o *AccountIdentityMatchScore) SetApy(v float64) {
	o.Apy.Set(&v)
}
// SetApyNil sets the value for Apy to be an explicit nil
func (o *AccountIdentityMatchScore) SetApyNil() {
	o.Apy.Set(nil)
}

// UnsetApy ensures that no value is present for Apy, not even an explicit nil
func (o *AccountIdentityMatchScore) UnsetApy() {
	o.Apy.Unset()
}
