...
type Transfer struct {
	...
	SettledAmount NullableString `json:"settled_amount,omitempty"`
	// The expected settlement schedule of this transfer, if posted. Only applies to ACH debit transfers.
	ExpectedSettlementSchedule *[]TransferExpectedSettlementScheduleItem `json:"expected_settlement_schedule,omitempty"`
...
func NewTransfer(id string, fundingAccountId string, type_ TransferType, user TransferUserInResponse, amount string, description string, created time.Time, status TransferStatus, network TransferNetwork, cancellable bool, failureReason NullableTransferFailure, metadata map[string]string, originationAccountId string, guaranteeDecision NullableTransferAuthorizationGuaranteeDecision, guaranteeDecisionRationale NullableTransferAuthorizationGuaranteeDecisionRationale, isoCurrencyCode string, standardReturnWindow NullableString, unauthorizedReturnWindow NullableString, expectedSettlementDate NullableString, originatorClientId NullableString, refunds []TransferRefund, recurringTransferId NullableString) *Transfer {
	this := Transfer{}
	this.Id = id
...
// GetSettledAmount returns the SettledAmount field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Transfer) GetSettledAmount() string {
	if o == nil || o.SettledAmount.Get() == nil {
		var ret string
		return ret
	}
	return *o.SettledAmount.Get()
}

// GetSettledAmountOk returns a tuple with the SettledAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Transfer) GetSettledAmountOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return o.SettledAmount.Get(), o.SettledAmount.IsSet()
}

// HasSettledAmount returns a boolean if a field has been set.
func (o *Transfer) HasSettledAmount() bool {
	if o != nil && o.SettledAmount.IsSet() {
		return true
	}
...
// SetSettledAmount gets a reference to the given NullableString and assigns it to the SettledAmount field.
func (o *Transfer) SetSettledAmount(v string) {
	o.SettledAmount.Set(&v)
}
// SetSettledAmountNil sets the value for SettledAmount to be an explicit nil
func (o *Transfer) SetSettledAmountNil() {
	o.SettledAmount.Set(nil)
}

// UnsetSettledAmount ensures that no value is present for SettledAmount, not even an explicit nil
func (o *Transfer) UnsetSettledAmount() {
	o.SettledAmount.Unset()
}

// GetExpectedSettlementSchedule returns the ExpectedSettlementSchedule field value if set, zero value otherwise.
func (o *Transfer) GetExpectedSettlementSchedule() []TransferExpectedSettlementScheduleItem {
	if o == nil || o.ExpectedSettlementSchedule == nil {
		var ret []TransferExpectedSettlementScheduleItem
		return ret
	}
	return *o.ExpectedSettlementSchedule
}

// GetExpectedSettlementScheduleOk returns a tuple with the ExpectedSettlementSchedule field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Transfer) GetExpectedSettlementScheduleOk() (*[]TransferExpectedSettlementScheduleItem, bool) {
	if o == nil || o.ExpectedSettlementSchedule == nil {
		return nil, false
	}
	return o.ExpectedSettlementSchedule, true
}

// HasExpectedSettlementSchedule returns a boolean if a field has been set.
func (o *Transfer) HasExpectedSettlementSchedule() bool {
	if o != nil && o.ExpectedSettlementSchedule != nil {
		return true
	}
...
// SetExpectedSettlementSchedule gets a reference to the given []TransferExpectedSettlementScheduleItem and assigns it to the ExpectedSettlementSchedule field.
func (o *Transfer) SetExpectedSettlementSchedule(v []TransferExpectedSettlementScheduleItem) {
	o.ExpectedSettlementSchedule = &v
}
...
func (o Transfer) MarshalJSON() ([]byte, error) {
	...
	if o.SettledAmount.IsSet() {
		toSerialize["settled_amount"] = o.SettledAmount.Get()
	}
	if o.ExpectedSettlementSchedule != nil {
		toSerialize["expected_settlement_schedule"] = o.ExpectedSettlementSchedule
	}
...
func (o *Transfer) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "expected_settlement_schedule")
