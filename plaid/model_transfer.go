...
type Transfer struct {
	...
	GuaranteeDecision TransferAuthorizationGuaranteeDecision `json:"guarantee_decision"`
	GuaranteeDecisionRationale NullableTransferAuthorizationGuaranteeDecisionRationale `json:"guarantee_decision_rationale"`
	GuaranteeDetails NullableTransferGuaranteeDetails `json:"guarantee_details,omitempty"`
	...
	// The date 61 business days from settlement date indicating the following ACH returns can no longer happen: R05, R07, R10, R11, R51, R33, R37, R38, R52, R53. This will be of the form YYYY-MM-DD.
...
func NewTransfer(id string, authorizationId string, fundingAccountId NullableString, type_ TransferType, user TransferUserInResponse, amount string, description string, created time.Time, status TransferStatus, network TransferNetwork, cancellable bool, failureReason NullableTransferFailure, metadata map[string]string, originationAccountId string, guaranteeDecision TransferAuthorizationGuaranteeDecision, guaranteeDecisionRationale NullableTransferAuthorizationGuaranteeDecisionRationale, isoCurrencyCode string, standardReturnWindow NullableString, unauthorizedReturnWindow NullableString, expectedSettlementDate NullableString, originatorClientId NullableString, refunds []TransferRefund, recurringTransferId NullableString, creditFundsSource TransferCreditFundsSource) *Transfer {
	this := Transfer{}
	this.Id = id
...
// GetGuaranteeDetails returns the GuaranteeDetails field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Transfer) GetGuaranteeDetails() TransferGuaranteeDetails {
	if o == nil || o.GuaranteeDetails.Get() == nil {
		var ret TransferGuaranteeDetails
		return ret
	}
	return *o.GuaranteeDetails.Get()
}

// GetGuaranteeDetailsOk returns a tuple with the GuaranteeDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Transfer) GetGuaranteeDetailsOk() (*TransferGuaranteeDetails, bool) {
	if o == nil  {
		return nil, false
	}
	return o.GuaranteeDetails.Get(), o.GuaranteeDetails.IsSet()
}

// HasGuaranteeDetails returns a boolean if a field has been set.
func (o *Transfer) HasGuaranteeDetails() bool {
	if o != nil && o.GuaranteeDetails.IsSet() {
		return true
	}
...
// SetGuaranteeDetails gets a reference to the given NullableTransferGuaranteeDetails and assigns it to the GuaranteeDetails field.
func (o *Transfer) SetGuaranteeDetails(v TransferGuaranteeDetails) {
	o.GuaranteeDetails.Set(&v)
}
// SetGuaranteeDetailsNil sets the value for GuaranteeDetails to be an explicit nil
func (o *Transfer) SetGuaranteeDetailsNil() {
	o.GuaranteeDetails.Set(nil)
}

// UnsetGuaranteeDetails ensures that no value is present for GuaranteeDetails, not even an explicit nil
func (o *Transfer) UnsetGuaranteeDetails() {
	o.GuaranteeDetails.Unset()
}
...
func (o Transfer) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["guarantee_decision"] = o.GuaranteeDecision
	}
	if true {
		toSerialize["guarantee_decision_rationale"] = o.GuaranteeDecisionRationale.Get()
	}
	if o.GuaranteeDetails.IsSet() {
		toSerialize["guarantee_details"] = o.GuaranteeDetails.Get()
	}
	if true {
...
func (o *Transfer) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "guarantee_details")
