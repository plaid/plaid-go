...
func NewTransfer(id string, achClass ACHClass, accountId string, type_ TransferType, user TransferUser, amount string, isoCurrencyCode string, description string, created time.Time, status TransferStatus, network TransferNetwork, cancellable bool, failureReason NullableTransferFailure, customTag NullableString, metadata map[string]string, originationAccountId string, direction NullableTransferDirection) *Transfer {
	this := Transfer{}
	this.Id = id
...
func (o *Transfer) GetUser() TransferUser {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *Transfer) GetUserOk() (*TransferUser, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.User, true
...
func (o *Transfer) SetUser(v TransferUser) {
	o.User = v
}
...
func (o *Transfer) GetCustomTag() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Transfer) GetCustomTagOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *Transfer) SetCustomTag(v string) {
	o.CustomTag.Set(&v)
}
