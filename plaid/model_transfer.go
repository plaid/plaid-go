...
func NewTransfer(id string, type_ TransferType, user TransferUserInResponse, amount string, description string, created time.Time, status TransferStatus, network TransferNetwork, cancellable bool, failureReason NullableTransferFailure, metadata map[string]string, originationAccountId string, guaranteeDecision NullableTransferAuthorizationGuaranteeDecision, guaranteeDecisionRationale NullableTransferAuthorizationGuaranteeDecisionRationale, isoCurrencyCode string, standardReturnWindow NullableString, unauthorizedReturnWindow NullableString, originatorClientId NullableString, refunds []TransferRefund) *Transfer {
	this := Transfer{}
	this.Id = id
	this.Type = type_
	this.User = user
