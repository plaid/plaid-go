...
type PaymentInitiationPaymentReverseResponse struct {
	...
	Status PaymentInitiationRefundStatus `json:"status"`
...
func NewPaymentInitiationPaymentReverseResponse(refundId string, status PaymentInitiationRefundStatus, requestId string) *PaymentInitiationPaymentReverseResponse {
...
func (o *PaymentInitiationPaymentReverseResponse) GetStatus() PaymentInitiationRefundStatus {
	if o == nil {
		var ret PaymentInitiationRefundStatus
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PaymentInitiationPaymentReverseResponse) GetStatusOk() (*PaymentInitiationRefundStatus, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *PaymentInitiationPaymentReverseResponse) SetStatus(v PaymentInitiationRefundStatus) {
	o.Status = v
}
