...
func NewPaymentProfileCreateResponse(paymentProfileId string, requestId string) *PaymentProfileCreateResponse {
...
func (o *PaymentProfileCreateResponse) GetPaymentProfileId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *PaymentProfileCreateResponse) GetPaymentProfileIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *PaymentProfileCreateResponse) SetPaymentProfileId(v string) {
...
func (o *PaymentProfileCreateResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "payment_profile_id")
