...
type LiabilitiesObject struct {
	...
	// The closed-end loan accounts returned.
	Loan []LoanLiability `json:"loan,omitempty"`
	// The line of credit accounts returned.
	LineOfCredit []LineOfCreditLiability `json:"line_of_credit,omitempty"`
...
// GetLoan returns the Loan field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *LiabilitiesObject) GetLoan() []LoanLiability {
	if o == nil  {
		var ret []LoanLiability
		return ret
	}
	return o.Loan
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *LiabilitiesObject) GetLoanOk() (*[]LoanLiability, bool) {
	if o == nil || o.Loan == nil {
		return nil, false
	}
	return &o.Loan, true
...
func (o *LiabilitiesObject) HasLoan() bool {
	if o != nil && o.Loan != nil {
		return true
	}
...
// SetLoan gets a reference to the given []LoanLiability and assigns it to the Loan field.
func (o *LiabilitiesObject) SetLoan(v []LoanLiability) {
	o.Loan = v
}

// GetLineOfCredit returns the LineOfCredit field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *LiabilitiesObject) GetLineOfCredit() []LineOfCreditLiability {
	if o == nil  {
		var ret []LineOfCreditLiability
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *LiabilitiesObject) GetLineOfCreditOk() (*[]LineOfCreditLiability, bool) {
	if o == nil || o.LineOfCredit == nil {
		return nil, false
	}
...
func (o *LiabilitiesObject) HasLineOfCredit() bool {
	if o != nil && o.LineOfCredit != nil {
		return true
	}
...
// SetLineOfCredit gets a reference to the given []LineOfCreditLiability and assigns it to the LineOfCredit field.
func (o *LiabilitiesObject) SetLineOfCredit(v []LineOfCreditLiability) {
	o.LineOfCredit = v
}
...
func (o *LiabilitiesObject) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "line_of_credit")
