...
type AccountsBalanceGetRequest struct {
	...
	PaymentDetails NullableAccountsBalanceGetRequestPaymentDetails `json:"payment_details,omitempty"`
}
...
// GetPaymentDetails returns the PaymentDetails field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *AccountsBalanceGetRequest) GetPaymentDetails() AccountsBalanceGetRequestPaymentDetails {
	if o == nil || o.PaymentDetails.Get() == nil {
		var ret AccountsBalanceGetRequestPaymentDetails
		return ret
	}
	return *o.PaymentDetails.Get()
}

// GetPaymentDetailsOk returns a tuple with the PaymentDetails field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AccountsBalanceGetRequest) GetPaymentDetailsOk() (*AccountsBalanceGetRequestPaymentDetails, bool) {
	if o == nil  {
		return nil, false
	}
	return o.PaymentDetails.Get(), o.PaymentDetails.IsSet()
}

// HasPaymentDetails returns a boolean if a field has been set.
func (o *AccountsBalanceGetRequest) HasPaymentDetails() bool {
	if o != nil && o.PaymentDetails.IsSet() {
		return true
	}
...
// SetPaymentDetails gets a reference to the given NullableAccountsBalanceGetRequestPaymentDetails and assigns it to the PaymentDetails field.
func (o *AccountsBalanceGetRequest) SetPaymentDetails(v AccountsBalanceGetRequestPaymentDetails) {
	o.PaymentDetails.Set(&v)
}
// SetPaymentDetailsNil sets the value for PaymentDetails to be an explicit nil
func (o *AccountsBalanceGetRequest) SetPaymentDetailsNil() {
	o.PaymentDetails.Set(nil)
}

// UnsetPaymentDetails ensures that no value is present for PaymentDetails, not even an explicit nil
func (o *AccountsBalanceGetRequest) UnsetPaymentDetails() {
	o.PaymentDetails.Unset()
}
...
func (o AccountsBalanceGetRequest) MarshalJSON() ([]byte, error) {
	...
	if o.PaymentDetails.IsSet() {
		toSerialize["payment_details"] = o.PaymentDetails.Get()
	}
