...
func NewPendingDisconnectWebhook(webhookType string, webhookCode string, itemId string, reason PendingDisconnectWebhookReason, disconnectTime time.Time, environment WebhookEnvironmentValues) *PendingDisconnectWebhook {
...
func (o *PendingDisconnectWebhook) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *PendingDisconnectWebhook) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *PendingDisconnectWebhook) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *PendingDisconnectWebhook) SetUserId(v string) {
	o.UserId = &v
}
...
// GetDisconnectTime returns the DisconnectTime field value
func (o *PendingDisconnectWebhook) GetDisconnectTime() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// GetDisconnectTimeOk returns a tuple with the DisconnectTime field value
// and a boolean to check if the value has been set.
func (o *PendingDisconnectWebhook) GetDisconnectTimeOk() (*time.Time, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.DisconnectTime, true
}

// SetDisconnectTime sets field value
func (o *PendingDisconnectWebhook) SetDisconnectTime(v time.Time) {
	o.DisconnectTime = v
}
...
func (o PendingDisconnectWebhook) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["disconnect_time"] = o.DisconnectTime
	}
	if true {
...
func (o *PendingDisconnectWebhook) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "disconnect_time")
