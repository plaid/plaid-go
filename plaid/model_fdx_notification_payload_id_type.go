...
func (v *FDXNotificationPayloadIdType) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid FDXNotificationPayloadIdType", value)
}
...
func NewFDXNotificationPayloadIdTypeFromValue(v string) (*FDXNotificationPayloadIdType, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for FDXNotificationPayloadIdType: valid values are %v", v, allowedFDXNotificationPayloadIdTypeEnumValues)
	}
}
