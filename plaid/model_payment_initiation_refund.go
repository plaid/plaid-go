...
func NewPaymentInitiationRefund(refundId string, amount PaymentAmount, status PaymentInitiationRefundStatus, lastStatusUpdate time.Time) *PaymentInitiationRefund {
...
func (o *PaymentInitiationRefund) GetStatus() PaymentInitiationRefundStatus {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *PaymentInitiationRefund) GetStatusOk() (*PaymentInitiationRefundStatus, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *PaymentInitiationRefund) SetStatus(v PaymentInitiationRefundStatus) {
	o.Status = v
}
