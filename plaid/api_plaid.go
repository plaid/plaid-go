...
type ApiAssetRelayCreateRequest struct {
	ctx _context.Context
	ApiService *PlaidApiService
	assetRelayCreateRequest *AssetRelayCreateRequest
}

func (r ApiAssetRelayCreateRequest) AssetRelayCreateRequest(assetRelayCreateRequest AssetRelayCreateRequest) ApiAssetRelayCreateRequest {
	r.assetRelayCreateRequest = &assetRelayCreateRequest
	return r
}

func (r ApiAssetRelayCreateRequest) Execute() (AssetRelayCreateResponse, *_nethttp.Response, error) {
	return r.ApiService.AssetRelayCreateExecute(r)
}

/*
 * AssetRelayCreate Create an `asset_relay_token` to share an Asset Report with a partner client
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiAssetRelayCreateRequest
 */
func (a *PlaidApiService) AssetRelayCreate(ctx _context.Context) ApiAssetRelayCreateRequest {
	return ApiAssetRelayCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *PlaidApiService) AssetRelayCreateExecute(r ApiAssetRelayCreateRequest) (AssetRelayCreateResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  AssetRelayCreateResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaidApiService.AssetRelayCreate")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.assetRelayCreateRequest == nil {
		return localVarReturnValue, nil, reportError("assetRelayCreateRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.assetRelayCreateRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["clientId"]; ok {
...
type ApiAssetRelayGetRequest struct {
	ctx _context.Context
	ApiService *PlaidApiService
	assetRelayGetRequest *AssetRelayGetRequest
}

func (r ApiAssetRelayGetRequest) AssetRelayGetRequest(assetRelayGetRequest AssetRelayGetRequest) ApiAssetRelayGetRequest {
	r.assetRelayGetRequest = &assetRelayGetRequest
	return r
}

func (r ApiAssetRelayGetRequest) Execute() (AssetReportGetResponse, *_nethttp.Response, error) {
	return r.ApiService.AssetRelayGetExecute(r)
}

/*
 * AssetRelayGet Retrieve an Asset Report that was shared with you
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiAssetRelayGetRequest
 */
func (a *PlaidApiService) AssetRelayGet(ctx _context.Context) ApiAssetRelayGetRequest {
	return ApiAssetRelayGetRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *PlaidApiService) AssetRelayGetExecute(r ApiAssetRelayGetRequest) (AssetReportGetResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaidApiService.AssetRelayGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.assetRelayGetRequest == nil {
		return localVarReturnValue, nil, reportError("assetRelayGetRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.assetRelayGetRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["clientId"]; ok {
...
type ApiAssetRelayRemoveRequest struct {
	ctx _context.Context
	ApiService *PlaidApiService
	assetRelayRemoveRequest *AssetRelayRemoveRequest
}

func (r ApiAssetRelayRemoveRequest) AssetRelayRemoveRequest(assetRelayRemoveRequest AssetRelayRemoveRequest) ApiAssetRelayRemoveRequest {
	r.assetRelayRemoveRequest = &assetRelayRemoveRequest
	return r
}

func (r ApiAssetRelayRemoveRequest) Execute() (AssetRelayRemoveResponse, *_nethttp.Response, error) {
	return r.ApiService.AssetRelayRemoveExecute(r)
}

/*
 * AssetRelayRemove Remove Asset Report Relay Token
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiAssetRelayRemoveRequest
 */
func (a *PlaidApiService) AssetRelayRemove(ctx _context.Context) ApiAssetRelayRemoveRequest {
	return ApiAssetRelayRemoveRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *PlaidApiService) AssetRelayRemoveExecute(r ApiAssetRelayRemoveRequest) (AssetRelayRemoveResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  AssetRelayRemoveResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PlaidApiService.AssetRelayRemove")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.assetRelayRemoveRequest == nil {
		return localVarReturnValue, nil, reportError("assetRelayRemoveRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.assetRelayRemoveRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["clientId"]; ok {
