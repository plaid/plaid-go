...
func (r ApiIncomeVerificationPaystubGetRequest) Execute() (*_nethttp.Response, error) {
 ...
 * Execute executes the request
 */
func (a *PlaidApiService) IncomeVerificationPaystubGetExecute(r ApiIncomeVerificationPaystubGetRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	if r.incomeVerificationPaystubGetRequest == nil {
		return nil, reportError("incomeVerificationPaystubGetRequest is required and must be specified")
	}
