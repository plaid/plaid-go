...
// OverrideAccounts Data to use to set values of test accounts. Some values cannot be specified in the schema and will instead be calculated from other test data in order to achieve more consistent, realistic test data.
...
func NewOverrideAccounts(type_ OverrideAccountType, subtype NullableAccountSubtype, startingBalance float64, forceAvailableBalance float64, hasNullAvailableBalance bool, currency string, meta Meta, numbers Numbers, transactions []TransactionOverride, identity OwnerOverride, liability LiabilityOverride, inflowModel InflowModel) *OverrideAccounts {
	this := OverrideAccounts{}
	this.Type = type_
	this.Subtype = subtype
	this.StartingBalance = startingBalance
	this.ForceAvailableBalance = forceAvailableBalance
	this.HasNullAvailableBalance = hasNullAvailableBalance
...
func (o *OverrideAccounts) GetStartingBalance() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OverrideAccounts) GetStartingBalanceOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *OverrideAccounts) SetStartingBalance(v float64) {
	o.StartingBalance = v
}

// GetForceAvailableBalance returns the ForceAvailableBalance field value
func (o *OverrideAccounts) GetForceAvailableBalance() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OverrideAccounts) GetForceAvailableBalanceOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *OverrideAccounts) SetForceAvailableBalance(v float64) {
	o.ForceAvailableBalance = v
}

// GetHasNullAvailableBalance returns the HasNullAvailableBalance field value
func (o *OverrideAccounts) GetHasNullAvailableBalance() bool {
	if o == nil {
		var ret bool
		return ret
	}

	return o.HasNullAvailableBalance
}

// GetHasNullAvailableBalanceOk returns a tuple with the HasNullAvailableBalance field value
// and a boolean to check if the value has been set.
func (o *OverrideAccounts) GetHasNullAvailableBalanceOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.HasNullAvailableBalance, true
}

// SetHasNullAvailableBalance sets field value
func (o *OverrideAccounts) SetHasNullAvailableBalance(v bool) {
	o.HasNullAvailableBalance = v
}
...
func (o OverrideAccounts) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["has_null_available_balance"] = o.HasNullAvailableBalance
	}
	if true {
...
func (o *OverrideAccounts) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "has_null_available_balance")
