...
func NewOverrideAccounts(type_ OverrideAccountType, subtype NullableAccountSubtype, startingBalance float64, forceAvailableBalance float64, currency string, meta Meta, numbers Numbers, transactions []TransactionOverride, identity OwnerOverride, liability LiabilityOverride, inflowModel InflowModel) *OverrideAccounts {
