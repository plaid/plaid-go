...
// GetAsyncUpdate returns the AsyncUpdate field value if set, zero value otherwise.
...
// GetAsyncUpdateOk returns a tuple with the AsyncUpdate field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasAsyncUpdate returns a boolean if a field has been set.
...
// SetAsyncUpdate gets a reference to the given bool and assigns it to the AsyncUpdate field.
...
func (o InvestmentsTransactionsGetRequestOptions) MarshalJSON() ([]byte, error) {
	...
	if o.AsyncUpdate != nil {
		toSerialize["async_update"] = o.AsyncUpdate
	}
