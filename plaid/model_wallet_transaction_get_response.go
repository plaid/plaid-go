...
type WalletTransactionGetResponse struct {
	...
	PayeeVerificationStatus NullableWalletTransactionPayeeVerificationStatus `json:"payee_verification_status,omitempty"`
...
// GetPayeeVerificationStatus returns the PayeeVerificationStatus field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WalletTransactionGetResponse) GetPayeeVerificationStatus() WalletTransactionPayeeVerificationStatus {
	if o == nil || o.PayeeVerificationStatus.Get() == nil {
		var ret WalletTransactionPayeeVerificationStatus
		return ret
	}
	return *o.PayeeVerificationStatus.Get()
}

// GetPayeeVerificationStatusOk returns a tuple with the PayeeVerificationStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WalletTransactionGetResponse) GetPayeeVerificationStatusOk() (*WalletTransactionPayeeVerificationStatus, bool) {
	if o == nil  {
		return nil, false
	}
	return o.PayeeVerificationStatus.Get(), o.PayeeVerificationStatus.IsSet()
}

// HasPayeeVerificationStatus returns a boolean if a field has been set.
func (o *WalletTransactionGetResponse) HasPayeeVerificationStatus() bool {
	if o != nil && o.PayeeVerificationStatus.IsSet() {
		return true
	}
...
// SetPayeeVerificationStatus gets a reference to the given NullableWalletTransactionPayeeVerificationStatus and assigns it to the PayeeVerificationStatus field.
func (o *WalletTransactionGetResponse) SetPayeeVerificationStatus(v WalletTransactionPayeeVerificationStatus) {
	o.PayeeVerificationStatus.Set(&v)
}
// SetPayeeVerificationStatusNil sets the value for PayeeVerificationStatus to be an explicit nil
func (o *WalletTransactionGetResponse) SetPayeeVerificationStatusNil() {
	o.PayeeVerificationStatus.Set(nil)
}

// UnsetPayeeVerificationStatus ensures that no value is present for PayeeVerificationStatus, not even an explicit nil
func (o *WalletTransactionGetResponse) UnsetPayeeVerificationStatus() {
	o.PayeeVerificationStatus.Unset()
}
...
func (o *WalletTransactionGetResponse) GetError() PlaidError {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WalletTransactionGetResponse) GetErrorOk() (*PlaidError, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *WalletTransactionGetResponse) HasError() bool {
...
func (o *WalletTransactionGetResponse) SetError(v PlaidError) {
	o.Error.Set(&v)
}
// SetErrorNil sets the value for Error to be an explicit nil
func (o *WalletTransactionGetResponse) SetErrorNil() {
	o.Error.Set(nil)
}

// UnsetError ensures that no value is present for Error, not even an explicit nil
func (o *WalletTransactionGetResponse) UnsetError() {
	o.Error.Unset()
}
...
func (o WalletTransactionGetResponse) MarshalJSON() ([]byte, error) {
	...
	if o.PayeeVerificationStatus.IsSet() {
		toSerialize["payee_verification_status"] = o.PayeeVerificationStatus.Get()
	}
...
func (o *WalletTransactionGetResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "payee_verification_status")
