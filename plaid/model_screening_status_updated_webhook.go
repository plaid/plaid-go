...
func NewScreeningStatusUpdatedWebhook(webhookType string, webhookCode string, screeningId interface{}, environment WebhookEnvironmentValues) *ScreeningStatusUpdatedWebhook {
