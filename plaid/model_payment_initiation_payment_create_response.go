...
type PaymentInitiationPaymentCreateResponse struct {
	...
	Status PaymentInitiationPaymentCreateStatus `json:"status"`
...
func NewPaymentInitiationPaymentCreateResponse(paymentId string, status PaymentInitiationPaymentCreateStatus, requestId string) *PaymentInitiationPaymentCreateResponse {
...
func (o *PaymentInitiationPaymentCreateResponse) GetStatus() PaymentInitiationPaymentCreateStatus {
	if o == nil {
		var ret PaymentInitiationPaymentCreateStatus
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PaymentInitiationPaymentCreateResponse) GetStatusOk() (*PaymentInitiationPaymentCreateStatus, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *PaymentInitiationPaymentCreateResponse) SetStatus(v PaymentInitiationPaymentCreateStatus) {
	o.Status = v
}
