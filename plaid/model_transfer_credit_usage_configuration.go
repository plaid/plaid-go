...
func NewTransferCreditUsageConfiguration(expectedFrequency OriginatorExpectedTransferFrequency, expectedHighestAmount string, expectedAverageAmount string, expectedMonthlyAmount string, secCodes []ACHClass) *TransferCreditUsageConfiguration {
...
func (o *TransferCreditUsageConfiguration) GetSecCodes() []ACHClass {
	if o == nil {
		var ret []ACHClass
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TransferCreditUsageConfiguration) GetSecCodesOk() (*[]ACHClass, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferCreditUsageConfiguration) SetSecCodes(v []ACHClass) {
	o.SecCodes = v
}
