...
func NewTransferEventSyncResponse(transferEvents []TransferEvent, hasMore bool, requestId string) *TransferEventSyncResponse {
...
func (o *TransferEventSyncResponse) GetHasMore() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TransferEventSyncResponse) GetHasMoreOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferEventSyncResponse) SetHasMore(v bool) {
	o.HasMore = v
}
