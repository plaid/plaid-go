...
func (o *TransactionAllOf) GetMerchantCategoryCode() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransactionAllOf) GetMerchantCategoryCodeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransactionAllOf) HasMerchantCategoryCode() bool {
...
func (o *TransactionAllOf) UnsetMerchantCategoryCode() {
...
func (o *TransactionAllOf) GetRunningBalance() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransactionAllOf) GetRunningBalanceOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransactionAllOf) HasRunningBalance() bool {
...
func (o *TransactionAllOf) GetClientCustomization() ClientCustomization {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransactionAllOf) GetClientCustomizationOk() (*ClientCustomization, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransactionAllOf) HasClientCustomization() bool {
...
func (o *TransactionAllOf) SetClientCustomization(v ClientCustomization) {
	o.ClientCustomization.Set(&v)
}
// SetClientCustomizationNil sets the value for ClientCustomization to be an explicit nil
func (o *TransactionAllOf) SetClientCustomizationNil() {
...
func (o *TransactionAllOf) UnsetClientCustomization() {
