...
type ItemGetResponse struct {
	Item ItemWithConsentFields `json:"item"`
...
func NewItemGetResponse(item ItemWithConsentFields, requestId string) *ItemGetResponse {
...
func (o *ItemGetResponse) GetItem() ItemWithConsentFields {
	if o == nil {
		var ret ItemWithConsentFields
		return ret
	}
...
func (o *ItemGetResponse) GetItemOk() (*ItemWithConsentFields, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Item, true
...
func (o *ItemGetResponse) SetItem(v ItemWithConsentFields) {
	o.Item = v
}
