...
func (o *PersonalFinanceCategory) GetVersion() string {
...
// and a boolean to check if the value has been set.
func (o *PersonalFinanceCategory) GetVersionOk() (*string, bool) {
	if o == nil || o.Version == nil {
		return nil, false
	}
...
func (o *PersonalFinanceCategory) SetVersion(v string) {
	o.Version = &v
}
