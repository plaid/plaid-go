...
type PersonalFinanceCategory struct {
	...
	Version *PersonalFinanceCategoryVersion `json:"version,omitempty"`
...
func (o *PersonalFinanceCategory) GetVersion() PersonalFinanceCategoryVersion {
...
// and a boolean to check if the value has been set.
func (o *PersonalFinanceCategory) GetVersionOk() (*PersonalFinanceCategoryVersion, bool) {
	if o == nil || o.Version == nil {
		return nil, false
	}
...
func (o *PersonalFinanceCategory) HasVersion() bool {
	if o != nil && o.Version != nil {
		return true
	}
...
// SetVersion gets a reference to the given PersonalFinanceCategoryVersion and assigns it to the Version field.
func (o *PersonalFinanceCategory) SetVersion(v PersonalFinanceCategoryVersion) {
	o.Version = &v
}
