...
func (v *FDXNotificationType) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid FDXNotificationType", value)
}
...
func NewFDXNotificationTypeFromValue(v string) (*FDXNotificationType, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for FDXNotificationType: valid values are %v", v, allowedFDXNotificationTypeEnumValues)
	}
}
