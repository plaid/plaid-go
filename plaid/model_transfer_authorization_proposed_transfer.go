...
func NewTransferAuthorizationProposedTransfer(accountId string, type_ TransferType, user TransferUserInResponse, amount string, network string, originationAccountId string, isoCurrencyCode string) *TransferAuthorizationProposedTransfer {
