...
func NewTransferAuthorizationProposedTransfer(fundingAccountId string, type_ TransferType, user TransferUserInResponse, amount string, network string, originationAccountId string, isoCurrencyCode string, originatorClientId NullableString) *TransferAuthorizationProposedTransfer {
