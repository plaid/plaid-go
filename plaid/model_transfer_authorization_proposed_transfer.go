...
func NewTransferAuthorizationProposedTransfer(fundingAccountId NullableString, type_ TransferType, user TransferUserInResponse, amount string, requestedAmount string, network string, originationAccountId string, isoCurrencyCode string, originatorClientId NullableString, creditFundsSource TransferCreditFundsSource) *TransferAuthorizationProposedTransfer {
...
func (o *TransferAuthorizationProposedTransfer) GetLedgerId() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferAuthorizationProposedTransfer) GetLedgerIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferAuthorizationProposedTransfer) HasLedgerId() bool {
...
func (o *TransferAuthorizationProposedTransfer) SetLedgerId(v string) {
	o.LedgerId.Set(&v)
}
// SetLedgerIdNil sets the value for LedgerId to be an explicit nil
func (o *TransferAuthorizationProposedTransfer) SetLedgerIdNil() {
	o.LedgerId.Set(nil)
}

// UnsetLedgerId ensures that no value is present for LedgerId, not even an explicit nil
func (o *TransferAuthorizationProposedTransfer) UnsetLedgerId() {
	o.LedgerId.Unset()
}
...
func (o *TransferAuthorizationProposedTransfer) GetRequestedAmount() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TransferAuthorizationProposedTransfer) GetRequestedAmountOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferAuthorizationProposedTransfer) SetRequestedAmount(v string) {
	o.RequestedAmount = v
}
...
func (o *TransferAuthorizationProposedTransfer) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "requested_amount")
