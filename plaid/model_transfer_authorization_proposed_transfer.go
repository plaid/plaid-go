...
func NewTransferAuthorizationProposedTransfer(fundingAccountId NullableString, type_ TransferType, user TransferUserInResponse, amount string, network string, originationAccountId string, isoCurrencyCode string, originatorClientId NullableString, creditFundsSource NullableTransferCreditFundsSource) *TransferAuthorizationProposedTransfer {
