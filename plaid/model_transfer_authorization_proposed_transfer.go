...
func NewTransferAuthorizationProposedTransfer(achClass ACHClass, accountId string, type_ TransferType, user TransferUserInResponse, amount string, isoCurrencyCode string, description string, network string, originationAccountId string) *TransferAuthorizationProposedTransfer {
