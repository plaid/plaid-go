...
func (v *FDXNotificationSeverity) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid FDXNotificationSeverity", value)
}
...
func NewFDXNotificationSeverityFromValue(v string) (*FDXNotificationSeverity, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for FDXNotificationSeverity: valid values are %v", v, allowedFDXNotificationSeverityEnumValues)
	}
}
