...
type TransactionsEnrichGetRequest struct {
	...
	// Include legacy categories in Enrich responses
	IncludeLegacyCategories *bool `json:"include_legacy_categories,omitempty"`
}
...
func NewTransactionsEnrichGetRequest(accountType string, transactions []ClientProvidedTransaction) *TransactionsEnrichGetRequest {
	...
	var includeLegacyCategories bool = false
	this.IncludeLegacyCategories = &includeLegacyCategories
	return &this
}
...
// GetIncludeLegacyCategories returns the IncludeLegacyCategories field value if set, zero value otherwise.
func (o *TransactionsEnrichGetRequest) GetIncludeLegacyCategories() bool {
	if o == nil || o.IncludeLegacyCategories == nil {
		var ret bool
		return ret
	}
	return *o.IncludeLegacyCategories
}

// GetIncludeLegacyCategoriesOk returns a tuple with the IncludeLegacyCategories field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TransactionsEnrichGetRequest) GetIncludeLegacyCategoriesOk() (*bool, bool) {
	if o == nil || o.IncludeLegacyCategories == nil {
		return nil, false
	}
	return o.IncludeLegacyCategories, true
}

// HasIncludeLegacyCategories returns a boolean if a field has been set.
func (o *TransactionsEnrichGetRequest) HasIncludeLegacyCategories() bool {
	if o != nil && o.IncludeLegacyCategories != nil {
		return true
	}
...
// SetIncludeLegacyCategories gets a reference to the given bool and assigns it to the IncludeLegacyCategories field.
func (o *TransactionsEnrichGetRequest) SetIncludeLegacyCategories(v bool) {
	o.IncludeLegacyCategories = &v
}
...
func (o TransactionsEnrichGetRequest) MarshalJSON() ([]byte, error) {
	...
	if o.IncludeLegacyCategories != nil {
		toSerialize["include_legacy_categories"] = o.IncludeLegacyCategories
	}
