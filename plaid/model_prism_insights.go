...
func (o *PrismInsights) GetModelVersion() string {
...
// and a boolean to check if the value has been set.
func (o *PrismInsights) GetModelVersionOk() (*string, bool) {
	if o == nil || o.ModelVersion == nil {
		return nil, false
	}
...
func (o *PrismInsights) HasModelVersion() bool {
	if o != nil && o.ModelVersion != nil {
		return true
	}
...
func (o *PrismInsights) SetModelVersion(v string) {
	o.ModelVersion = &v
}
