...
func NewIdentityDefaultUpdateWebhook(webhookType string, webhookCode string, itemId string, accountIdsWithUpdatedIdentity map[string][]IdentityUpdateTypes, error_ NullablePlaidError, environment WebhookEnvironmentValues) *IdentityDefaultUpdateWebhook {
...
func (o *IdentityDefaultUpdateWebhook) GetEnvironment() WebhookEnvironmentValues {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *IdentityDefaultUpdateWebhook) GetEnvironmentOk() (*WebhookEnvironmentValues, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *IdentityDefaultUpdateWebhook) SetEnvironment(v WebhookEnvironmentValues) {
	o.Environment = v
}
