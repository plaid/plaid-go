...
func NewIdentityDefaultUpdateWebhook(webhookType string, webhookCode string, itemId string, accountIdsWithUpdatedIdentity map[string][]IdentityUpdateTypes, error_ NullablePlaidError) *IdentityDefaultUpdateWebhook {
