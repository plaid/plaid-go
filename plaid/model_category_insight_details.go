...
type CategoryInsightDetails struct {
	...
	TopCounterparties *[]string `json:"top_counterparties,omitempty"`
...
func NewCategoryInsightDetails(name string, transactionCount int32, totalOutflows float64, totalInflows float64) *CategoryInsightDetails {
...
// GetTopCounterparties returns the TopCounterparties field value if set, zero value otherwise.
func (o *CategoryInsightDetails) GetTopCounterparties() []string {
	if o == nil || o.TopCounterparties == nil {
		var ret []string
		return ret
	}
...
// GetTopCounterpartiesOk returns a tuple with the TopCounterparties field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CategoryInsightDetails) GetTopCounterpartiesOk() (*[]string, bool) {
	if o == nil || o.TopCounterparties == nil {
		return nil, false
	}
...
// HasTopCounterparties returns a boolean if a field has been set.
func (o *CategoryInsightDetails) HasTopCounterparties() bool {
	if o != nil && o.TopCounterparties != nil {
		return true
	}
...
// SetTopCounterparties gets a reference to the given []string and assigns it to the TopCounterparties field.
func (o *CategoryInsightDetails) SetTopCounterparties(v []string) {
