...
func NewProjectedIncomeSummaryFieldNumber(value float64, verificationStatus VerificationStatus) *ProjectedIncomeSummaryFieldNumber {
...
func (o *ProjectedIncomeSummaryFieldNumber) GetValue() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
func (o *ProjectedIncomeSummaryFieldNumber) GetValueOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Value, true
...
func (o *ProjectedIncomeSummaryFieldNumber) SetValue(v float64) {
	o.Value = v
}
