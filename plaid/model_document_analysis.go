...
type DocumentAnalysis struct {
	...
	FraudAnalysisDetails NullableFraudAnalysisDetails `json:"fraud_analysis_details"`
	ImageQualityDetails NullableImageQualityDetails `json:"image_quality_details"`
	HumanReview NullableHumanReview `json:"human_review,omitempty"`
	AamvaVerification NullableAAMVAAnalysis `json:"aamva_verification"`
...
func NewDocumentAnalysis(authenticity DocumentAuthenticityMatchCode, imageQuality ImageQuality, extractedData NullablePhysicalDocumentExtractedDataAnalysis, fraudAnalysisDetails NullableFraudAnalysisDetails, imageQualityDetails NullableImageQualityDetails, aamvaVerification NullableAAMVAAnalysis) *DocumentAnalysis {
	this := DocumentAnalysis{}
	this.Authenticity = authenticity
	this.ImageQuality = imageQuality
	this.ExtractedData = extractedData
	this.FraudAnalysisDetails = fraudAnalysisDetails
	this.ImageQualityDetails = imageQualityDetails
	this.AamvaVerification = aamvaVerification
	return &this
}
...
// GetFraudAnalysisDetails returns the FraudAnalysisDetails field value
// If the value is explicit nil, the zero value for FraudAnalysisDetails will be returned
...
// GetFraudAnalysisDetailsOk returns a tuple with the FraudAnalysisDetails field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetFraudAnalysisDetails sets field value
func (o *DocumentAnalysis) SetFraudAnalysisDetails(v FraudAnalysisDetails) {
	o.FraudAnalysisDetails.Set(&v)
}

// GetImageQualityDetails returns the ImageQualityDetails field value
// If the value is explicit nil, the zero value for ImageQualityDetails will be returned
...
// GetImageQualityDetailsOk returns a tuple with the ImageQualityDetails field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetImageQualityDetails sets field value
...
// GetAamvaVerification returns the AamvaVerification field value
// If the value is explicit nil, the zero value for AAMVAAnalysis will be returned
func (o *DocumentAnalysis) GetAamvaVerification() AAMVAAnalysis {
	if o == nil || o.AamvaVerification.Get() == nil {
		var ret AAMVAAnalysis
		return ret
	}

	return *o.AamvaVerification.Get()
}

// GetAamvaVerificationOk returns a tuple with the AamvaVerification field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DocumentAnalysis) GetAamvaVerificationOk() (*AAMVAAnalysis, bool) {
	if o == nil  {
		return nil, false
	}
	return o.AamvaVerification.Get(), o.AamvaVerification.IsSet()
}

// SetAamvaVerification sets field value
func (o *DocumentAnalysis) SetAamvaVerification(v AAMVAAnalysis) {
	o.AamvaVerification.Set(&v)
}
...
func (o DocumentAnalysis) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["aamva_verification"] = o.AamvaVerification.Get()
	}
...
func (o *DocumentAnalysis) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "aamva_verification")
