...
func (v *UserStatedIncomeSourcePayType) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid UserStatedIncomeSourcePayType", value)
}
...
func NewUserStatedIncomeSourcePayTypeFromValue(v string) (*UserStatedIncomeSourcePayType, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for UserStatedIncomeSourcePayType: valid values are %v", v, allowedUserStatedIncomeSourcePayTypeEnumValues)
	}
}
