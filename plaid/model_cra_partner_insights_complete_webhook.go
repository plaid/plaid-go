...
// CraPartnerInsightsCompleteWebhook Fired when a partner insights report has finished generating or failed to generate.
type CraPartnerInsightsCompleteWebhook struct {
	...
	Result CraPartnerInsightsCompleteResult `json:"result"`
...
func NewCraPartnerInsightsCompleteWebhook(webhookType string, webhookCode string, userId string, result CraPartnerInsightsCompleteResult, environment WebhookEnvironmentValues) *CraPartnerInsightsCompleteWebhook {
...
func (o *CraPartnerInsightsCompleteWebhook) GetResult() CraPartnerInsightsCompleteResult {
	if o == nil {
		var ret CraPartnerInsightsCompleteResult
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CraPartnerInsightsCompleteWebhook) GetResultOk() (*CraPartnerInsightsCompleteResult, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CraPartnerInsightsCompleteWebhook) SetResult(v CraPartnerInsightsCompleteResult) {
	o.Result = v
}
