...
func (o *PayPeriodDetails) GetPayFrequency() PayPeriodDetailsPayFrequency {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PayPeriodDetails) GetPayFrequencyOk() (*PayPeriodDetailsPayFrequency, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *PayPeriodDetails) SetPayFrequency(v PayPeriodDetailsPayFrequency) {
