...
type CreditPayrollIncomeGetResponse struct {
	// The unique identifier associated with the payroll income response.
	PayrollIncomeId *string `json:"payroll_income_id,omitempty"`
...
// GetPayrollIncomeId returns the PayrollIncomeId field value if set, zero value otherwise.
func (o *CreditPayrollIncomeGetResponse) GetPayrollIncomeId() string {
	if o == nil || o.PayrollIncomeId == nil {
		var ret string
		return ret
	}
	return *o.PayrollIncomeId
}

// GetPayrollIncomeIdOk returns a tuple with the PayrollIncomeId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreditPayrollIncomeGetResponse) GetPayrollIncomeIdOk() (*string, bool) {
	if o == nil || o.PayrollIncomeId == nil {
		return nil, false
	}
	return o.PayrollIncomeId, true
}

// HasPayrollIncomeId returns a boolean if a field has been set.
func (o *CreditPayrollIncomeGetResponse) HasPayrollIncomeId() bool {
	if o != nil && o.PayrollIncomeId != nil {
		return true
	}
...
// SetPayrollIncomeId gets a reference to the given string and assigns it to the PayrollIncomeId field.
func (o *CreditPayrollIncomeGetResponse) SetPayrollIncomeId(v string) {
	o.PayrollIncomeId = &v
}
...
func (o CreditPayrollIncomeGetResponse) MarshalJSON() ([]byte, error) {
	...
	if o.PayrollIncomeId != nil {
		toSerialize["payroll_income_id"] = o.PayrollIncomeId
	}
	if true {
...
func (o *CreditPayrollIncomeGetResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		delete(additionalProperties, "payroll_income_id")
