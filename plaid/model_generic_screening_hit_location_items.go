...
type _GenericScreeningHitLocationItems GenericScreeningHitLocationItems
...
func (o *GenericScreeningHitLocationItems) UnmarshalJSON(bytes []byte) (err error) {
	varGenericScreeningHitLocationItems := _GenericScreeningHitLocationItems{}

	if err = json.Unmarshal(bytes, &varGenericScreeningHitLocationItems); err == nil {
		*o = GenericScreeningHitLocationItems(varGenericScreeningHitLocationItems)
	} else {
		return err
	}
