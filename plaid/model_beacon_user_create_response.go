...
func NewBeaconUserCreateResponse(itemIds []string, id string, version int32, createdAt time.Time, updatedAt time.Time, status BeaconUserStatus, programId string, clientUserId string, user BeaconUserData, auditTrail BeaconAuditTrail, requestId string) *BeaconUserCreateResponse {
...
func (o *BeaconUserCreateResponse) GetItemIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *BeaconUserCreateResponse) GetItemIdsOk() (*[]string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *BeaconUserCreateResponse) SetItemIds(v []string) {
	o.ItemIds = v
}
