...
type Meta struct {
	...
	// The annual percentage yield (APY) to report on the account, expressed as a percentage (e.g. `4.25` means 4.25%). Applies to interest-bearing depository accounts; if omitted, the account reports no APY.
...
// and a boolean to check if the value has been set.
func (o *Meta) GetApyOk() (*float64, bool) {
	if o == nil || o.Apy == nil {
		return nil, false
	}
	return o.Apy, true
...
// SetApy gets a reference to the given float64 and assigns it to the Apy field.
func (o *Meta) SetApy(v float64) {
	o.Apy = &v
}
