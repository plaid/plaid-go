...
func NewAddressDataNullable(city NullableString, region NullableString, street string, postalCode NullableString, country NullableString) *AddressDataNullable {
