...
type _TransferAuthorizationUserInRequest TransferAuthorizationUserInRequest
...
func (o *TransferAuthorizationUserInRequest) UnmarshalJSON(bytes []byte) (err error) {
	varTransferAuthorizationUserInRequest := _TransferAuthorizationUserInRequest{}

	if err = json.Unmarshal(bytes, &varTransferAuthorizationUserInRequest); err == nil {
		*o = TransferAuthorizationUserInRequest(varTransferAuthorizationUserInRequest)
	}
