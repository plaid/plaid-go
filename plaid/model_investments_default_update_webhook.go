...
func NewInvestmentsDefaultUpdateWebhook(webhookType string, webhookCode string, itemId string, newInvestmentsTransactions float32, canceledInvestmentsTransactions float32, environment WebhookEnvironmentValues) *InvestmentsDefaultUpdateWebhook {
