...
func NewBaseReportItem(institutionName string, institutionId string, dateLastUpdated time.Time, itemId string, accounts []BaseReportAccount) *BaseReportItem {
	this := BaseReportItem{}
...
func (o *BaseReportItem) GetItemId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BaseReportItem) GetItemIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *BaseReportItem) SetItemId(v string) {
	o.ItemId = v
}
