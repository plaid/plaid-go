...
type RiskCheckBehavior struct {
	...
	RiskLevel *RiskLevelWithNoData `json:"risk_level,omitempty"`
...
func (o *RiskCheckBehavior) GetRiskLevel() RiskLevelWithNoData {
	if o == nil || o.RiskLevel == nil {
		var ret RiskLevelWithNoData
		return ret
	}
	return *o.RiskLevel
}
...
// and a boolean to check if the value has been set.
func (o *RiskCheckBehavior) GetRiskLevelOk() (*RiskLevelWithNoData, bool) {
	if o == nil || o.RiskLevel == nil {
		return nil, false
	}
...
func (o *RiskCheckBehavior) HasRiskLevel() bool {
	if o != nil && o.RiskLevel != nil {
		return true
	}
...
// SetRiskLevel gets a reference to the given RiskLevelWithNoData and assigns it to the RiskLevel field.
func (o *RiskCheckBehavior) SetRiskLevel(v RiskLevelWithNoData) {
	o.RiskLevel = &v
}
