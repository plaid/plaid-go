...
type ConnectedApplication struct {
	...
	// The date and time this application was linked, in [ISO 8601](https://wikipedia.org/wiki/ISO_8601) format in UTC (e.g. `\"2020-01-01T00:00:00Z\"`). Note that older, legacy integrations instead receive this value as a date only, in `YYYY-MM-DD` format (e.g. `\"2020-01-01\"`).
...
func NewConnectedApplication(applicationId string, name string, createdAt time.Time) *ConnectedApplication {
...
func (o *ConnectedApplication) GetCreatedAt() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ConnectedApplication) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *ConnectedApplication) SetCreatedAt(v time.Time) {
	o.CreatedAt = v
}
