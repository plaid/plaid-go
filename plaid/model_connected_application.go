...
type ConnectedApplication struct {
	...
	Status ConnectedApplicationStatus `json:"status"`
}
...
func NewConnectedApplication(applicationId string, name string, logo NullableString, logoUrl NullableString, applicationUrl NullableString, reasonForAccess NullableString, createdAt string, joinDate string, productDataTypes []string, status ConnectedApplicationStatus) *ConnectedApplication {
...
func (o *ConnectedApplication) GetStatus() ConnectedApplicationStatus {
	if o == nil {
		var ret ConnectedApplicationStatus
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ConnectedApplication) GetStatusOk() (*ConnectedApplicationStatus, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *ConnectedApplication) SetStatus(v ConnectedApplicationStatus) {
	o.Status = v
}
