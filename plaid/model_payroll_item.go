...
func NewPayrollItem(itemId string, accounts []PayrollIncomeAccountData, payrollIncome []PayrollIncomeObject, status NullablePayrollItemStatus, updatedAt NullableTime) *PayrollItem {
	this := PayrollItem{}
	this.ItemId = itemId
