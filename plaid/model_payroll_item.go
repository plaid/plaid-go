...
func NewPayrollItem(itemId string, accounts []PayrollIncomeAccountData, payrollIncome []PayrollIncomeObject, status NullablePayrollItemStatus, pullId string) *PayrollItem {
	this := PayrollItem{}
	this.ItemId = itemId
...
// GetPullId returns the PullId field value
func (o *PayrollItem) GetPullId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// GetPullIdOk returns a tuple with the PullId field value
// and a boolean to check if the value has been set.
func (o *PayrollItem) GetPullIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.PullId, true
}

// SetPullId sets field value
func (o *PayrollItem) SetPullId(v string) {
	o.PullId = v
}
