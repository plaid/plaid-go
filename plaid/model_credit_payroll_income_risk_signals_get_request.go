...
func (o *CreditPayrollIncomeRiskSignalsGetRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *CreditPayrollIncomeRiskSignalsGetRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *CreditPayrollIncomeRiskSignalsGetRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *CreditPayrollIncomeRiskSignalsGetRequest) SetUserId(v string) {
	o.UserId = &v
}
