...
func (o *HoldingsDefaultUpdateWebhook) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *HoldingsDefaultUpdateWebhook) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *HoldingsDefaultUpdateWebhook) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *HoldingsDefaultUpdateWebhook) SetUserId(v string) {
	o.UserId = &v
}
