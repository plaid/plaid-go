...
type _BaseReportAccountBalances BaseReportAccountBalances
...
func (o *BaseReportAccountBalances) UnmarshalJSON(bytes []byte) (err error) {
	varBaseReportAccountBalances := _BaseReportAccountBalances{}

	if err = json.Unmarshal(bytes, &varBaseReportAccountBalances); err == nil {
		*o = BaseReportAccountBalances(varBaseReportAccountBalances)
	} else {
		return err
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "average_monthly_balances")
		delete(additionalProperties, "most_recent_thirty_day_average_balance")
