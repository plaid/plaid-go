...
type PaymentConsentPeriodicAmount struct {
	...
	Alignment *PaymentConsentPeriodicAlignment `json:"alignment,omitempty"`
...
func NewPaymentConsentPeriodicAmount(amount PaymentConsentPeriodicAmountAmount, interval PaymentConsentPeriodicInterval) *PaymentConsentPeriodicAmount {
...
func (o *PaymentConsentPeriodicAmount) HasAlignment() bool {
	if o != nil && o.Alignment != nil {
		return true
	}
...
// SetAlignment gets a reference to the given PaymentConsentPeriodicAlignment and assigns it to the Alignment field.
