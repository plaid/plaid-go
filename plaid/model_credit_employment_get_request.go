...
func NewCreditEmploymentGetRequest() *CreditEmploymentGetRequest {
...
func (o *CreditEmploymentGetRequest) HasUserToken() bool {
	if o != nil && o.UserToken != nil {
		return true
	}
...
func (o *CreditEmploymentGetRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *CreditEmploymentGetRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *CreditEmploymentGetRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *CreditEmploymentGetRequest) SetUserId(v string) {
	o.UserId = &v
}
