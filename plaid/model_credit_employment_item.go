...
func NewCreditEmploymentItem(itemId string, employments []CreditEmploymentVerification, pullId string) *CreditEmploymentItem {
...
func (o *CreditEmploymentItem) GetPullId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreditEmploymentItem) GetPullIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CreditEmploymentItem) SetPullId(v string) {
	o.PullId = v
}
...
func (o *CreditEmploymentItem) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "pull_id")
