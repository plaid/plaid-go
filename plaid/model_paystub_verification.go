...
// PaystubVerification An object containing information for whether or not the uploaded paystub is fradulent
type PaystubVerification struct {
	// Derived verification status.
	VerificationStatus NullableString `json:"verification_status"`
	VerificationAttributes *[]VerificationAttribute `json:"verification_attributes,omitempty"`
...
func NewPaystubVerification(verificationStatus NullableString) *PaystubVerification {
...
// GetVerificationAttributes returns the VerificationAttributes field value if set, zero value otherwise.
func (o *PaystubVerification) GetVerificationAttributes() []VerificationAttribute {
	if o == nil || o.VerificationAttributes == nil {
...
// GetVerificationAttributesOk returns a tuple with the VerificationAttributes field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasVerificationAttributes returns a boolean if a field has been set.
func (o *PaystubVerification) HasVerificationAttributes() bool {
	if o != nil && o.VerificationAttributes != nil {
		return true
	}
...
// SetVerificationAttributes gets a reference to the given []VerificationAttribute and assigns it to the VerificationAttributes field.
...
func (o PaystubVerification) MarshalJSON() ([]byte, error) {
	...
	if o.VerificationAttributes != nil {
