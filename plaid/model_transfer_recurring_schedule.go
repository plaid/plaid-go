...
type TransferRecurringSchedule struct {
	IntervalUnit *TransferScheduleIntervalUnit `json:"interval_unit,omitempty"`
...
func NewTransferRecurringSchedule() *TransferRecurringSchedule {
...
func (o *TransferRecurringSchedule) HasIntervalUnit() bool {
	if o != nil && o.IntervalUnit != nil {
		return true
	}
...
// SetIntervalUnit gets a reference to the given TransferScheduleIntervalUnit and assigns it to the IntervalUnit field.
...
func (o *TransferRecurringSchedule) HasIntervalCount() bool {
	if o != nil && o.IntervalCount != nil {
		return true
	}
...
func (o *TransferRecurringSchedule) HasIntervalExecutionDay() bool {
	if o != nil && o.IntervalExecutionDay != nil {
		return true
	}
...
func (o *TransferRecurringSchedule) HasStartDate() bool {
	if o != nil && o.StartDate != nil {
		return true
	}
