...
func NewYTDNetIncomeSummaryFieldNumber(value float64, verificationStatus VerificationStatus) *YTDNetIncomeSummaryFieldNumber {
...
func (o *YTDNetIncomeSummaryFieldNumber) GetValue() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
func (o *YTDNetIncomeSummaryFieldNumber) GetValueOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Value, true
...
func (o *YTDNetIncomeSummaryFieldNumber) SetValue(v float64) {
	o.Value = v
}
