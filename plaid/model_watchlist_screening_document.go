...
type _WatchlistScreeningDocument WatchlistScreeningDocument
...
func (o *WatchlistScreeningDocument) UnmarshalJSON(bytes []byte) (err error) {
	varWatchlistScreeningDocument := _WatchlistScreeningDocument{}

	if err = json.Unmarshal(bytes, &varWatchlistScreeningDocument); err == nil {
		*o = WatchlistScreeningDocument(varWatchlistScreeningDocument)
	} else {
		return err
	}
