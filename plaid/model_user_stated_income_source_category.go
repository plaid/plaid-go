...
func (v *UserStatedIncomeSourceCategory) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid UserStatedIncomeSourceCategory", value)
}
...
func NewUserStatedIncomeSourceCategoryFromValue(v string) (*UserStatedIncomeSourceCategory, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for UserStatedIncomeSourceCategory: valid values are %v", v, allowedUserStatedIncomeSourceCategoryEnumValues)
	}
}
