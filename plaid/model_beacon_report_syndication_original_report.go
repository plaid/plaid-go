...
func NewBeaconReportSyndicationOriginalReport(id NullableString, createdAt time.Time, type_ BeaconReportType, fraudDate string) *BeaconReportSyndicationOriginalReport {
