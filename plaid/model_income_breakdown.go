...
func NewIncomeBreakdown(type_ NullableIncomeBreakdownType, rate NullableFloat64, hours NullableFloat32, total NullableFloat64) *IncomeBreakdown {
...
// If the value is explicit nil, the zero value for IncomeBreakdownType will be returned
func (o *IncomeBreakdown) GetType() IncomeBreakdownType {
	if o == nil || o.Type.Get() == nil {
		var ret IncomeBreakdownType
		return ret
	}
...
func (o *IncomeBreakdown) GetRate() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IncomeBreakdown) GetRateOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *IncomeBreakdown) SetRate(v float64) {
	o.Rate.Set(&v)
}
...
// If the value is explicit nil, the zero value for float64 will be returned
func (o *IncomeBreakdown) GetTotal() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IncomeBreakdown) GetTotalOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *IncomeBreakdown) SetTotal(v float64) {
	o.Total.Set(&v)
}
