...
func NewInvestmentsHoldingsGetResponse(accounts []InvestmentAccount, holdings []Holding, securities []Security, item Item, requestId string) *InvestmentsHoldingsGetResponse {
...
func (o *InvestmentsHoldingsGetResponse) GetAccounts() []InvestmentAccount {
	if o == nil {
...
func (o *InvestmentsHoldingsGetResponse) GetAccountsOk() (*[]InvestmentAccount, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *InvestmentsHoldingsGetResponse) SetAccounts(v []InvestmentAccount) {
	o.Accounts = v
}
...
func (o *InvestmentsHoldingsGetResponse) GetIsInvestmentsFallbackItem() bool {
...
// and a boolean to check if the value has been set.
func (o *InvestmentsHoldingsGetResponse) GetIsInvestmentsFallbackItemOk() (*bool, bool) {
	if o == nil || o.IsInvestmentsFallbackItem == nil {
		return nil, false
	}
...
func (o *InvestmentsHoldingsGetResponse) HasIsInvestmentsFallbackItem() bool {
	if o != nil && o.IsInvestmentsFallbackItem != nil {
		return true
	}
...
func (o *InvestmentsHoldingsGetResponse) SetIsInvestmentsFallbackItem(v bool) {
