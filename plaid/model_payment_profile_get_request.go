...
func NewPaymentProfileGetRequest(paymentProfileId string) *PaymentProfileGetRequest {
...
func (o *PaymentProfileGetRequest) GetPaymentProfileId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PaymentProfileGetRequest) GetPaymentProfileIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *PaymentProfileGetRequest) SetPaymentProfileId(v string) {
