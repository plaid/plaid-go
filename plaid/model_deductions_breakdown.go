...
func (o *DeductionsBreakdown) GetCurrentAmount() float64 {
...
func (o *DeductionsBreakdown) GetCurrentAmountOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *DeductionsBreakdown) SetCurrentAmount(v float64) {
...
func (o *DeductionsBreakdown) GetYtdAmount() float64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DeductionsBreakdown) GetYtdAmountOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *DeductionsBreakdown) SetYtdAmount(v float64) {
	o.YtdAmount.Set(&v)
}
