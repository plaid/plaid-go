...
type _ScreeningHitDateOfBirthItem ScreeningHitDateOfBirthItem
...
func (o *ScreeningHitDateOfBirthItem) UnmarshalJSON(bytes []byte) (err error) {
	varScreeningHitDateOfBirthItem := _ScreeningHitDateOfBirthItem{}

	if err = json.Unmarshal(bytes, &varScreeningHitDateOfBirthItem); err == nil {
		*o = ScreeningHitDateOfBirthItem(varScreeningHitDateOfBirthItem)
	} else {
		return err
	}
