...
// APIClient manages communication with the The Plaid API API v2020-09-14_1.680.0
...
// optionally a custom http.Client to allow for advanced predictionFeatures such as caching.
