...
func (o *SandboxPublicTokenCreateRequestOptionsTransactions) GetDaysRequested() int32 {
...
// and a boolean to check if the value has been set.
func (o *SandboxPublicTokenCreateRequestOptionsTransactions) GetDaysRequestedOk() (*int32, bool) {
	if o == nil || o.DaysRequested == nil {
		return nil, false
	}
...
func (o *SandboxPublicTokenCreateRequestOptionsTransactions) HasDaysRequested() bool {
	if o != nil && o.DaysRequested != nil {
		return true
	}
...
func (o *SandboxPublicTokenCreateRequestOptionsTransactions) SetDaysRequested(v int32) {
	o.DaysRequested = &v
}
