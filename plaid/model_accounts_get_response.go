...
type AccountsGetResponse struct {
	...
	Item Item `json:"item"`
	PaymentRiskAssessment NullableAccountsBalanceGetResponsePaymentRiskAssessment `json:"payment_risk_assessment,omitempty"`
...
// GetPaymentRiskAssessment returns the PaymentRiskAssessment field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *AccountsGetResponse) GetPaymentRiskAssessment() AccountsBalanceGetResponsePaymentRiskAssessment {
	if o == nil || o.PaymentRiskAssessment.Get() == nil {
		var ret AccountsBalanceGetResponsePaymentRiskAssessment
		return ret
	}
	return *o.PaymentRiskAssessment.Get()
}

// GetPaymentRiskAssessmentOk returns a tuple with the PaymentRiskAssessment field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AccountsGetResponse) GetPaymentRiskAssessmentOk() (*AccountsBalanceGetResponsePaymentRiskAssessment, bool) {
	if o == nil  {
		return nil, false
	}
	return o.PaymentRiskAssessment.Get(), o.PaymentRiskAssessment.IsSet()
}

// HasPaymentRiskAssessment returns a boolean if a field has been set.
func (o *AccountsGetResponse) HasPaymentRiskAssessment() bool {
	if o != nil && o.PaymentRiskAssessment.IsSet() {
		return true
	}
...
// SetPaymentRiskAssessment gets a reference to the given NullableAccountsBalanceGetResponsePaymentRiskAssessment and assigns it to the PaymentRiskAssessment field.
func (o *AccountsGetResponse) SetPaymentRiskAssessment(v AccountsBalanceGetResponsePaymentRiskAssessment) {
	o.PaymentRiskAssessment.Set(&v)
}
// SetPaymentRiskAssessmentNil sets the value for PaymentRiskAssessment to be an explicit nil
func (o *AccountsGetResponse) SetPaymentRiskAssessmentNil() {
	o.PaymentRiskAssessment.Set(nil)
}

// UnsetPaymentRiskAssessment ensures that no value is present for PaymentRiskAssessment, not even an explicit nil
func (o *AccountsGetResponse) UnsetPaymentRiskAssessment() {
	o.PaymentRiskAssessment.Unset()
}
...
func (o AccountsGetResponse) MarshalJSON() ([]byte, error) {
	...
	if o.PaymentRiskAssessment.IsSet() {
		toSerialize["payment_risk_assessment"] = o.PaymentRiskAssessment.Get()
	}
	if true {
...
func (o *AccountsGetResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "payment_risk_assessment")
