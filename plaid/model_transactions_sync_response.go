...
func NewTransactionsSyncResponse(transactionsUpdateStatus TransactionsUpdateStatus, accounts []AccountBase, added []Transaction, modified []Transaction, removed []RemovedTransaction, nextCursor string, hasMore bool, requestId string) *TransactionsSyncResponse {
