...
func NewCreditBankStatementUploadTransaction(amount NullableFloat32, date NullableString, originalDescription NullableString) *CreditBankStatementUploadTransaction {
