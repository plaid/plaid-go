...
func (o *LinkTokenGetResponse) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *LinkTokenGetResponse) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *LinkTokenGetResponse) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *LinkTokenGetResponse) SetUserId(v string) {
	o.UserId = &v
}
