...
type LinkTokenGetResponse struct {
	...
	// Information about Link sessions created using this `link_token`. This field will only be present if your client is enabled for Hosted Link. Session data will be provided for up to six hours after the session has ended.
	LinkSessions *[]LinkTokenGetSessionsResponse `json:"link_sessions,omitempty"`
...
// GetLinkSessions returns the LinkSessions field value if set, zero value otherwise.
func (o *LinkTokenGetResponse) GetLinkSessions() []LinkTokenGetSessionsResponse {
	if o == nil || o.LinkSessions == nil {
		var ret []LinkTokenGetSessionsResponse
		return ret
	}
	return *o.LinkSessions
}

// GetLinkSessionsOk returns a tuple with the LinkSessions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LinkTokenGetResponse) GetLinkSessionsOk() (*[]LinkTokenGetSessionsResponse, bool) {
	if o == nil || o.LinkSessions == nil {
		return nil, false
	}
	return o.LinkSessions, true
}

// HasLinkSessions returns a boolean if a field has been set.
func (o *LinkTokenGetResponse) HasLinkSessions() bool {
	if o != nil && o.LinkSessions != nil {
		return true
	}
...
// SetLinkSessions gets a reference to the given []LinkTokenGetSessionsResponse and assigns it to the LinkSessions field.
func (o *LinkTokenGetResponse) SetLinkSessions(v []LinkTokenGetSessionsResponse) {
	o.LinkSessions = &v
}
...
func (o LinkTokenGetResponse) MarshalJSON() ([]byte, error) {
	...
	if o.LinkSessions != nil {
		toSerialize["link_sessions"] = o.LinkSessions
	}
	if true {
...
func (o *LinkTokenGetResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "link_sessions")
