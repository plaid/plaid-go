...
type AssetReport struct {
	...
	Insights NullableAccountInsights `json:"insights,omitempty"`
...
func (o *AssetReport) GetInsights() AccountInsights {
...
func (o *AssetReport) GetInsightsOk() (*AccountInsights, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *AssetReport) HasInsights() bool {
...
// SetInsights gets a reference to the given NullableAccountInsights and assigns it to the Insights field.
func (o *AssetReport) SetInsights(v AccountInsights) {
	o.Insights.Set(&v)
}
// SetInsightsNil sets the value for Insights to be an explicit nil
func (o *AssetReport) SetInsightsNil() {
	o.Insights.Set(nil)
}

// UnsetInsights ensures that no value is present for Insights, not even an explicit nil
func (o *AssetReport) UnsetInsights() {
	o.Insights.Unset()
}
