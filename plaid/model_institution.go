...
type Institution struct {
	...
	DtcNumbers *[]string `json:"dtc_numbers,omitempty"`
...
// GetDtcNumbers returns the DtcNumbers field value if set, zero value otherwise.
func (o *Institution) GetDtcNumbers() []string {
	if o == nil || o.DtcNumbers == nil {
		var ret []string
		return ret
	}
	return *o.DtcNumbers
...
// GetDtcNumbersOk returns a tuple with the DtcNumbers field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Institution) GetDtcNumbersOk() (*[]string, bool) {
	if o == nil || o.DtcNumbers == nil {
		return nil, false
	}
...
// HasDtcNumbers returns a boolean if a field has been set.
func (o *Institution) HasDtcNumbers() bool {
	if o != nil && o.DtcNumbers != nil {
		return true
	}
...
// SetDtcNumbers gets a reference to the given []string and assigns it to the DtcNumbers field.
func (o *Institution) SetDtcNumbers(v []string) {
	o.DtcNumbers = &v
}
