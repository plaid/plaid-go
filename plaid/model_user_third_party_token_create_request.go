...
func NewUserThirdPartyTokenCreateRequest(thirdPartyClientId string) *UserThirdPartyTokenCreateRequest {
...
func (o *UserThirdPartyTokenCreateRequest) HasUserToken() bool {
	if o != nil && o.UserToken != nil {
		return true
	}
...
func (o *UserThirdPartyTokenCreateRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *UserThirdPartyTokenCreateRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *UserThirdPartyTokenCreateRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *UserThirdPartyTokenCreateRequest) SetUserId(v string) {
	o.UserId = &v
}
