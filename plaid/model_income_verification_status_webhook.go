...
func NewIncomeVerificationStatusWebhook(webhookType string, webhookCode string, itemId string, verificationStatus string, environment WebhookEnvironmentValues) *IncomeVerificationStatusWebhook {
...
func (o *IncomeVerificationStatusWebhook) GetEnvironment() WebhookEnvironmentValues {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *IncomeVerificationStatusWebhook) GetEnvironmentOk() (*WebhookEnvironmentValues, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *IncomeVerificationStatusWebhook) SetEnvironment(v WebhookEnvironmentValues) {
	o.Environment = v
}
