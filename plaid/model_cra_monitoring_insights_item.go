...
func NewCraMonitoringInsightsItem(dateGenerated time.Time, itemId string, institutionId string, institutionName string, status MonitoringInsightsItemStatus, insights NullableMonitoringInsights) *CraMonitoringInsightsItem {
...
func (o *CraMonitoringInsightsItem) GetInstitutionId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CraMonitoringInsightsItem) GetInstitutionIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CraMonitoringInsightsItem) SetInstitutionId(v string) {
	o.InstitutionId = v
}

// GetInstitutionName returns the InstitutionName field value
func (o *CraMonitoringInsightsItem) GetInstitutionName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CraMonitoringInsightsItem) GetInstitutionNameOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *CraMonitoringInsightsItem) SetInstitutionName(v string) {
	o.InstitutionName = v
}
