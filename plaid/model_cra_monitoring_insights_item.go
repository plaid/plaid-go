...
type CraMonitoringInsightsItem struct {
	...
	Insights MonitoringInsights `json:"insights"`
...
func NewCraMonitoringInsightsItem(dateGenerated time.Time, itemId string, status MonitoringInsightsItemStatus, insights MonitoringInsights) *CraMonitoringInsightsItem {
