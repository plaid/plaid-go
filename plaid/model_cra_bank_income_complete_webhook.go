...
type CraBankIncomeCompleteWebhook struct {
	...
	Result CraBankIncomeCompleteResult `json:"result"`
...
func NewCraBankIncomeCompleteWebhook(webhookType string, webhookCode string, userId string, result CraBankIncomeCompleteResult, environment WebhookEnvironmentValues) *CraBankIncomeCompleteWebhook {
