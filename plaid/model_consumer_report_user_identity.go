...
func (o *ConsumerReportUserIdentity) HasDateOfBirth() bool {
...
func (o *ConsumerReportUserIdentity) SetDateOfBirthNil() {
	o.DateOfBirth.Set(nil)
}

// UnsetDateOfBirth ensures that no value is present for DateOfBirth, not even an explicit nil
func (o *ConsumerReportUserIdentity) UnsetDateOfBirth() {
	o.DateOfBirth.Unset()
}
