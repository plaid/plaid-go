...
type ConsumerReportUserIdentity struct {
	...
	SsnFull NullableString `json:"ssn_full,omitempty"`
...
// GetSsnFull returns the SsnFull field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ConsumerReportUserIdentity) GetSsnFull() string {
	if o == nil || o.SsnFull.Get() == nil {
		var ret string
		return ret
	}
	return *o.SsnFull.Get()
}

// GetSsnFullOk returns a tuple with the SsnFull field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ConsumerReportUserIdentity) GetSsnFullOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return o.SsnFull.Get(), o.SsnFull.IsSet()
}

// HasSsnFull returns a boolean if a field has been set.
func (o *ConsumerReportUserIdentity) HasSsnFull() bool {
	if o != nil && o.SsnFull.IsSet() {
		return true
	}
...
// SetSsnFull gets a reference to the given NullableString and assigns it to the SsnFull field.
func (o *ConsumerReportUserIdentity) SetSsnFull(v string) {
	o.SsnFull.Set(&v)
}
// SetSsnFullNil sets the value for SsnFull to be an explicit nil
func (o *ConsumerReportUserIdentity) SetSsnFullNil() {
	o.SsnFull.Set(nil)
}

// UnsetSsnFull ensures that no value is present for SsnFull, not even an explicit nil
func (o *ConsumerReportUserIdentity) UnsetSsnFull() {
	o.SsnFull.Unset()
}
...
func (o ConsumerReportUserIdentity) MarshalJSON() ([]byte, error) {
	...
	if o.SsnFull.IsSet() {
		toSerialize["ssn_full"] = o.SsnFull.Get()
	}
	if o.SsnLast4.IsSet() {
...
func (o *ConsumerReportUserIdentity) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ssn_full")
