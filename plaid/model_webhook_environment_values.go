...
func (v *WebhookEnvironmentValues) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid WebhookEnvironmentValues", value)
}
...
func NewWebhookEnvironmentValuesFromValue(v string) (*WebhookEnvironmentValues, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for WebhookEnvironmentValues: valid values are %v", v, allowedWebhookEnvironmentValuesEnumValues)
	}
}
