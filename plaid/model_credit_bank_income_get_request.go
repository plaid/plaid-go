...
func (o *CreditBankIncomeGetRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *CreditBankIncomeGetRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *CreditBankIncomeGetRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *CreditBankIncomeGetRequest) SetUserId(v string) {
	o.UserId = &v
}
