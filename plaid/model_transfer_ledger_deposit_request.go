...
func (o *TransferLedgerDepositRequest) GetLedgerId() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferLedgerDepositRequest) GetLedgerIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferLedgerDepositRequest) HasLedgerId() bool {
...
func (o *TransferLedgerDepositRequest) SetLedgerId(v string) {
	o.LedgerId.Set(&v)
}
// SetLedgerIdNil sets the value for LedgerId to be an explicit nil
func (o *TransferLedgerDepositRequest) SetLedgerIdNil() {
	o.LedgerId.Set(nil)
}

// UnsetLedgerId ensures that no value is present for LedgerId, not even an explicit nil
func (o *TransferLedgerDepositRequest) UnsetLedgerId() {
	o.LedgerId.Unset()
}
