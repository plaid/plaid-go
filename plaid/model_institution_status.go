...
type InstitutionStatus struct {
	ItemLogins *ProductStatus `json:"item_logins,omitempty"`
...
// GetItemLogins returns the ItemLogins field value if set, zero value otherwise.
func (o *InstitutionStatus) GetItemLogins() ProductStatus {
	if o == nil || o.ItemLogins == nil {
...
// SetItemLogins gets a reference to the given ProductStatus and assigns it to the ItemLogins field.
