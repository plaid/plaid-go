...
type _PhysicalDocumentExtractedDataAnalysis PhysicalDocumentExtractedDataAnalysis
...
func (o *PhysicalDocumentExtractedDataAnalysis) UnmarshalJSON(bytes []byte) (err error) {
	varPhysicalDocumentExtractedDataAnalysis := _PhysicalDocumentExtractedDataAnalysis{}

	if err = json.Unmarshal(bytes, &varPhysicalDocumentExtractedDataAnalysis); err == nil {
		*o = PhysicalDocumentExtractedDataAnalysis(varPhysicalDocumentExtractedDataAnalysis)
	} else {
		return err
	}
