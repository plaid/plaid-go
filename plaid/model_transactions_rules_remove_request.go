...
func NewTransactionsRulesRemoveRequest(clientUserId string, ruleId string) *TransactionsRulesRemoveRequest {
...
func (o *TransactionsRulesRemoveRequest) HasClientId() bool {
	if o != nil && o.ClientId != nil {
		return true
	}
...
func (o *TransactionsRulesRemoveRequest) HasSecret() bool {
	if o != nil && o.Secret != nil {
		return true
	}
...
func (o *TransactionsRulesRemoveRequest) GetClientUserId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TransactionsRulesRemoveRequest) GetClientUserIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransactionsRulesRemoveRequest) SetClientUserId(v string) {
	o.ClientUserId = v
}
