...
type PaymentInitiationConsentCreateRequest struct {
	...
	PayerDetails NullablePaymentInitiationConsentPayerDetails `json:"payer_details,omitempty"`
}
...
func NewPaymentInitiationConsentCreateRequest(recipientId string, reference string, constraints PaymentInitiationConsentConstraints) *PaymentInitiationConsentCreateRequest {
...
func (o *PaymentInitiationConsentCreateRequest) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *PaymentInitiationConsentCreateRequest) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *PaymentInitiationConsentCreateRequest) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *PaymentInitiationConsentCreateRequest) SetUserId(v string) {
	o.UserId = &v
}
...
func (o *PaymentInitiationConsentCreateRequest) HasScopes() bool {
	if o != nil && o.Scopes != nil {
		return true
	}
...
func (o *PaymentInitiationConsentCreateRequest) GetType() PaymentInitiationConsentType {
	if o == nil || o.Type == nil {
...
// and a boolean to check if the value has been set.
func (o *PaymentInitiationConsentCreateRequest) GetTypeOk() (*PaymentInitiationConsentType, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return o.Type, true
...
func (o *PaymentInitiationConsentCreateRequest) HasType() bool {
	if o != nil && o.Type != nil {
		return true
	}
...
func (o *PaymentInitiationConsentCreateRequest) SetType(v PaymentInitiationConsentType) {
	o.Type = &v
}
...
func (o *PaymentInitiationConsentCreateRequest) GetPayerDetails() PaymentInitiationConsentPayerDetails {
	if o == nil || o.PayerDetails.Get() == nil {
		var ret PaymentInitiationConsentPayerDetails
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PaymentInitiationConsentCreateRequest) GetPayerDetailsOk() (*PaymentInitiationConsentPayerDetails, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *PaymentInitiationConsentCreateRequest) HasPayerDetails() bool {
...
// SetPayerDetails gets a reference to the given NullablePaymentInitiationConsentPayerDetails and assigns it to the PayerDetails field.
func (o *PaymentInitiationConsentCreateRequest) SetPayerDetails(v PaymentInitiationConsentPayerDetails) {
	o.PayerDetails.Set(&v)
}
// SetPayerDetailsNil sets the value for PayerDetails to be an explicit nil
func (o *PaymentInitiationConsentCreateRequest) SetPayerDetailsNil() {
	o.PayerDetails.Set(nil)
}

// UnsetPayerDetails ensures that no value is present for PayerDetails, not even an explicit nil
func (o *PaymentInitiationConsentCreateRequest) UnsetPayerDetails() {
