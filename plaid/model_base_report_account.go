...
type BaseReportAccount struct {
	...
	Metadata BaseReportAccountMetadata `json:"metadata"`
	...
	Attributes *BaseReportAttributes `json:"attributes,omitempty"`
...
func NewBaseReportAccount(accountId string, balances BaseReportAccountBalances, consumerDisputes []ConsumerDispute, mask NullableString, metadata BaseReportAccountMetadata, name string, officialName NullableString, type_ AccountType, subtype NullableAccountSubtype, daysAvailable float32, transactions []BaseReportTransaction, owners []Owner, ownershipType NullableOwnershipType) *BaseReportAccount {
...
func (o *BaseReportAccount) GetAccountId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *BaseReportAccount) GetAccountIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *BaseReportAccount) SetAccountId(v string) {
	o.AccountId = v
}
...
func (o *BaseReportAccount) GetConsumerDisputes() []ConsumerDispute {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *BaseReportAccount) GetConsumerDisputesOk() (*[]ConsumerDispute, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *BaseReportAccount) SetConsumerDisputes(v []ConsumerDispute) {
...
func (o *BaseReportAccount) GetMetadata() BaseReportAccountMetadata {
	if o == nil {
		var ret BaseReportAccountMetadata
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BaseReportAccount) GetMetadataOk() (*BaseReportAccountMetadata, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *BaseReportAccount) SetMetadata(v BaseReportAccountMetadata) {
	o.Metadata = v
}
...
func (o *BaseReportAccount) GetHistoricalBalances() []BaseReportHistoricalBalance {
...
// and a boolean to check if the value has been set.
func (o *BaseReportAccount) GetHistoricalBalancesOk() (*[]BaseReportHistoricalBalance, bool) {
	if o == nil || o.HistoricalBalances == nil {
		return nil, false
	}
...
func (o *BaseReportAccount) SetHistoricalBalances(v []BaseReportHistoricalBalance) {
...
func (o *BaseReportAccount) GetAttributes() BaseReportAttributes {
	if o == nil || o.Attributes == nil {
		var ret BaseReportAttributes
		return ret
	}
	return *o.Attributes
}
...
// and a boolean to check if the value has been set.
func (o *BaseReportAccount) GetAttributesOk() (*BaseReportAttributes, bool) {
	if o == nil || o.Attributes == nil {
		return nil, false
	}
...
func (o *BaseReportAccount) HasAttributes() bool {
	if o != nil && o.Attributes != nil {
		return true
	}
...
// SetAttributes gets a reference to the given BaseReportAttributes and assigns it to the Attributes field.
func (o *BaseReportAccount) SetAttributes(v BaseReportAttributes) {
	o.Attributes = &v
}
