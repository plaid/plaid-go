...
func (v *LinkDeliverySessionStatus) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid LinkDeliverySessionStatus", value)
}
...
func NewLinkDeliverySessionStatusFromValue(v string) (*LinkDeliverySessionStatus, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for LinkDeliverySessionStatus: valid values are %v", v, allowedLinkDeliverySessionStatusEnumValues)
	}
}
