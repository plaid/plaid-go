...
func (v *FDXNotificationPriority) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid FDXNotificationPriority", value)
}
...
func NewFDXNotificationPriorityFromValue(v string) (*FDXNotificationPriority, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for FDXNotificationPriority: valid values are %v", v, allowedFDXNotificationPriorityEnumValues)
	}
}
