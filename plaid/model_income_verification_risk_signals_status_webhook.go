...
func NewIncomeVerificationRiskSignalsStatusWebhook(webhookType string, webhookCode string, itemId string, riskSignalsStatus string, environment WebhookEnvironmentValues) *IncomeVerificationRiskSignalsStatusWebhook {
