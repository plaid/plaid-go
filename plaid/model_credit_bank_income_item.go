...
type CreditBankIncomeItem struct {
	...
	InsitutionName *string `json:"insitution_name,omitempty"`
...
// GetInsitutionName returns the InsitutionName field value if set, zero value otherwise.
func (o *CreditBankIncomeItem) GetInsitutionName() string {
	if o == nil || o.InsitutionName == nil {
		var ret string
		return ret
	}
	return *o.InsitutionName
}

// GetInsitutionNameOk returns a tuple with the InsitutionName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreditBankIncomeItem) GetInsitutionNameOk() (*string, bool) {
	if o == nil || o.InsitutionName == nil {
		return nil, false
	}
	return o.InsitutionName, true
}

// HasInsitutionName returns a boolean if a field has been set.
func (o *CreditBankIncomeItem) HasInsitutionName() bool {
	if o != nil && o.InsitutionName != nil {
		return true
	}
...
// SetInsitutionName gets a reference to the given string and assigns it to the InsitutionName field.
func (o *CreditBankIncomeItem) SetInsitutionName(v string) {
	o.InsitutionName = &v
}
...
func (o CreditBankIncomeItem) MarshalJSON() ([]byte, error) {
	...
	if o.InsitutionName != nil {
		toSerialize["insitution_name"] = o.InsitutionName
	}
	if o.ItemId != nil {
