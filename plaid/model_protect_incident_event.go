...
type ProtectIncidentEvent struct {
	...
	// An `item_id` associated with the Item related to this incident. To identify an Item when creating a report, provide `access_token`.
...
func (o *ProtectIncidentEvent) GetAccessToken() string {
...
// and a boolean to check if the value has been set.
func (o *ProtectIncidentEvent) GetAccessTokenOk() (*string, bool) {
	if o == nil || o.AccessToken == nil {
		return nil, false
	}
...
func (o *ProtectIncidentEvent) HasAccessToken() bool {
	if o != nil && o.AccessToken != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ProtectIncidentEvent) GetItemIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *ProtectIncidentEvent) HasItemId() bool {
...
func (o *ProtectIncidentEvent) SetItemId(v string) {
	o.ItemId.Set(&v)
}
// SetItemIdNil sets the value for ItemId to be an explicit nil
func (o *ProtectIncidentEvent) SetItemIdNil() {
	o.ItemId.Set(nil)
}

// UnsetItemId ensures that no value is present for ItemId, not even an explicit nil
func (o *ProtectIncidentEvent) UnsetItemId() {
	o.ItemId.Unset()
}
