...
func (o *ExternalPaymentOptions) GetSchemeAutomaticDowngrade() bool {
	if o == nil || o.SchemeAutomaticDowngrade.Get() == nil {
		var ret bool
		return ret
	}
	return *o.SchemeAutomaticDowngrade.Get()
}

// GetSchemeAutomaticDowngradeOk returns a tuple with the SchemeAutomaticDowngrade field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ExternalPaymentOptions) GetSchemeAutomaticDowngradeOk() (*bool, bool) {
	...
	return o.SchemeAutomaticDowngrade.Get(), o.SchemeAutomaticDowngrade.IsSet()
}
...
func (o *ExternalPaymentOptions) HasSchemeAutomaticDowngrade() bool {
	if o != nil && o.SchemeAutomaticDowngrade.IsSet() {
		return true
	}
...
func (o *ExternalPaymentOptions) SetSchemeAutomaticDowngrade(v bool) {
	o.SchemeAutomaticDowngrade.Set(&v)
}
...
func (o *ExternalPaymentOptions) SetSchemeAutomaticDowngradeNil() {
	o.SchemeAutomaticDowngrade.Set(nil)
}
...
func (o *ExternalPaymentOptions) UnsetSchemeAutomaticDowngrade() {
	o.SchemeAutomaticDowngrade.Unset()
}
...
func (o ExternalPaymentOptions) MarshalJSON() ([]byte, error) {
	...
	if o.SchemeAutomaticDowngrade.IsSet() {
		toSerialize["scheme_automatic_downgrade"] = o.SchemeAutomaticDowngrade.Get()
	}
...
func (o *ExternalPaymentOptions) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "scheme_automatic_downgrade")
