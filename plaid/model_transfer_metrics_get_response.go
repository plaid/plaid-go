...
type TransferMetricsGetResponse struct {
	...
	ReturnRates NullableTransferMetricsGetReturnRates `json:"return_rates,omitempty"`
	AuthorizationUsage NullableTransferMetricsGetAuthorizationUsage `json:"authorization_usage,omitempty"`
...
// GetReturnRates returns the ReturnRates field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TransferMetricsGetResponse) GetReturnRates() TransferMetricsGetReturnRates {
	if o == nil || o.ReturnRates.Get() == nil {
		var ret TransferMetricsGetReturnRates
		return ret
	}
	return *o.ReturnRates.Get()
}

// GetReturnRatesOk returns a tuple with the ReturnRates field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferMetricsGetResponse) GetReturnRatesOk() (*TransferMetricsGetReturnRates, bool) {
	if o == nil  {
		return nil, false
	}
	return o.ReturnRates.Get(), o.ReturnRates.IsSet()
}

// HasReturnRates returns a boolean if a field has been set.
func (o *TransferMetricsGetResponse) HasReturnRates() bool {
	if o != nil && o.ReturnRates.IsSet() {
		return true
	}
...
// SetReturnRates gets a reference to the given NullableTransferMetricsGetReturnRates and assigns it to the ReturnRates field.
func (o *TransferMetricsGetResponse) SetReturnRates(v TransferMetricsGetReturnRates) {
	o.ReturnRates.Set(&v)
}
// SetReturnRatesNil sets the value for ReturnRates to be an explicit nil
func (o *TransferMetricsGetResponse) SetReturnRatesNil() {
	o.ReturnRates.Set(nil)
}

// UnsetReturnRates ensures that no value is present for ReturnRates, not even an explicit nil
func (o *TransferMetricsGetResponse) UnsetReturnRates() {
	o.ReturnRates.Unset()
}

// GetAuthorizationUsage returns the AuthorizationUsage field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TransferMetricsGetResponse) GetAuthorizationUsage() TransferMetricsGetAuthorizationUsage {
	if o == nil || o.AuthorizationUsage.Get() == nil {
		var ret TransferMetricsGetAuthorizationUsage
		return ret
	}
	return *o.AuthorizationUsage.Get()
}

// GetAuthorizationUsageOk returns a tuple with the AuthorizationUsage field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferMetricsGetResponse) GetAuthorizationUsageOk() (*TransferMetricsGetAuthorizationUsage, bool) {
	if o == nil  {
		return nil, false
	}
	return o.AuthorizationUsage.Get(), o.AuthorizationUsage.IsSet()
}

// HasAuthorizationUsage returns a boolean if a field has been set.
func (o *TransferMetricsGetResponse) HasAuthorizationUsage() bool {
	if o != nil && o.AuthorizationUsage.IsSet() {
		return true
	}
...
// SetAuthorizationUsage gets a reference to the given NullableTransferMetricsGetAuthorizationUsage and assigns it to the AuthorizationUsage field.
func (o *TransferMetricsGetResponse) SetAuthorizationUsage(v TransferMetricsGetAuthorizationUsage) {
	o.AuthorizationUsage.Set(&v)
}
// SetAuthorizationUsageNil sets the value for AuthorizationUsage to be an explicit nil
func (o *TransferMetricsGetResponse) SetAuthorizationUsageNil() {
	o.AuthorizationUsage.Set(nil)
}

// UnsetAuthorizationUsage ensures that no value is present for AuthorizationUsage, not even an explicit nil
func (o *TransferMetricsGetResponse) UnsetAuthorizationUsage() {
	o.AuthorizationUsage.Unset()
}
...
func (o TransferMetricsGetResponse) MarshalJSON() ([]byte, error) {
	...
	if o.ReturnRates.IsSet() {
		toSerialize["return_rates"] = o.ReturnRates.Get()
	}
	if o.AuthorizationUsage.IsSet() {
		toSerialize["authorization_usage"] = o.AuthorizationUsage.Get()
	}
...
func (o *TransferMetricsGetResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "return_rates")
		delete(additionalProperties, "authorization_usage")
