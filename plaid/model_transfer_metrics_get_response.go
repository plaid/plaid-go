...
func NewTransferMetricsGetResponse(requestId string, dailyDebitTransferVolume string, dailyCreditTransferVolume string, monthlyTransferVolume string, isoCurrencyCode string) *TransferMetricsGetResponse {
