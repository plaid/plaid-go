...
func NewWalletBalance(isoCurrencyCode string, current float64, available float64) *WalletBalance {
	this := WalletBalance{}
...
func (o *WalletBalance) GetAvailable() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WalletBalance) GetAvailableOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *WalletBalance) SetAvailable(v float64) {
	o.Available = v
}
