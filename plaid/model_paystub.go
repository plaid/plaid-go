...
type Paystub struct {
	...
	Verification NullablePaystubFraudVerification `json:"verification"`
...
func NewPaystub(deductions Deductions, docId string, earnings Earnings, employee Employee, employer PaystubEmployer, netPay NetPay, payPeriodDetails PayPeriodDetails, incomeBreakdown []IncomeBreakdown, ytdEarnings PaystubYTDDetails, verification NullablePaystubFraudVerification) *Paystub {
	this := Paystub{}
...
// If the value is explicit nil, the zero value for PaystubFraudVerification will be returned
func (o *Paystub) GetVerification() PaystubFraudVerification {
	if o == nil || o.Verification.Get() == nil {
		var ret PaystubFraudVerification
		return ret
	}
...
func (o *Paystub) GetVerificationOk() (*PaystubFraudVerification, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *Paystub) SetVerification(v PaystubFraudVerification) {
