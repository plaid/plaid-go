...
func (v *Form1099Type) UnmarshalJSON(src []byte) error {
	...
	return fmt.Errorf("%+v is not a valid Form1099Type", value)
}
...
func NewForm1099TypeFromValue(v string) (*Form1099Type, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for Form1099Type: valid values are %v", v, allowedForm1099TypeEnumValues)
	}
}
