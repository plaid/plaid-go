...
// IdentityMatchUser The user's legal name, phone number, email address and address used to perform fuzzy match.
type IdentityMatchUser struct {
	...
	Address NullableAddressDataNullable `json:"address,omitempty"`
...
func (o *IdentityMatchUser) GetAddress() AddressDataNullable {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IdentityMatchUser) GetAddressOk() (*AddressDataNullable, bool) {
	if o == nil  {
		return nil, false
	}
...
// SetAddress gets a reference to the given NullableAddressDataNullable and assigns it to the Address field.
func (o *IdentityMatchUser) SetAddress(v AddressDataNullable) {
	o.Address.Set(&v)
}
