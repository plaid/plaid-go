...
type UserAccountSessionGetResponse struct {
	...
	IdentityEditHistory NullableUserAccountIdentityEditHistory `json:"identity_edit_history,omitempty"`
...
// GetIdentityEditHistory returns the IdentityEditHistory field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UserAccountSessionGetResponse) GetIdentityEditHistory() UserAccountIdentityEditHistory {
	if o == nil || o.IdentityEditHistory.Get() == nil {
		var ret UserAccountIdentityEditHistory
		return ret
	}
	return *o.IdentityEditHistory.Get()
}

// GetIdentityEditHistoryOk returns a tuple with the IdentityEditHistory field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *UserAccountSessionGetResponse) GetIdentityEditHistoryOk() (*UserAccountIdentityEditHistory, bool) {
	if o == nil  {
		return nil, false
	}
	return o.IdentityEditHistory.Get(), o.IdentityEditHistory.IsSet()
}

// HasIdentityEditHistory returns a boolean if a field has been set.
func (o *UserAccountSessionGetResponse) HasIdentityEditHistory() bool {
	if o != nil && o.IdentityEditHistory.IsSet() {
		return true
	}
...
// SetIdentityEditHistory gets a reference to the given NullableUserAccountIdentityEditHistory and assigns it to the IdentityEditHistory field.
func (o *UserAccountSessionGetResponse) SetIdentityEditHistory(v UserAccountIdentityEditHistory) {
	o.IdentityEditHistory.Set(&v)
}
// SetIdentityEditHistoryNil sets the value for IdentityEditHistory to be an explicit nil
func (o *UserAccountSessionGetResponse) SetIdentityEditHistoryNil() {
	o.IdentityEditHistory.Set(nil)
}

// UnsetIdentityEditHistory ensures that no value is present for IdentityEditHistory, not even an explicit nil
func (o *UserAccountSessionGetResponse) UnsetIdentityEditHistory() {
	o.IdentityEditHistory.Unset()
}
...
func (o UserAccountSessionGetResponse) MarshalJSON() ([]byte, error) {
	...
	if o.IdentityEditHistory.IsSet() {
		toSerialize["identity_edit_history"] = o.IdentityEditHistory.Get()
	}
	if true {
...
func (o *UserAccountSessionGetResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "identity_edit_history")
