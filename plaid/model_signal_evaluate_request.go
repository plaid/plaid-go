...
type SignalEvaluateRequest struct {
	...
	RiskProfileKey NullableString `json:"risk_profile_key,omitempty"`
...
func (o *SignalEvaluateRequest) GetIsRecurring() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SignalEvaluateRequest) GetIsRecurringOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *SignalEvaluateRequest) HasIsRecurring() bool {
...
func (o *SignalEvaluateRequest) GetDefaultPaymentMethod() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SignalEvaluateRequest) GetDefaultPaymentMethodOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *SignalEvaluateRequest) HasDefaultPaymentMethod() bool {
...
func (o *SignalEvaluateRequest) SetDefaultPaymentMethod(v string) {
	o.DefaultPaymentMethod.Set(&v)
}
// SetDefaultPaymentMethodNil sets the value for DefaultPaymentMethod to be an explicit nil
func (o *SignalEvaluateRequest) SetDefaultPaymentMethodNil() {
...
func (o *SignalEvaluateRequest) UnsetDefaultPaymentMethod() {
...
// GetRiskProfileKey returns the RiskProfileKey field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *SignalEvaluateRequest) GetRiskProfileKey() string {
	if o == nil || o.RiskProfileKey.Get() == nil {
		var ret string
		return ret
	}
	return *o.RiskProfileKey.Get()
}

// GetRiskProfileKeyOk returns a tuple with the RiskProfileKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SignalEvaluateRequest) GetRiskProfileKeyOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return o.RiskProfileKey.Get(), o.RiskProfileKey.IsSet()
}

// HasRiskProfileKey returns a boolean if a field has been set.
func (o *SignalEvaluateRequest) HasRiskProfileKey() bool {
	if o != nil && o.RiskProfileKey.IsSet() {
		return true
	}
...
// SetRiskProfileKey gets a reference to the given NullableString and assigns it to the RiskProfileKey field.
func (o *SignalEvaluateRequest) SetRiskProfileKey(v string) {
	o.RiskProfileKey.Set(&v)
}
// SetRiskProfileKeyNil sets the value for RiskProfileKey to be an explicit nil
func (o *SignalEvaluateRequest) SetRiskProfileKeyNil() {
	o.RiskProfileKey.Set(nil)
}

// UnsetRiskProfileKey ensures that no value is present for RiskProfileKey, not even an explicit nil
func (o *SignalEvaluateRequest) UnsetRiskProfileKey() {
	o.RiskProfileKey.Unset()
}

// GetRulesetKey returns the RulesetKey field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *SignalEvaluateRequest) GetRulesetKey() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SignalEvaluateRequest) GetRulesetKeyOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *SignalEvaluateRequest) HasRulesetKey() bool {
...
func (o SignalEvaluateRequest) MarshalJSON() ([]byte, error) {
	...
	if o.RiskProfileKey.IsSet() {
		toSerialize["risk_profile_key"] = o.RiskProfileKey.Get()
	}
