...
func NewProcessorTransactionsRecurringGetRequest(processorToken string, accountIds []string) *ProcessorTransactionsRecurringGetRequest {
...
func (o *ProcessorTransactionsRecurringGetRequest) GetAccountIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProcessorTransactionsRecurringGetRequest) GetAccountIdsOk() (*[]string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *ProcessorTransactionsRecurringGetRequest) SetAccountIds(v []string) {
	o.AccountIds = v
}
