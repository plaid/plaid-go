...
type _EntityWatchlistScreeningReview EntityWatchlistScreeningReview
...
func (o *EntityWatchlistScreeningReview) UnmarshalJSON(bytes []byte) (err error) {
	varEntityWatchlistScreeningReview := _EntityWatchlistScreeningReview{}

	if err = json.Unmarshal(bytes, &varEntityWatchlistScreeningReview); err == nil {
		*o = EntityWatchlistScreeningReview(varEntityWatchlistScreeningReview)
	} else {
		return err
	}
