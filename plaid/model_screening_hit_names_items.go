...
type _ScreeningHitNamesItems ScreeningHitNamesItems
...
func (o *ScreeningHitNamesItems) UnmarshalJSON(bytes []byte) (err error) {
	varScreeningHitNamesItems := _ScreeningHitNamesItems{}

	if err = json.Unmarshal(bytes, &varScreeningHitNamesItems); err == nil {
		*o = ScreeningHitNamesItems(varScreeningHitNamesItems)
	} else {
		return err
	}
