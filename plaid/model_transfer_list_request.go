...
func (o *TransferListRequest) GetFundingAccountId() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferListRequest) GetFundingAccountIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferListRequest) HasFundingAccountId() bool {
...
func (o *TransferListRequest) SetFundingAccountId(v string) {
	o.FundingAccountId.Set(&v)
}
// SetFundingAccountIdNil sets the value for FundingAccountId to be an explicit nil
func (o *TransferListRequest) SetFundingAccountIdNil() {
...
func (o *TransferListRequest) UnsetFundingAccountId() {
