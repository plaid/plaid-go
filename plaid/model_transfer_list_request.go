...
// TransferListRequest TransferListRequest defines the request schema for `/transfer/list`
type TransferListRequest struct {
	...
	Direction NullableTransferDirection `json:"direction,omitempty"`
}
...
func (o *TransferListRequest) GetDirection() TransferDirection {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TransferListRequest) GetDirectionOk() (*TransferDirection, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *TransferListRequest) HasDirection() bool {
...
// SetDirection gets a reference to the given NullableTransferDirection and assigns it to the Direction field.
func (o *TransferListRequest) SetDirection(v TransferDirection) {
	o.Direction.Set(&v)
}
// SetDirectionNil sets the value for Direction to be an explicit nil
func (o *TransferListRequest) SetDirectionNil() {
	o.Direction.Set(nil)
}

// UnsetDirection ensures that no value is present for Direction, not even an explicit nil
func (o *TransferListRequest) UnsetDirection() {
	o.Direction.Unset()
}
