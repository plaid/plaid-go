...
func NewItemImportRequest(userAuth ItemImportRequestUserAuth) *ItemImportRequest {
...
func (o *ItemImportRequest) GetInstitutionId() string {
...
// and a boolean to check if the value has been set.
func (o *ItemImportRequest) GetInstitutionIdOk() (*string, bool) {
	if o == nil || o.InstitutionId == nil {
		return nil, false
	}
...
func (o *ItemImportRequest) HasInstitutionId() bool {
	if o != nil && o.InstitutionId != nil {
		return true
	}
...
func (o *ItemImportRequest) SetInstitutionId(v string) {
	o.InstitutionId = &v
}
...
func (o *ItemImportRequest) HasProducts() bool {
	if o != nil && o.Products != nil {
		return true
	}
