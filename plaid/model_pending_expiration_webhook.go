...
func NewPendingExpirationWebhook(webhookType string, webhookCode string, itemId string, consentExpirationTime time.Time, environment WebhookEnvironmentValues) *PendingExpirationWebhook {
...
func (o *PendingExpirationWebhook) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *PendingExpirationWebhook) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *PendingExpirationWebhook) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *PendingExpirationWebhook) SetUserId(v string) {
	o.UserId = &v
}
...
func (o *PendingExpirationWebhook) GetEnvironment() WebhookEnvironmentValues {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *PendingExpirationWebhook) GetEnvironmentOk() (*WebhookEnvironmentValues, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *PendingExpirationWebhook) SetEnvironment(v WebhookEnvironmentValues) {
	o.Environment = v
}
