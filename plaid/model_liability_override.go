...
func NewLiabilityOverride(type_ string, purchaseApr float64, cashApr float64, balanceTransferApr float64, specialApr float64, lastPaymentAmount float64, minimumPaymentAmount float64, isOverdue bool, originationDate string, principal float64, nominalApr float64, interestCapitalizationGracePeriodMonths float32, repaymentModel StudentLoanRepaymentModel, expectedPayoffDate string, guarantor string, isFederal bool, loanName string, loanStatus StudentLoanStatus, paymentReferenceNumber string, pslfStatus PSLFStatus, repaymentPlanDescription string, repaymentPlanType string, sequenceNumber string, servicerAddress Address) *LiabilityOverride {
...
func (o *LiabilityOverride) GetPurchaseApr() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LiabilityOverride) GetPurchaseAprOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *LiabilityOverride) SetPurchaseApr(v float64) {
	o.PurchaseApr = v
}

// GetCashApr returns the CashApr field value
func (o *LiabilityOverride) GetCashApr() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LiabilityOverride) GetCashAprOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *LiabilityOverride) SetCashApr(v float64) {
	o.CashApr = v
}

// GetBalanceTransferApr returns the BalanceTransferApr field value
func (o *LiabilityOverride) GetBalanceTransferApr() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LiabilityOverride) GetBalanceTransferAprOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *LiabilityOverride) SetBalanceTransferApr(v float64) {
	o.BalanceTransferApr = v
}

// GetSpecialApr returns the SpecialApr field value
func (o *LiabilityOverride) GetSpecialApr() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LiabilityOverride) GetSpecialAprOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *LiabilityOverride) SetSpecialApr(v float64) {
	o.SpecialApr = v
}

// GetLastPaymentAmount returns the LastPaymentAmount field value
func (o *LiabilityOverride) GetLastPaymentAmount() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LiabilityOverride) GetLastPaymentAmountOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *LiabilityOverride) SetLastPaymentAmount(v float64) {
	o.LastPaymentAmount = v
}

// GetMinimumPaymentAmount returns the MinimumPaymentAmount field value
func (o *LiabilityOverride) GetMinimumPaymentAmount() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LiabilityOverride) GetMinimumPaymentAmountOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *LiabilityOverride) SetMinimumPaymentAmount(v float64) {
...
func (o *LiabilityOverride) GetPrincipal() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LiabilityOverride) GetPrincipalOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *LiabilityOverride) SetPrincipal(v float64) {
	o.Principal = v
}

// GetNominalApr returns the NominalApr field value
func (o *LiabilityOverride) GetNominalApr() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LiabilityOverride) GetNominalAprOk() (*float64, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *LiabilityOverride) SetNominalApr(v float64) {
	o.NominalApr = v
}
