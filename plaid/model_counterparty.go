...
func (o *Counterparty) GetAccountNumbers() CounterpartyNumbers {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Counterparty) GetAccountNumbersOk() (*CounterpartyNumbers, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o *Counterparty) HasAccountNumbers() bool {
