...
func (o *LinkTokenCreateResponse) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *LinkTokenCreateResponse) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *LinkTokenCreateResponse) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *LinkTokenCreateResponse) SetUserId(v string) {
	o.UserId = &v
}
