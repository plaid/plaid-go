...
func (o *UserPermissionRevokedWebhook) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *UserPermissionRevokedWebhook) GetUserIdOk() (*string, bool) {
	if o == nil || o.UserId == nil {
		return nil, false
	}
...
func (o *UserPermissionRevokedWebhook) HasUserId() bool {
	if o != nil && o.UserId != nil {
		return true
	}
...
func (o *UserPermissionRevokedWebhook) SetUserId(v string) {
	o.UserId = &v
}
