...
type WalletGetResponse struct {
	...
	Numbers *WalletNumbers `json:"numbers,omitempty"`
...
func (o *WalletGetResponse) HasNumbers() bool {
	if o != nil && o.Numbers != nil {
		return true
	}
...
// SetNumbers gets a reference to the given WalletNumbers and assigns it to the Numbers field.
