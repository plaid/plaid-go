...
type MonitoringIncomeSource struct {
	...
	IsMissingIncome bool `json:"is_missing_income"`
...
func NewMonitoringIncomeSource(incomeSourceId string, incomeDescription string, incomeCategory CreditBankIncomeCategory, lastTransactionDate string, isMissingIncome bool) *MonitoringIncomeSource {
...
// GetIsMissingIncome returns the IsMissingIncome field value
func (o *MonitoringIncomeSource) GetIsMissingIncome() bool {
	if o == nil {
		var ret bool
		return ret
	}

	return o.IsMissingIncome
}

// GetIsMissingIncomeOk returns a tuple with the IsMissingIncome field value
// and a boolean to check if the value has been set.
func (o *MonitoringIncomeSource) GetIsMissingIncomeOk() (*bool, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.IsMissingIncome, true
}

// SetIsMissingIncome sets field value
func (o *MonitoringIncomeSource) SetIsMissingIncome(v bool) {
	o.IsMissingIncome = v
}
...
func (o MonitoringIncomeSource) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["is_missing_income"] = o.IsMissingIncome
	}
...
func (o *MonitoringIncomeSource) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "is_missing_income")
