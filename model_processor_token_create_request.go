...
type ProcessorTokenCreateRequest struct {
	...
	// The processor you are integrating with. Valid values are `\"achq\"`, `\"alpaca\"`, `\"astra\"`, `\"check\"`, `\"checkbook\"`, `\"circle\"`, `\"drivewealth\"`, `\"dwolla\"`, `\"galileo\"`, \"`interactive_brokers`\", `\"lithic\"`, `\"modern_treasury\"`, `\"moov\"`, `\"ocrolus\"`, `\"prime_trust\"`, `\"rize\"`, `\"sila_money\"`, `\"svb_api\"`, `\"unit\"`, `\"vesta\"`, `\"vopay\"`, `\"wyre\"`
