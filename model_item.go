...
type Item struct {
	...
	ConsentExpirationTime NullableString `json:"consent_expiration_time"`
...
func NewItem(itemId string, webhook NullableString, error_ NullableError, availableProducts []Products, billedProducts []Products, consentExpirationTime NullableString, updateType string) *Item {
	this := Item{}
	this.ItemId = itemId
