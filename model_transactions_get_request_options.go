...
type TransactionsGetRequestOptions struct {
	...
	// Include the transactions' original descriptions. This feature is in closed beta and only available to beta program participants. For more details, contact your Plaid Account Manager.
